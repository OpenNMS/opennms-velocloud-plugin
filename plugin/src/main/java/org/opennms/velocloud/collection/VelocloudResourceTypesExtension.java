...
public class VelocloudResourceTypesExtension implements ResourceTypesExtension {

    private final ClassPathResourceTypesLoader classPathResourceTypesLoader =
            new ClassPathResourceTypesLoader(VelocloudResourceTypesExtension.class, "velocloud-resource.xml");
