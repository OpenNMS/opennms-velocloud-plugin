...
package org.opennms.velocloud.configuration;
...
public class VelocloudGraphPropertiesExtension implements GraphPropertiesExtension {

    private ClassPathGraphPropertiesLoader graphPropertiesLoader = new ClassPathGraphPropertiesLoader(VelocloudGraphPropertiesExtension.class,
            "velocloud-graph.properties");
