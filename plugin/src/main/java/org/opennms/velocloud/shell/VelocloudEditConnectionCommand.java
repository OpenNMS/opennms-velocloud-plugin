...
@Command(scope = "opennms-velocloud", name = "edit-connection", description = "Edit connection")
@Service
public class VelocloudEditConnectionCommand implements Action {
    ...
    @Argument(index = 1, name = "url", required = true, description = "Orchestrator URL")
    String url;

    @Argument(index = 2, name = "apiKey", required = true, description = "API Token")
    String apiKey;
