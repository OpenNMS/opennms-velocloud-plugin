...
public class BaseApiResource10 {
   ...
   */
  @JsonAdapter(AlertsEnabledEnum.Adapter.class)
  public enum AlertsEnabledEnum {
    ...
    public static class Adapter extends TypeAdapter<AlertsEnabledEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final AlertsEnabledEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public AlertsEnabledEnum read(final JsonReader jsonReader) throws IOException {
        Object value = jsonReader.nextInt();
        return AlertsEnabledEnum.fromValue(String.valueOf(value));
      }
    }
   ...
   */
  @JsonAdapter(OperatorAlertsEnabledEnum.Adapter.class)
  public enum OperatorAlertsEnabledEnum {
    ...
    public static class Adapter extends TypeAdapter<OperatorAlertsEnabledEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final OperatorAlertsEnabledEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public OperatorAlertsEnabledEnum read(final JsonReader jsonReader) throws IOException {
        Object value = jsonReader.nextInt();
        return OperatorAlertsEnabledEnum.fromValue(String.valueOf(value));
      }
    }
