...
/**
 * CreateEnterpriseSchemaServiceLicenses
 */
...
public class CreateEnterpriseSchemaServiceLicenses {
  @SerializedName("SDWAN")
  private CreateEnterpriseSchemaServiceLicensesSDWAN SDWAN = null;

  @SerializedName("ENI")
  private CreateEnterpriseSchemaServiceLicensesSDWAN ENI = null;

  @SerializedName("CWS")
  private CreateEnterpriseSchemaServiceLicensesSDWAN CWS = null;

  @SerializedName("ZTNAD")
  private CreateEnterpriseSchemaServiceLicensesSDWAN ZTNAD = null;

  public CreateEnterpriseSchemaServiceLicenses SDWAN(CreateEnterpriseSchemaServiceLicensesSDWAN SDWAN) {
    this.SDWAN = SDWAN;
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public CreateEnterpriseSchemaServiceLicensesSDWAN getSDWAN() {
    return SDWAN;
  }

  public void setSDWAN(CreateEnterpriseSchemaServiceLicensesSDWAN SDWAN) {
    this.SDWAN = SDWAN;
  }

  public CreateEnterpriseSchemaServiceLicenses ENI(CreateEnterpriseSchemaServiceLicensesSDWAN ENI) {
    this.ENI = ENI;
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public CreateEnterpriseSchemaServiceLicensesSDWAN getENI() {
    return ENI;
  }

  public void setENI(CreateEnterpriseSchemaServiceLicensesSDWAN ENI) {
    this.ENI = ENI;
  }

  public CreateEnterpriseSchemaServiceLicenses CWS(CreateEnterpriseSchemaServiceLicensesSDWAN CWS) {
    this.CWS = CWS;
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public CreateEnterpriseSchemaServiceLicensesSDWAN getCWS() {
    return CWS;
  }

  public void setCWS(CreateEnterpriseSchemaServiceLicensesSDWAN CWS) {
    this.CWS = CWS;
  }

  public CreateEnterpriseSchemaServiceLicenses ZTNAD(CreateEnterpriseSchemaServiceLicensesSDWAN ZTNAD) {
    this.ZTNAD = ZTNAD;
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public CreateEnterpriseSchemaServiceLicensesSDWAN getZTNAD() {
    return ZTNAD;
  }

  public void setZTNAD(CreateEnterpriseSchemaServiceLicensesSDWAN ZTNAD) {
    this.ZTNAD = ZTNAD;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateEnterpriseSchemaServiceLicenses createEnterpriseSchemaServiceLicenses = (CreateEnterpriseSchemaServiceLicenses) o;
    return Objects.equals(this.SDWAN, createEnterpriseSchemaServiceLicenses.SDWAN) &&
        Objects.equals(this.ENI, createEnterpriseSchemaServiceLicenses.ENI) &&
        Objects.equals(this.CWS, createEnterpriseSchemaServiceLicenses.CWS) &&
        Objects.equals(this.ZTNAD, createEnterpriseSchemaServiceLicenses.ZTNAD);
  }

  @Override
  public int hashCode() {
    return Objects.hash(SDWAN, ENI, CWS, ZTNAD);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateEnterpriseSchemaServiceLicenses {\n");
    
    sb.append("    SDWAN: ").append(toIndentedString(SDWAN)).append("\n");
    sb.append("    ENI: ").append(toIndentedString(ENI)).append("\n");
    sb.append("    CWS: ").append(toIndentedString(CWS)).append("\n");
    sb.append("    ZTNAD: ").append(toIndentedString(ZTNAD)).append("\n");
    sb.append("}");
    return sb.toString();
  }
