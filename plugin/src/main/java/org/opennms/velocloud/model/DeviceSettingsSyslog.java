...
import org.opennms.velocloud.model.DeviceSettingsSyslogCollector;
/**
...
public class DeviceSettingsSyslog {
  @SerializedName("enabled")
  private Boolean enabled = null;

  /**
   * Gets or Sets facilityCode
   */
  @JsonAdapter(FacilityCodeEnum.Adapter.class)
  public enum FacilityCodeEnum {
    ...
    public static FacilityCodeEnum fromValue(String text) {
      for (FacilityCodeEnum b : FacilityCodeEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<FacilityCodeEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final FacilityCodeEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public FacilityCodeEnum read(final JsonReader jsonReader) throws IOException {
        Object value = jsonReader.nextString();
        return FacilityCodeEnum.fromValue(String.valueOf(value));
      }
    }
  }  @SerializedName("facilityCode")
  private FacilityCodeEnum facilityCode = null;

  @SerializedName("override")
  private Boolean override = null;

  @SerializedName("collectors")
  private List<DeviceSettingsSyslogCollector> collectors = new ArrayList<>();

  public DeviceSettingsSyslog enabled(Boolean enabled) {
  ...
  **/
  ...
  public DeviceSettingsSyslog facilityCode(FacilityCodeEnum facilityCode) {
  ...
  **/
  @Schema(description = "")
  public FacilityCodeEnum getFacilityCode() {
    return facilityCode;
  }

  public void setFacilityCode(FacilityCodeEnum facilityCode) {
    this.facilityCode = facilityCode;
  }

  public DeviceSettingsSyslog override(Boolean override) {
  ...
  **/
  ...
  public DeviceSettingsSyslog collectors(List<DeviceSettingsSyslogCollector> collectors) {
    this.collectors = collectors;
    return this;
  }

  public DeviceSettingsSyslog addCollectorsItem(DeviceSettingsSyslogCollector collectorsItem) {
  ...
  **/
  @Schema(required = true, description = "")
  public List<DeviceSettingsSyslogCollector> getCollectors() {
    return collectors;
  }

  public void setCollectors(List<DeviceSettingsSyslogCollector> collectors) {
    this.collectors = collectors;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeviceSettingsSyslog deviceSettingsSyslog = (DeviceSettingsSyslog) o;
    return Objects.equals(this.enabled, deviceSettingsSyslog.enabled) &&
        Objects.equals(this.facilityCode, deviceSettingsSyslog.facilityCode) &&
        Objects.equals(this.override, deviceSettingsSyslog.override) &&
        Objects.equals(this.collectors, deviceSettingsSyslog.collectors);
  }

  @Override
  public int hashCode() {
    return Objects.hash(enabled, facilityCode, override, collectors);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceSettingsSyslog {\n");
