...
import org.opennms.velocloud.model.GlobalIPv6AdvancedConfiguration;
import org.opennms.velocloud.model.GlobalIPv6IcmpV6MessagesConfiguration;
/**
...
public class DeviceSettingsGlobalIPv6Settings {
  @SerializedName("advancedConfiguration")
  private GlobalIPv6AdvancedConfiguration advancedConfiguration = null;

  @SerializedName("icmpV6Messages")
  private GlobalIPv6IcmpV6MessagesConfiguration icmpV6Messages = null;

  public DeviceSettingsGlobalIPv6Settings advancedConfiguration(GlobalIPv6AdvancedConfiguration advancedConfiguration) {
  ...
  **/
  @Schema(description = "")
  public GlobalIPv6AdvancedConfiguration getAdvancedConfiguration() {
    return advancedConfiguration;
  }

  public void setAdvancedConfiguration(GlobalIPv6AdvancedConfiguration advancedConfiguration) {
    this.advancedConfiguration = advancedConfiguration;
  }

  public DeviceSettingsGlobalIPv6Settings icmpV6Messages(GlobalIPv6IcmpV6MessagesConfiguration icmpV6Messages) {
    this.icmpV6Messages = icmpV6Messages;
    return this;
  }

   /**
   * Get icmpV6Messages
   * @return icmpV6Messages
  **/
  @Schema(description = "")
  public GlobalIPv6IcmpV6MessagesConfiguration getIcmpV6Messages() {
    return icmpV6Messages;
  }

  public void setIcmpV6Messages(GlobalIPv6IcmpV6MessagesConfiguration icmpV6Messages) {
    this.icmpV6Messages = icmpV6Messages;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeviceSettingsGlobalIPv6Settings deviceSettingsGlobalIPv6Settings = (DeviceSettingsGlobalIPv6Settings) o;
    return Objects.equals(this.advancedConfiguration, deviceSettingsGlobalIPv6Settings.advancedConfiguration) &&
        Objects.equals(this.icmpV6Messages, deviceSettingsGlobalIPv6Settings.icmpV6Messages);
  }

  @Override
  public int hashCode() {
    return Objects.hash(advancedConfiguration, icmpV6Messages);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceSettingsGlobalIPv6Settings {\n");
    
    sb.append("    advancedConfiguration: ").append(toIndentedString(advancedConfiguration)).append("\n");
    sb.append("    icmpV6Messages: ").append(toIndentedString(icmpV6Messages)).append("\n");
    sb.append("}");
    return sb.toString();
  }
