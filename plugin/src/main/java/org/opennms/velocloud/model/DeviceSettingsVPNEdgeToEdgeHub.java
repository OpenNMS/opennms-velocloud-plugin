...
/**
 * DeviceSettingsVPNEdgeToEdgeHub
 */
...
public class DeviceSettingsVPNEdgeToEdgeHub {
  ...
  public enum RefEnum {
    EDGEHUB("deviceSettings:vpn:edgeHub");
  ...
  public DeviceSettingsVPNEdgeToEdgeHub enabled(Boolean enabled) {
  ...
  **/
  ...
  public DeviceSettingsVPNEdgeToEdgeHub ref(RefEnum ref) {
    this.ref = ref;
    return this;
  }
  ...
  **/
  ...
  public DeviceSettingsVPNEdgeToEdgeHub vpnHubs(List<BaseApiResource11> vpnHubs) {
    this.vpnHubs = vpnHubs;
    return this;
  }

  public DeviceSettingsVPNEdgeToEdgeHub addVpnHubsItem(BaseApiResource11 vpnHubsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceSettingsVPNEdgeToEdgeHub deviceSettingsVPNEdgeToEdgeHub = (DeviceSettingsVPNEdgeToEdgeHub) o;
    return Objects.equals(this.enabled, deviceSettingsVPNEdgeToEdgeHub.enabled) &&
        Objects.equals(this.ref, deviceSettingsVPNEdgeToEdgeHub.ref) &&
        Objects.equals(this.vpnHubs, deviceSettingsVPNEdgeToEdgeHub.vpnHubs);
  }

  @Override
  public int hashCode() {
    return Objects.hash(enabled, ref, vpnHubs);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceSettingsVPNEdgeToEdgeHub {\n");
