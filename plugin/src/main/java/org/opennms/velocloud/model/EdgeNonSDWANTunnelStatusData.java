...
public class EdgeNonSDWANTunnelStatusData {
  /**
   * Gets or Sets state
   */
  ...
  @SerializedName("local_interface_ip")
  private String localInterfaceIp = null;

  @SerializedName("local_public_ip")
  private String localPublicIp = null;

  @SerializedName("nvs_ip")
  private String nvsIp = null;
  ...
  private BaseApiResource12 provider = null;

  public EdgeNonSDWANTunnelStatusData state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  **/
  ...
  public EdgeNonSDWANTunnelStatusData timestamp(OffsetDateTime timestamp) {
  ...
  **/
  ...
  public EdgeNonSDWANTunnelStatusData link(BaseApiResource3 link) {
    this.link = link;
    return this;
  }
  ...
  **/
  ...
  public EdgeNonSDWANTunnelStatusData localInterfaceIp(String localInterfaceIp) {
    this.localInterfaceIp = localInterfaceIp;
    return this;
  }

   /**
   * Get localInterfaceIp
  ...
  **/
  ...
  public EdgeNonSDWANTunnelStatusData localPublicIp(String localPublicIp) {
  ...
  **/
  ...
  public EdgeNonSDWANTunnelStatusData nvsIp(String nvsIp) {
    this.nvsIp = nvsIp;
    return this;
  }
  ...
  **/
  ...
  public void setNvsIp(String nvsIp) {
    this.nvsIp = nvsIp;
  }

  public EdgeNonSDWANTunnelStatusData pathId(String pathId) {
    this.pathId = pathId;
    return this;
  }
  ...
  **/
  ...
  public EdgeNonSDWANTunnelStatusData segment(BaseApiResource segment) {
  ...
  **/
  ...
  public EdgeNonSDWANTunnelStatusData site(BaseApiResource2 site) {
    this.site = site;
    return this;
  }
  ...
  **/
  ...
  public EdgeNonSDWANTunnelStatusData provider(BaseApiResource12 provider) {
  ...
  **/
  @Schema(description = "")
  public BaseApiResource12 getProvider() {
    return provider;
  }

  public void setProvider(BaseApiResource12 provider) {
    this.provider = provider;
  }
  ...
  public boolean equals(Object o) {
    ...
    EdgeNonSDWANTunnelStatusData edgeNonSDWANTunnelStatusData = (EdgeNonSDWANTunnelStatusData) o;
    return Objects.equals(this.state, edgeNonSDWANTunnelStatusData.state) &&
        Objects.equals(this.timestamp, edgeNonSDWANTunnelStatusData.timestamp) &&
        Objects.equals(this.link, edgeNonSDWANTunnelStatusData.link) &&
        Objects.equals(this.localInterfaceIp, edgeNonSDWANTunnelStatusData.localInterfaceIp) &&
        Objects.equals(this.localPublicIp, edgeNonSDWANTunnelStatusData.localPublicIp) &&
        Objects.equals(this.nvsIp, edgeNonSDWANTunnelStatusData.nvsIp) &&
        Objects.equals(this.pathId, edgeNonSDWANTunnelStatusData.pathId) &&
        Objects.equals(this.segment, edgeNonSDWANTunnelStatusData.segment) &&
        Objects.equals(this.site, edgeNonSDWANTunnelStatusData.site) &&
        Objects.equals(this.provider, edgeNonSDWANTunnelStatusData.provider);
  }

  @Override
  public int hashCode() {
    return Objects.hash(state, timestamp, link, localInterfaceIp, localPublicIp, nvsIp, pathId, segment, site, provider);
  }
  ...
  public String toString() {
    ...
    sb.append("class EdgeNonSDWANTunnelStatusData {\n");
    
    sb.append("    state: ").append(toIndentedString(state)).append("\n");
    sb.append("    timestamp: ").append(toIndentedString(timestamp)).append("\n");
    sb.append("    link: ").append(toIndentedString(link)).append("\n");
    sb.append("    localInterfaceIp: ").append(toIndentedString(localInterfaceIp)).append("\n");
    sb.append("    localPublicIp: ").append(toIndentedString(localPublicIp)).append("\n");
    sb.append("    nvsIp: ").append(toIndentedString(nvsIp)).append("\n");
