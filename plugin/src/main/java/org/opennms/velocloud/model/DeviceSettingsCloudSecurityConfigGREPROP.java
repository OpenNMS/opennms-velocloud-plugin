...
/**
 * DeviceSettingsCloudSecurityConfigGREPROP
 */
...
public class DeviceSettingsCloudSecurityConfigGREPROP {
  @SerializedName("keepaliveIntervalSecs")
  private Integer keepaliveIntervalSecs = null;

  @SerializedName("keepaliveRetries")
  private Integer keepaliveRetries = null;

  public DeviceSettingsCloudSecurityConfigGREPROP keepaliveIntervalSecs(Integer keepaliveIntervalSecs) {
  ...
  **/
  @Schema(description = "")
  public Integer getKeepaliveIntervalSecs() {
    return keepaliveIntervalSecs;
  }

  public void setKeepaliveIntervalSecs(Integer keepaliveIntervalSecs) {
    this.keepaliveIntervalSecs = keepaliveIntervalSecs;
  }

  public DeviceSettingsCloudSecurityConfigGREPROP keepaliveRetries(Integer keepaliveRetries) {
    this.keepaliveRetries = keepaliveRetries;
    return this;
  }

   /**
   * Get keepaliveRetries
   * minimum: 0
   * maximum: 10
  ...
  **/
  ...
  public void setKeepaliveRetries(Integer keepaliveRetries) {
    this.keepaliveRetries = keepaliveRetries;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeviceSettingsCloudSecurityConfigGREPROP deviceSettingsCloudSecurityConfigGREPROP = (DeviceSettingsCloudSecurityConfigGREPROP) o;
    return Objects.equals(this.keepaliveIntervalSecs, deviceSettingsCloudSecurityConfigGREPROP.keepaliveIntervalSecs) &&
        Objects.equals(this.keepaliveRetries, deviceSettingsCloudSecurityConfigGREPROP.keepaliveRetries);
  }

  @Override
  public int hashCode() {
    return Objects.hash(keepaliveIntervalSecs, keepaliveRetries);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceSettingsCloudSecurityConfigGREPROP {\n");
    
    sb.append("    keepaliveIntervalSecs: ").append(toIndentedString(keepaliveIntervalSecs)).append("\n");
    sb.append("    keepaliveRetries: ").append(toIndentedString(keepaliveRetries)).append("\n");
    sb.append("}");
    return sb.toString();
  }
