...
/**
 * GlobalIPv6IcmpV6MessagesConfiguration
 */
...
public class GlobalIPv6IcmpV6MessagesConfiguration {
  @SerializedName("disableDestinationUnreachable")
  private Boolean disableDestinationUnreachable = null;

  @SerializedName("disableTimeExceeded")
  private Boolean disableTimeExceeded = null;

  @SerializedName("disableParameterProblem")
  private Boolean disableParameterProblem = null;

  public GlobalIPv6IcmpV6MessagesConfiguration disableDestinationUnreachable(Boolean disableDestinationUnreachable) {
    this.disableDestinationUnreachable = disableDestinationUnreachable;
    return this;
  }

   /**
   * Get disableDestinationUnreachable
   * @return disableDestinationUnreachable
  **/
  @Schema(description = "")
  public Boolean isDisableDestinationUnreachable() {
    return disableDestinationUnreachable;
  }

  public void setDisableDestinationUnreachable(Boolean disableDestinationUnreachable) {
    this.disableDestinationUnreachable = disableDestinationUnreachable;
  }

  public GlobalIPv6IcmpV6MessagesConfiguration disableTimeExceeded(Boolean disableTimeExceeded) {
    this.disableTimeExceeded = disableTimeExceeded;
    return this;
  }

   /**
   * Get disableTimeExceeded
   * @return disableTimeExceeded
  **/
  @Schema(description = "")
  public Boolean isDisableTimeExceeded() {
    return disableTimeExceeded;
  }

  public void setDisableTimeExceeded(Boolean disableTimeExceeded) {
    this.disableTimeExceeded = disableTimeExceeded;
  }

  public GlobalIPv6IcmpV6MessagesConfiguration disableParameterProblem(Boolean disableParameterProblem) {
    this.disableParameterProblem = disableParameterProblem;
    return this;
  }

   /**
   * Get disableParameterProblem
   * @return disableParameterProblem
  **/
  @Schema(description = "")
  public Boolean isDisableParameterProblem() {
    return disableParameterProblem;
  }

  public void setDisableParameterProblem(Boolean disableParameterProblem) {
    this.disableParameterProblem = disableParameterProblem;
  }
  ...
  public boolean equals(Object o) {
    ...
    GlobalIPv6IcmpV6MessagesConfiguration globalIPv6IcmpV6MessagesConfiguration = (GlobalIPv6IcmpV6MessagesConfiguration) o;
    return Objects.equals(this.disableDestinationUnreachable, globalIPv6IcmpV6MessagesConfiguration.disableDestinationUnreachable) &&
        Objects.equals(this.disableTimeExceeded, globalIPv6IcmpV6MessagesConfiguration.disableTimeExceeded) &&
        Objects.equals(this.disableParameterProblem, globalIPv6IcmpV6MessagesConfiguration.disableParameterProblem);
  }

  @Override
  public int hashCode() {
    return Objects.hash(disableDestinationUnreachable, disableTimeExceeded, disableParameterProblem);
  }
  ...
  public String toString() {
    ...
    sb.append("class GlobalIPv6IcmpV6MessagesConfiguration {\n");
    
    sb.append("    disableDestinationUnreachable: ").append(toIndentedString(disableDestinationUnreachable)).append("\n");
    sb.append("    disableTimeExceeded: ").append(toIndentedString(disableTimeExceeded)).append("\n");
    sb.append("    disableParameterProblem: ").append(toIndentedString(disableParameterProblem)).append("\n");
    sb.append("}");
    return sb.toString();
  }
