...
import org.opennms.velocloud.model.DeviceSettingsRoutedInterfaceAddressingv6;
...
public class DeviceSettingsRoutedInterfacev6Detail {
  @SerializedName("addressing")
  private DeviceSettingsRoutedInterfaceAddressingv6 addressing = null;

  /**
   * Gets or Sets wanOverlay
   */
  @JsonAdapter(WanOverlayEnum.Adapter.class)
  public enum WanOverlayEnum {
    ...
    public static class Adapter extends TypeAdapter<WanOverlayEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final WanOverlayEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public WanOverlayEnum read(final JsonReader jsonReader) throws IOException {
        Object value = jsonReader.nextString();
        return WanOverlayEnum.fromValue(String.valueOf(value));
      }
    }
  }  @SerializedName("wanOverlay")
  private WanOverlayEnum wanOverlay = null;

  /**
   * Gets or Sets rpf
   */
  @JsonAdapter(RpfEnum.Adapter.class)
  public enum RpfEnum {
    SPECIFIC("SPECIFIC"),
    LOOSE("LOOSE"),
    DISABLED("DISABLED");
    ...
    public static class Adapter extends TypeAdapter<RpfEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final RpfEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public RpfEnum read(final JsonReader jsonReader) throws IOException {
        Object value = jsonReader.nextString();
        return RpfEnum.fromValue(String.valueOf(value));
      }
    }
  }  @SerializedName("rpf")
  ...
  public DeviceSettingsRoutedInterfacev6Detail addressing(DeviceSettingsRoutedInterfaceAddressingv6 addressing) {
  ...
  **/
  @Schema(description = "")
  public DeviceSettingsRoutedInterfaceAddressingv6 getAddressing() {
    return addressing;
  }

  public void setAddressing(DeviceSettingsRoutedInterfaceAddressingv6 addressing) {
    this.addressing = addressing;
  }

  public DeviceSettingsRoutedInterfacev6Detail wanOverlay(WanOverlayEnum wanOverlay) {
  ...
  **/
  ...
  public DeviceSettingsRoutedInterfacev6Detail rpf(RpfEnum rpf) {
    this.rpf = rpf;
    return this;
  }
  ...
  **/
  ...
  public DeviceSettingsRoutedInterfacev6Detail trusted(Boolean trusted) {
  ...
  **/
  ...
  public DeviceSettingsRoutedInterfacev6Detail natDirect(Boolean natDirect) {
  ...
  **/
  ...
  public DeviceSettingsRoutedInterfacev6Detail dhcpServer(DeviceSettingsDHCPV6 dhcpServer) {
  ...
  **/
  ...
  public DeviceSettingsRoutedInterfacev6Detail routerAdvertisementHostSettings(DeviceSettingsRouterAdvertisementHostSettings routerAdvertisementHostSettings) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceSettingsRoutedInterfacev6Detail deviceSettingsRoutedInterfacev6Detail = (DeviceSettingsRoutedInterfacev6Detail) o;
    return Objects.equals(this.addressing, deviceSettingsRoutedInterfacev6Detail.addressing) &&
        Objects.equals(this.wanOverlay, deviceSettingsRoutedInterfacev6Detail.wanOverlay) &&
        Objects.equals(this.rpf, deviceSettingsRoutedInterfacev6Detail.rpf) &&
        Objects.equals(this.trusted, deviceSettingsRoutedInterfacev6Detail.trusted) &&
        Objects.equals(this.natDirect, deviceSettingsRoutedInterfacev6Detail.natDirect) &&
        Objects.equals(this.dhcpServer, deviceSettingsRoutedInterfacev6Detail.dhcpServer) &&
        Objects.equals(this.routerAdvertisementHostSettings, deviceSettingsRoutedInterfacev6Detail.routerAdvertisementHostSettings);
  }

  @Override
  public int hashCode() {
    return Objects.hash(addressing, wanOverlay, rpf, trusted, natDirect, dhcpServer, routerAdvertisementHostSettings);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceSettingsRoutedInterfacev6Detail {\n");
