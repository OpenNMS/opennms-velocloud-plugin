 ...
 */
@Schema(description = "Applicable only for CELL interfaces")
...
public class EnterpriseDeviceSettingsCellular {
  @SerializedName("simPin")
  private AnyOfEnterpriseDeviceSettingsCellularSimPin simPin = null;
  ...
  @SerializedName("apn")
  private AnyOfEnterpriseDeviceSettingsCellularApn apn = null;
  ...
  public enum IptypeEnum {
    ...
    public static IptypeEnum fromValue(String text) {
    ...
    public static class Adapter extends TypeAdapter<IptypeEnum> {
      ...
      public IptypeEnum read(final JsonReader jsonReader) throws IOException {
        Object value = jsonReader.nextString();
        return IptypeEnum.fromValue(String.valueOf(value));
      }
    }
  ...
  private AnyOfEnterpriseDeviceSettingsCellularUsername username = null;

  @SerializedName("password")
  private AnyOfEnterpriseDeviceSettingsCellularPassword password = null;

  public EnterpriseDeviceSettingsCellular simPin(AnyOfEnterpriseDeviceSettingsCellularSimPin simPin) {
    this.simPin = simPin;
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public AnyOfEnterpriseDeviceSettingsCellularSimPin getSimPin() {
    return simPin;
  }

  public void setSimPin(AnyOfEnterpriseDeviceSettingsCellularSimPin simPin) {
    this.simPin = simPin;
  }

  public EnterpriseDeviceSettingsCellular network(NetworkEnum network) {
  ...
  **/
  ...
  public EnterpriseDeviceSettingsCellular apn(AnyOfEnterpriseDeviceSettingsCellularApn apn) {
    this.apn = apn;
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public AnyOfEnterpriseDeviceSettingsCellularApn getApn() {
    return apn;
  }

  public void setApn(AnyOfEnterpriseDeviceSettingsCellularApn apn) {
    this.apn = apn;
  }

  public EnterpriseDeviceSettingsCellular iptype(IptypeEnum iptype) {
    this.iptype = iptype;
    return this;
  }
  ...
  **/
  ...
  public EnterpriseDeviceSettingsCellular username(AnyOfEnterpriseDeviceSettingsCellularUsername username) {
  ...
  **/
  @Schema(description = "")
  public AnyOfEnterpriseDeviceSettingsCellularUsername getUsername() {
    return username;
  }

  public void setUsername(AnyOfEnterpriseDeviceSettingsCellularUsername username) {
    this.username = username;
  }

  public EnterpriseDeviceSettingsCellular password(AnyOfEnterpriseDeviceSettingsCellularPassword password) {
  ...
  **/
  @Schema(description = "")
  public AnyOfEnterpriseDeviceSettingsCellularPassword getPassword() {
    return password;
  }

  public void setPassword(AnyOfEnterpriseDeviceSettingsCellularPassword password) {
    this.password = password;
  }
  ...
  public boolean equals(Object o) {
    ...
    EnterpriseDeviceSettingsCellular enterpriseDeviceSettingsCellular = (EnterpriseDeviceSettingsCellular) o;
    return Objects.equals(this.simPin, enterpriseDeviceSettingsCellular.simPin) &&
        Objects.equals(this.network, enterpriseDeviceSettingsCellular.network) &&
        Objects.equals(this.apn, enterpriseDeviceSettingsCellular.apn) &&
        Objects.equals(this.iptype, enterpriseDeviceSettingsCellular.iptype) &&
        Objects.equals(this.username, enterpriseDeviceSettingsCellular.username) &&
        Objects.equals(this.password, enterpriseDeviceSettingsCellular.password);
  }

  @Override
  public int hashCode() {
    return Objects.hash(simPin, network, apn, iptype, username, password);
  }
  ...
  public String toString() {
    ...
    sb.append("class EnterpriseDeviceSettingsCellular {\n");
    
    sb.append("    simPin: ").append(toIndentedString(simPin)).append("\n");
