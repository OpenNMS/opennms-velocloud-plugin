...
public class BaseApiResource14 {
  ...
  public BaseApiResource14 _href(String _href) {
    this._href = _href;
    return this;
  }
  ...
  **/
  ...
  public BaseApiResource14 id(Float id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public BaseApiResource14 name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    BaseApiResource14 baseApiResource14 = (BaseApiResource14) o;
    return Objects.equals(this._href, baseApiResource14._href) &&
        Objects.equals(this.id, baseApiResource14.id) &&
        Objects.equals(this.name, baseApiResource14.name);
  }

  @Override
  public int hashCode() {
    return Objects.hash(_href, id, name);
  }
  ...
  public String toString() {
    ...
    sb.append("class BaseApiResource14 {\n");
