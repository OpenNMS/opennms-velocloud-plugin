...
public class DeviceSettingsSNMPv2C {
  ...
  public DeviceSettingsSNMPv2C enabled(Boolean enabled) {
  ...
  **/
  ...
  public DeviceSettingsSNMPv2C community(String community) {
  ...
  **/
  ...
  public DeviceSettingsSNMPv2C allowedIp(List<String> allowedIp) {
    this.allowedIp = allowedIp;
    return this;
  }

  public DeviceSettingsSNMPv2C addAllowedIpItem(String allowedIpItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceSettingsSNMPv2C deviceSettingsSNMPv2C = (DeviceSettingsSNMPv2C) o;
    return Objects.equals(this.enabled, deviceSettingsSNMPv2C.enabled) &&
        Objects.equals(this.community, deviceSettingsSNMPv2C.community) &&
        Objects.equals(this.allowedIp, deviceSettingsSNMPv2C.allowedIp);
  }

  @Override
  public int hashCode() {
    return Objects.hash(enabled, community, allowedIp);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceSettingsSNMPv2C {\n");
