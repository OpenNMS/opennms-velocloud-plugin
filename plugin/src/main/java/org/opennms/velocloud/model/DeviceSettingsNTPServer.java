...
public class DeviceSettingsNTPServer {
  @SerializedName("server")
  private String server = null;

  public DeviceSettingsNTPServer server(String server) {
    this.server = server;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceSettingsNTPServer deviceSettingsNTPServer = (DeviceSettingsNTPServer) o;
    return Objects.equals(this.server, deviceSettingsNTPServer.server);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceSettingsNTPServer {\n");
