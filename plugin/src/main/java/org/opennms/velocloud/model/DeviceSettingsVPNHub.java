...
public class DeviceSettingsVPNHub {
  ...
  public DeviceSettingsVPNHub logicalId(String logicalId) {
  ...
  **/
  ...
  public DeviceSettingsVPNHub name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public DeviceSettingsVPNHub type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceSettingsVPNHub deviceSettingsVPNHub = (DeviceSettingsVPNHub) o;
    return Objects.equals(this.logicalId, deviceSettingsVPNHub.logicalId) &&
        Objects.equals(this.name, deviceSettingsVPNHub.name) &&
        Objects.equals(this.type, deviceSettingsVPNHub.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(logicalId, name, type);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceSettingsVPNHub {\n");
