...
import org.opennms.velocloud.model.DeviceSettingsSoftwareUpdateWindow;
/**
...
public class DeviceSettingsSoftwareUpdate {
  @SerializedName("windowed")
  private Boolean windowed = null;

  @SerializedName("window")
  private DeviceSettingsSoftwareUpdateWindow window = null;

  public DeviceSettingsSoftwareUpdate windowed(Boolean windowed) {
  ...
  **/
  ...
  public DeviceSettingsSoftwareUpdate window(DeviceSettingsSoftwareUpdateWindow window) {
    this.window = window;
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public DeviceSettingsSoftwareUpdateWindow getWindow() {
    return window;
  }

  public void setWindow(DeviceSettingsSoftwareUpdateWindow window) {
    this.window = window;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeviceSettingsSoftwareUpdate deviceSettingsSoftwareUpdate = (DeviceSettingsSoftwareUpdate) o;
    return Objects.equals(this.windowed, deviceSettingsSoftwareUpdate.windowed) &&
        Objects.equals(this.window, deviceSettingsSoftwareUpdate.window);
  }

  @Override
  public int hashCode() {
    return Objects.hash(windowed, window);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceSettingsSoftwareUpdate {\n");
    
    sb.append("    windowed: ").append(toIndentedString(windowed)).append("\n");
