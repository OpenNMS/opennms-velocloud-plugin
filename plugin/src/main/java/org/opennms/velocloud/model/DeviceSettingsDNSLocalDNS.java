...
public class DeviceSettingsDNSLocalDNS {
  @SerializedName("ipv4Address")
  private List<String> ipv4Address = null;
  ...
  public DeviceSettingsDNSLocalDNS ipv4Address(List<String> ipv4Address) {
    this.ipv4Address = ipv4Address;
    return this;
  }

  public DeviceSettingsDNSLocalDNS addIpv4AddressItem(String ipv4AddressItem) {
    if (this.ipv4Address == null) {
      this.ipv4Address = new ArrayList<>();
    }
    this.ipv4Address.add(ipv4AddressItem);
    return this;
  }
  ...
  **/
  ...
  public DeviceSettingsDNSLocalDNS ipv6Address(List<String> ipv6Address) {
    this.ipv6Address = ipv6Address;
    return this;
  }

  public DeviceSettingsDNSLocalDNS addIpv6AddressItem(String ipv6AddressItem) {
  ...
  **/
  ...
  public DeviceSettingsDNSLocalDNS fqdn(String fqdn) {
    this.fqdn = fqdn;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceSettingsDNSLocalDNS deviceSettingsDNSLocalDNS = (DeviceSettingsDNSLocalDNS) o;
    return Objects.equals(this.ipv4Address, deviceSettingsDNSLocalDNS.ipv4Address) &&
        Objects.equals(this.ipv6Address, deviceSettingsDNSLocalDNS.ipv6Address) &&
        Objects.equals(this.fqdn, deviceSettingsDNSLocalDNS.fqdn);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ipv4Address, ipv6Address, fqdn);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceSettingsDNSLocalDNS {\n");
