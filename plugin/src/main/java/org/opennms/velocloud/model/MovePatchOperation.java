...
public class MovePatchOperation implements AnyOfPatchSchemaItems {
  /**
   * Gets or Sets op
   */
  ...
  public MovePatchOperation op(OpEnum op) {
    this.op = op;
    return this;
  }
  ...
  **/
  ...
  public MovePatchOperation from(String from) {
    this.from = from;
    return this;
  }
  ...
  **/
  ...
  public MovePatchOperation path(String path) {
    this.path = path;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    MovePatchOperation movePatchOperation = (MovePatchOperation) o;
    return Objects.equals(this.op, movePatchOperation.op) &&
        Objects.equals(this.from, movePatchOperation.from) &&
        Objects.equals(this.path, movePatchOperation.path);
  }

  @Override
  public int hashCode() {
    return Objects.hash(op, from, path);
  }
  ...
  public String toString() {
    ...
    sb.append("class MovePatchOperation {\n");
