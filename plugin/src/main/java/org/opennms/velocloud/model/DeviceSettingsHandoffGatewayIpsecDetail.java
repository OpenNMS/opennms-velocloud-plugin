...
/**
 * DeviceSettingsHandoffGatewayIpsecDetail
 */
...
public class DeviceSettingsHandoffGatewayIpsecDetail {
  @SerializedName("ipsecGatewayAddress")
  private String ipsecGatewayAddress = null;

  @SerializedName("strictHostCheck")
  private Boolean strictHostCheck = null;

  public DeviceSettingsHandoffGatewayIpsecDetail ipsecGatewayAddress(String ipsecGatewayAddress) {
    this.ipsecGatewayAddress = ipsecGatewayAddress;
    return this;
  }

   /**
   * Get ipsecGatewayAddress
   * @return ipsecGatewayAddress
  **/
  @Schema(description = "")
  public String getIpsecGatewayAddress() {
    return ipsecGatewayAddress;
  }

  public void setIpsecGatewayAddress(String ipsecGatewayAddress) {
    this.ipsecGatewayAddress = ipsecGatewayAddress;
  }

  public DeviceSettingsHandoffGatewayIpsecDetail strictHostCheck(Boolean strictHostCheck) {
  ...
  **/
  @Schema(description = "")
  public Boolean isStrictHostCheck() {
    return strictHostCheck;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeviceSettingsHandoffGatewayIpsecDetail deviceSettingsHandoffGatewayIpsecDetail = (DeviceSettingsHandoffGatewayIpsecDetail) o;
    return Objects.equals(this.ipsecGatewayAddress, deviceSettingsHandoffGatewayIpsecDetail.ipsecGatewayAddress) &&
        Objects.equals(this.strictHostCheck, deviceSettingsHandoffGatewayIpsecDetail.strictHostCheck);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ipsecGatewayAddress, strictHostCheck);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceSettingsHandoffGatewayIpsecDetail {\n");
    
    sb.append("    ipsecGatewayAddress: ").append(toIndentedString(ipsecGatewayAddress)).append("\n");
    sb.append("    strictHostCheck: ").append(toIndentedString(strictHostCheck)).append("\n");
    sb.append("}");
    return sb.toString();
  }
