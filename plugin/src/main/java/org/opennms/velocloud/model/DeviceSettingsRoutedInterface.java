...
import org.opennms.velocloud.model.DeviceSettingsLANL2;
import org.opennms.velocloud.model.DeviceSettingsRoutedInterfaceAddressing;
import org.opennms.velocloud.model.DeviceSettingsRoutedInterfaceOSPF;
import org.opennms.velocloud.model.DeviceSettingsRoutedInterfacev6Detail;
import org.opennms.velocloud.model.DeviceSettingsSubInterface;
import org.opennms.velocloud.model.EnterpriseDeviceSettingsCellular;
import org.opennms.velocloud.model.EnterpriseDeviceSettingsDslSettings;
import org.opennms.velocloud.model.EnterpriseDeviceSettingsMulticast;
import org.opennms.velocloud.model.EnterpriseDeviceSettingsRadiusAuthentication;
/**
...
public class DeviceSettingsRoutedInterface {
  ...
  @SerializedName("disableV4")
  private Boolean disableV4 = null;

  @SerializedName("disableV6")
  private Boolean disableV6 = null;

  /**
   * Gets or Sets overlayPreference
   */
  @JsonAdapter(OverlayPreferenceEnum.Adapter.class)
  public enum OverlayPreferenceEnum {
    ...
    public static class Adapter extends TypeAdapter<OverlayPreferenceEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final OverlayPreferenceEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public OverlayPreferenceEnum read(final JsonReader jsonReader) throws IOException {
        Object value = jsonReader.nextString();
        return OverlayPreferenceEnum.fromValue(String.valueOf(value));
      }
    }
  }  @SerializedName("overlayPreference")
  ...
  @SerializedName("evdslModemAttached")
  private Boolean evdslModemAttached = false;

  @SerializedName("radiusAuthentication")
   ...
   */
  @JsonAdapter(SfpTypeEnum.Adapter.class)
  public enum SfpTypeEnum {
    ...
    public static class Adapter extends TypeAdapter<SfpTypeEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final SfpTypeEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public SfpTypeEnum read(final JsonReader jsonReader) throws IOException {
        Object value = jsonReader.nextString();
        return SfpTypeEnum.fromValue(String.valueOf(value));
      }
    }
  }  @SerializedName("sfpType")
  private SfpTypeEnum sfpType = null;

  @SerializedName("subinterfaces")
  ...
  @SerializedName("underlayAccounting")
