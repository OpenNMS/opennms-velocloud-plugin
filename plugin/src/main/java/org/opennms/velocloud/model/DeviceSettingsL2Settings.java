...
public class DeviceSettingsL2Settings {
  @SerializedName("overrideARPTimeout")
  private Boolean overrideARPTimeout = null;

  @SerializedName("arpStaleTimeoutMinutes")
  private Integer arpStaleTimeoutMinutes = null;

  @SerializedName("arpDeadTimeoutMinutes")
  private Integer arpDeadTimeoutMinutes = null;

  @SerializedName("arpCleanupTimeoutMinutes")
  private Integer arpCleanupTimeoutMinutes = null;

  public DeviceSettingsL2Settings overrideARPTimeout(Boolean overrideARPTimeout) {
    this.overrideARPTimeout = overrideARPTimeout;
    return this;
  }

   /**
   * Get overrideARPTimeout
   * @return overrideARPTimeout
  **/
  @Schema(description = "")
  public Boolean isOverrideARPTimeout() {
    return overrideARPTimeout;
  }

  public void setOverrideARPTimeout(Boolean overrideARPTimeout) {
    this.overrideARPTimeout = overrideARPTimeout;
  }

  public DeviceSettingsL2Settings arpStaleTimeoutMinutes(Integer arpStaleTimeoutMinutes) {
    this.arpStaleTimeoutMinutes = arpStaleTimeoutMinutes;
    return this;
  }

   /**
   * Get arpStaleTimeoutMinutes
   * @return arpStaleTimeoutMinutes
  **/
  @Schema(description = "")
  public Integer getArpStaleTimeoutMinutes() {
    return arpStaleTimeoutMinutes;
  }

  public void setArpStaleTimeoutMinutes(Integer arpStaleTimeoutMinutes) {
    this.arpStaleTimeoutMinutes = arpStaleTimeoutMinutes;
  }

  public DeviceSettingsL2Settings arpDeadTimeoutMinutes(Integer arpDeadTimeoutMinutes) {
    this.arpDeadTimeoutMinutes = arpDeadTimeoutMinutes;
    return this;
  }

   /**
   * Get arpDeadTimeoutMinutes
   * @return arpDeadTimeoutMinutes
  **/
  @Schema(description = "")
  public Integer getArpDeadTimeoutMinutes() {
    return arpDeadTimeoutMinutes;
  }

  public void setArpDeadTimeoutMinutes(Integer arpDeadTimeoutMinutes) {
    this.arpDeadTimeoutMinutes = arpDeadTimeoutMinutes;
  }

  public DeviceSettingsL2Settings arpCleanupTimeoutMinutes(Integer arpCleanupTimeoutMinutes) {
    this.arpCleanupTimeoutMinutes = arpCleanupTimeoutMinutes;
    return this;
  }

   /**
   * Get arpCleanupTimeoutMinutes
   * @return arpCleanupTimeoutMinutes
  **/
  @Schema(description = "")
  public Integer getArpCleanupTimeoutMinutes() {
    return arpCleanupTimeoutMinutes;
  }

  public void setArpCleanupTimeoutMinutes(Integer arpCleanupTimeoutMinutes) {
    this.arpCleanupTimeoutMinutes = arpCleanupTimeoutMinutes;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeviceSettingsL2Settings deviceSettingsL2Settings = (DeviceSettingsL2Settings) o;
    return Objects.equals(this.overrideARPTimeout, deviceSettingsL2Settings.overrideARPTimeout) &&
        Objects.equals(this.arpStaleTimeoutMinutes, deviceSettingsL2Settings.arpStaleTimeoutMinutes) &&
        Objects.equals(this.arpDeadTimeoutMinutes, deviceSettingsL2Settings.arpDeadTimeoutMinutes) &&
        Objects.equals(this.arpCleanupTimeoutMinutes, deviceSettingsL2Settings.arpCleanupTimeoutMinutes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(overrideARPTimeout, arpStaleTimeoutMinutes, arpDeadTimeoutMinutes, arpCleanupTimeoutMinutes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceSettingsL2Settings {\n");
    
    sb.append("    overrideARPTimeout: ").append(toIndentedString(overrideARPTimeout)).append("\n");
    sb.append("    arpStaleTimeoutMinutes: ").append(toIndentedString(arpStaleTimeoutMinutes)).append("\n");
    sb.append("    arpDeadTimeoutMinutes: ").append(toIndentedString(arpDeadTimeoutMinutes)).append("\n");
    sb.append("    arpCleanupTimeoutMinutes: ").append(toIndentedString(arpCleanupTimeoutMinutes)).append("\n");
    sb.append("}");
    return sb.toString();
  }
