...
/**
 * DeviceSettingsVPNEdgeToEdgeDetailProfileIsolation
 */
...
public class DeviceSettingsVPNEdgeToEdgeDetailProfileIsolation {
  @SerializedName("enabled")
  private Boolean enabled = null;

  @SerializedName("profileLogicalId")
  private String profileLogicalId = null;

  @SerializedName("isolateDynamic")
  private Boolean isolateDynamic = null;

  public DeviceSettingsVPNEdgeToEdgeDetailProfileIsolation enabled(Boolean enabled) {
  ...
  **/
  ...
  public DeviceSettingsVPNEdgeToEdgeDetailProfileIsolation profileLogicalId(String profileLogicalId) {
    this.profileLogicalId = profileLogicalId;
    return this;
  }

   /**
   * Get profileLogicalId
   * @return profileLogicalId
  **/
  @Schema(description = "")
  public String getProfileLogicalId() {
    return profileLogicalId;
  }

  public void setProfileLogicalId(String profileLogicalId) {
    this.profileLogicalId = profileLogicalId;
  }

  public DeviceSettingsVPNEdgeToEdgeDetailProfileIsolation isolateDynamic(Boolean isolateDynamic) {
    this.isolateDynamic = isolateDynamic;
    return this;
  }

   /**
   * Get isolateDynamic
   * @return isolateDynamic
  **/
  @Schema(description = "")
  public Boolean isIsolateDynamic() {
    return isolateDynamic;
  }

  public void setIsolateDynamic(Boolean isolateDynamic) {
    this.isolateDynamic = isolateDynamic;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeviceSettingsVPNEdgeToEdgeDetailProfileIsolation deviceSettingsVPNEdgeToEdgeDetailProfileIsolation = (DeviceSettingsVPNEdgeToEdgeDetailProfileIsolation) o;
    return Objects.equals(this.enabled, deviceSettingsVPNEdgeToEdgeDetailProfileIsolation.enabled) &&
        Objects.equals(this.profileLogicalId, deviceSettingsVPNEdgeToEdgeDetailProfileIsolation.profileLogicalId) &&
        Objects.equals(this.isolateDynamic, deviceSettingsVPNEdgeToEdgeDetailProfileIsolation.isolateDynamic);
  }

  @Override
  public int hashCode() {
    return Objects.hash(enabled, profileLogicalId, isolateDynamic);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceSettingsVPNEdgeToEdgeDetailProfileIsolation {\n");
    
    sb.append("    enabled: ").append(toIndentedString(enabled)).append("\n");
    sb.append("    profileLogicalId: ").append(toIndentedString(profileLogicalId)).append("\n");
    sb.append("    isolateDynamic: ").append(toIndentedString(isolateDynamic)).append("\n");
    sb.append("}");
    return sb.toString();
  }
