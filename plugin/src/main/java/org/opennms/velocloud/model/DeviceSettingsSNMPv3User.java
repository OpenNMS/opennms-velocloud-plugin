...
public class DeviceSettingsSNMPv3User {
  @SerializedName("name")
  ...
  @SerializedName("encrAlg")
  private String encrAlg = null;

  public DeviceSettingsSNMPv3User name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public DeviceSettingsSNMPv3User passphrase(String passphrase) {
  ...
  **/
  ...
  public DeviceSettingsSNMPv3User authAlg(String authAlg) {
  ...
  **/
  ...
  public DeviceSettingsSNMPv3User privacy(Boolean privacy) {
  ...
  **/
  ...
  public DeviceSettingsSNMPv3User encrAlg(String encrAlg) {
  ...
  **/
  ...
  public void setEncrAlg(String encrAlg) {
    this.encrAlg = encrAlg;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeviceSettingsSNMPv3User deviceSettingsSNMPv3User = (DeviceSettingsSNMPv3User) o;
    return Objects.equals(this.name, deviceSettingsSNMPv3User.name) &&
        Objects.equals(this.passphrase, deviceSettingsSNMPv3User.passphrase) &&
        Objects.equals(this.authAlg, deviceSettingsSNMPv3User.authAlg) &&
        Objects.equals(this.privacy, deviceSettingsSNMPv3User.privacy) &&
        Objects.equals(this.encrAlg, deviceSettingsSNMPv3User.encrAlg);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, passphrase, authAlg, privacy, encrAlg);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceSettingsSNMPv3User {\n");
    
    sb.append("    name: ").append(toIndentedString(name)).append("\n");
    sb.append("    passphrase: ").append(toIndentedString(passphrase)).append("\n");
    sb.append("    authAlg: ").append(toIndentedString(authAlg)).append("\n");
    sb.append("    privacy: ").append(toIndentedString(privacy)).append("\n");
    sb.append("    encrAlg: ").append(toIndentedString(encrAlg)).append("\n");
    sb.append("}");
    return sb.toString();
  }
