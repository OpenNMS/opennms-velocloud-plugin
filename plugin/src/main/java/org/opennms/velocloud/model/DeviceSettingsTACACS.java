...
public class DeviceSettingsTACACS {
  @SerializedName("tacacsService")
  private BaseApiResource11 tacacsService = null;
  ...
  public DeviceSettingsTACACS tacacsService(BaseApiResource11 tacacsService) {
   ...
   /**
   * Get tacacsService
   * @return tacacsService
  **/
  @Schema(description = "")
  public BaseApiResource11 getTacacsService() {
    return tacacsService;
  }

  public void setTacacsService(BaseApiResource11 tacacsService) {
    this.tacacsService = tacacsService;
  }

  public DeviceSettingsTACACS ref(RefEnum ref) {
    this.ref = ref;
    return this;
  }
  ...
  **/
  ...
  public DeviceSettingsTACACS sourceInterface(String sourceInterface) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceSettingsTACACS deviceSettingsTACACS = (DeviceSettingsTACACS) o;
    return Objects.equals(this.tacacsService, deviceSettingsTACACS.tacacsService) &&
        Objects.equals(this.ref, deviceSettingsTACACS.ref) &&
        Objects.equals(this.sourceInterface, deviceSettingsTACACS.sourceInterface);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tacacsService, ref, sourceInterface);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceSettingsTACACS {\n");
    
    sb.append("    tacacsService: ").append(toIndentedString(tacacsService)).append("\n");
