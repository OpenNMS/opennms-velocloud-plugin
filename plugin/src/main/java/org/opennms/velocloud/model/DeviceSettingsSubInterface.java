...
public class DeviceSettingsSubInterface {
  @SerializedName("subinterfaceId")
  private Integer subinterfaceId = null;

  /**
   * Gets or Sets subinterfaceType
   */
  @JsonAdapter(SubinterfaceTypeEnum.Adapter.class)
  public enum SubinterfaceTypeEnum {
    SECONDARY_IP("SECONDARY_IP"),
    SUB_INTERFACE("SUB_INTERFACE");

    private String value;

    SubinterfaceTypeEnum(String value) {
      this.value = value;
    }
    ...
    public static SubinterfaceTypeEnum fromValue(String text) {
      for (SubinterfaceTypeEnum b : SubinterfaceTypeEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<SubinterfaceTypeEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final SubinterfaceTypeEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public SubinterfaceTypeEnum read(final JsonReader jsonReader) throws IOException {
        Object value = jsonReader.nextString();
        return SubinterfaceTypeEnum.fromValue(String.valueOf(value));
      }
    }
  }  @SerializedName("subinterfaceType")
  private SubinterfaceTypeEnum subinterfaceType = null;

  public DeviceSettingsSubInterface subinterfaceId(Integer subinterfaceId) {
  ...
  **/
  ...
  public DeviceSettingsSubInterface subinterfaceType(SubinterfaceTypeEnum subinterfaceType) {
    this.subinterfaceType = subinterfaceType;
    return this;
  }

   /**
   * Get subinterfaceType
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceSettingsSubInterface deviceSettingsSubInterface = (DeviceSettingsSubInterface) o;
    return Objects.equals(this.subinterfaceId, deviceSettingsSubInterface.subinterfaceId) &&
        Objects.equals(this.subinterfaceType, deviceSettingsSubInterface.subinterfaceType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(subinterfaceId, subinterfaceType);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceSettingsSubInterface {\n");
    
    sb.append("    subinterfaceId: ").append(toIndentedString(subinterfaceId)).append("\n");
    sb.append("    subinterfaceType: ").append(toIndentedString(subinterfaceType)).append("\n");
    sb.append("}");
    return sb.toString();
  }
