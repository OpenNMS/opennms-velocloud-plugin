...
/**
 * DeviceSettingsOSPFBGPRedistribution
 */
...
public class DeviceSettingsOSPFBGPRedistribution {
  ...
  public enum MetricTypeEnum {
    ...
    public static class Adapter extends TypeAdapter<MetricTypeEnum> {
      ...
      public MetricTypeEnum read(final JsonReader jsonReader) throws IOException {
        ...
        return MetricTypeEnum.fromValue(String.valueOf(value));
      }
    }
  }  @SerializedName("metricType")
  private MetricTypeEnum metricType = null;

  public DeviceSettingsOSPFBGPRedistribution enabled(Boolean enabled) {
  ...
  **/
  ...
  public DeviceSettingsOSPFBGPRedistribution metric(Integer metric) {
    this.metric = metric;
    return this;
  }
  ...
  **/
  ...
  public DeviceSettingsOSPFBGPRedistribution metricType(MetricTypeEnum metricType) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceSettingsOSPFBGPRedistribution deviceSettingsOSPFBGPRedistribution = (DeviceSettingsOSPFBGPRedistribution) o;
    return Objects.equals(this.enabled, deviceSettingsOSPFBGPRedistribution.enabled) &&
        Objects.equals(this.metric, deviceSettingsOSPFBGPRedistribution.metric) &&
        Objects.equals(this.metricType, deviceSettingsOSPFBGPRedistribution.metricType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(enabled, metric, metricType);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceSettingsOSPFBGPRedistribution {\n");
