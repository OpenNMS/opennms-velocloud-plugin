...
/**
 * GlobalIPv6AdvancedConfiguration
 */
...
public class GlobalIPv6AdvancedConfiguration {
  @SerializedName("disableAllIPv6Traffic")
  private Boolean disableAllIPv6Traffic = null;

  @SerializedName("dropRoutingHeaderTypeZeroPackets")
  private Boolean dropRoutingHeaderTypeZeroPackets = null;

  @SerializedName("enforceExtensionHeaderValidation")
  private Boolean enforceExtensionHeaderValidation = null;

  @SerializedName("enforceExtensionHeaderOrderCheck")
  private Boolean enforceExtensionHeaderOrderCheck = null;

  @SerializedName("dropnLogPacketsForRFCReservedFields")
  private Boolean dropnLogPacketsForRFCReservedFields = null;

  public GlobalIPv6AdvancedConfiguration disableAllIPv6Traffic(Boolean disableAllIPv6Traffic) {
    this.disableAllIPv6Traffic = disableAllIPv6Traffic;
    return this;
  }

   /**
   * Get disableAllIPv6Traffic
   * @return disableAllIPv6Traffic
  **/
  @Schema(description = "")
  public Boolean isDisableAllIPv6Traffic() {
    return disableAllIPv6Traffic;
  }

  public void setDisableAllIPv6Traffic(Boolean disableAllIPv6Traffic) {
    this.disableAllIPv6Traffic = disableAllIPv6Traffic;
  }

  public GlobalIPv6AdvancedConfiguration dropRoutingHeaderTypeZeroPackets(Boolean dropRoutingHeaderTypeZeroPackets) {
    this.dropRoutingHeaderTypeZeroPackets = dropRoutingHeaderTypeZeroPackets;
    return this;
  }

   /**
   * Get dropRoutingHeaderTypeZeroPackets
   * @return dropRoutingHeaderTypeZeroPackets
  **/
  @Schema(description = "")
  public Boolean isDropRoutingHeaderTypeZeroPackets() {
    return dropRoutingHeaderTypeZeroPackets;
  }

  public void setDropRoutingHeaderTypeZeroPackets(Boolean dropRoutingHeaderTypeZeroPackets) {
    this.dropRoutingHeaderTypeZeroPackets = dropRoutingHeaderTypeZeroPackets;
  }

  public GlobalIPv6AdvancedConfiguration enforceExtensionHeaderValidation(Boolean enforceExtensionHeaderValidation) {
    this.enforceExtensionHeaderValidation = enforceExtensionHeaderValidation;
    return this;
  }

   /**
   * Get enforceExtensionHeaderValidation
   * @return enforceExtensionHeaderValidation
  **/
  @Schema(description = "")
  public Boolean isEnforceExtensionHeaderValidation() {
    return enforceExtensionHeaderValidation;
  }

  public void setEnforceExtensionHeaderValidation(Boolean enforceExtensionHeaderValidation) {
    this.enforceExtensionHeaderValidation = enforceExtensionHeaderValidation;
  }

  public GlobalIPv6AdvancedConfiguration enforceExtensionHeaderOrderCheck(Boolean enforceExtensionHeaderOrderCheck) {
    this.enforceExtensionHeaderOrderCheck = enforceExtensionHeaderOrderCheck;
    return this;
  }

   /**
   * Get enforceExtensionHeaderOrderCheck
   * @return enforceExtensionHeaderOrderCheck
  **/
  @Schema(description = "")
  public Boolean isEnforceExtensionHeaderOrderCheck() {
    return enforceExtensionHeaderOrderCheck;
  }

  public void setEnforceExtensionHeaderOrderCheck(Boolean enforceExtensionHeaderOrderCheck) {
    this.enforceExtensionHeaderOrderCheck = enforceExtensionHeaderOrderCheck;
  }

  public GlobalIPv6AdvancedConfiguration dropnLogPacketsForRFCReservedFields(Boolean dropnLogPacketsForRFCReservedFields) {
    this.dropnLogPacketsForRFCReservedFields = dropnLogPacketsForRFCReservedFields;
    return this;
  }

   /**
   * Get dropnLogPacketsForRFCReservedFields
   * @return dropnLogPacketsForRFCReservedFields
  **/
  @Schema(description = "")
  public Boolean isDropnLogPacketsForRFCReservedFields() {
    return dropnLogPacketsForRFCReservedFields;
  }

  public void setDropnLogPacketsForRFCReservedFields(Boolean dropnLogPacketsForRFCReservedFields) {
    this.dropnLogPacketsForRFCReservedFields = dropnLogPacketsForRFCReservedFields;
  }
  ...
  public boolean equals(Object o) {
    ...
    GlobalIPv6AdvancedConfiguration globalIPv6AdvancedConfiguration = (GlobalIPv6AdvancedConfiguration) o;
    return Objects.equals(this.disableAllIPv6Traffic, globalIPv6AdvancedConfiguration.disableAllIPv6Traffic) &&
        Objects.equals(this.dropRoutingHeaderTypeZeroPackets, globalIPv6AdvancedConfiguration.dropRoutingHeaderTypeZeroPackets) &&
        Objects.equals(this.enforceExtensionHeaderValidation, globalIPv6AdvancedConfiguration.enforceExtensionHeaderValidation) &&
        Objects.equals(this.enforceExtensionHeaderOrderCheck, globalIPv6AdvancedConfiguration.enforceExtensionHeaderOrderCheck) &&
        Objects.equals(this.dropnLogPacketsForRFCReservedFields, globalIPv6AdvancedConfiguration.dropnLogPacketsForRFCReservedFields);
  }

  @Override
  public int hashCode() {
    return Objects.hash(disableAllIPv6Traffic, dropRoutingHeaderTypeZeroPackets, enforceExtensionHeaderValidation, enforceExtensionHeaderOrderCheck, dropnLogPacketsForRFCReservedFields);
  }
  ...
  public String toString() {
    ...
    sb.append("class GlobalIPv6AdvancedConfiguration {\n");
    
    sb.append("    disableAllIPv6Traffic: ").append(toIndentedString(disableAllIPv6Traffic)).append("\n");
    sb.append("    dropRoutingHeaderTypeZeroPackets: ").append(toIndentedString(dropRoutingHeaderTypeZeroPackets)).append("\n");
    sb.append("    enforceExtensionHeaderValidation: ").append(toIndentedString(enforceExtensionHeaderValidation)).append("\n");
    sb.append("    enforceExtensionHeaderOrderCheck: ").append(toIndentedString(enforceExtensionHeaderOrderCheck)).append("\n");
    sb.append("    dropnLogPacketsForRFCReservedFields: ").append(toIndentedString(dropnLogPacketsForRFCReservedFields)).append("\n");
    sb.append("}");
    return sb.toString();
  }
