...
/**
 * EnterpriseHealthStatsSchemaData
 */
...
public class EnterpriseHealthStatsSchemaData {
  @SerializedName("edge")
  private BaseApiResource2 edge = null;

  @SerializedName("tunnelCount")
  private Integer tunnelCount = null;

  @SerializedName("tunnelCountV6")
  private Integer tunnelCountV6 = null;

  @SerializedName("memoryPct")
  private Float memoryPct = null;
  ...
  private Integer cpuCoreTemp = null;

  @SerializedName("handoffQueueDrops")
  private Integer handoffQueueDrops = null;

  public EnterpriseHealthStatsSchemaData edge(BaseApiResource2 edge) {
    this.edge = edge;
    return this;
  }
  ...
  **/
  ...
  public EnterpriseHealthStatsSchemaData tunnelCount(Integer tunnelCount) {
  ...
  **/
  ...
  public EnterpriseHealthStatsSchemaData tunnelCountV6(Integer tunnelCountV6) {
  ...
  **/
  @Schema(description = "")
  public Integer getTunnelCountV6() {
    return tunnelCountV6;
  }

  public void setTunnelCountV6(Integer tunnelCountV6) {
    this.tunnelCountV6 = tunnelCountV6;
  }

  public EnterpriseHealthStatsSchemaData memoryPct(Float memoryPct) {
  ...
  **/
  @Schema(description = "")
  public Float getMemoryPct() {
    return memoryPct;
  }

  public void setMemoryPct(Float memoryPct) {
    this.memoryPct = memoryPct;
  }

  public EnterpriseHealthStatsSchemaData flowCount(Float flowCount) {
  ...
  **/
  ...
  public EnterpriseHealthStatsSchemaData cpuPct(Float cpuPct) {
    this.cpuPct = cpuPct;
    return this;
  }
  ...
  **/
  ...
  public void setCpuPct(Float cpuPct) {
    this.cpuPct = cpuPct;
  }

  public EnterpriseHealthStatsSchemaData cpuCoreTemp(Integer cpuCoreTemp) {
  ...
  **/
  @Schema(description = "")
  public Integer getCpuCoreTemp() {
    return cpuCoreTemp;
  }

  public void setCpuCoreTemp(Integer cpuCoreTemp) {
    this.cpuCoreTemp = cpuCoreTemp;
  }

  public EnterpriseHealthStatsSchemaData handoffQueueDrops(Integer handoffQueueDrops) {
  ...
  **/
  @Schema(description = "")
  public Integer getHandoffQueueDrops() {
    return handoffQueueDrops;
  }

  public void setHandoffQueueDrops(Integer handoffQueueDrops) {
    this.handoffQueueDrops = handoffQueueDrops;
  }
  ...
  public boolean equals(Object o) {
    ...
    EnterpriseHealthStatsSchemaData enterpriseHealthStatsSchemaData = (EnterpriseHealthStatsSchemaData) o;
    return Objects.equals(this.edge, enterpriseHealthStatsSchemaData.edge) &&
        Objects.equals(this.tunnelCount, enterpriseHealthStatsSchemaData.tunnelCount) &&
        Objects.equals(this.tunnelCountV6, enterpriseHealthStatsSchemaData.tunnelCountV6) &&
        Objects.equals(this.memoryPct, enterpriseHealthStatsSchemaData.memoryPct) &&
        Objects.equals(this.flowCount, enterpriseHealthStatsSchemaData.flowCount) &&
        Objects.equals(this.cpuPct, enterpriseHealthStatsSchemaData.cpuPct) &&
        Objects.equals(this.cpuCoreTemp, enterpriseHealthStatsSchemaData.cpuCoreTemp) &&
        Objects.equals(this.handoffQueueDrops, enterpriseHealthStatsSchemaData.handoffQueueDrops);
  }

  @Override
  public int hashCode() {
    return Objects.hash(edge, tunnelCount, tunnelCountV6, memoryPct, flowCount, cpuPct, cpuCoreTemp, handoffQueueDrops);
  }
  ...
  public String toString() {
    ...
    sb.append("class EnterpriseHealthStatsSchemaData {\n");
