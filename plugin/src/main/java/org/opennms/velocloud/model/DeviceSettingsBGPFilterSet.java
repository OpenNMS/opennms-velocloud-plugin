...
public class DeviceSettingsBGPFilterSet {
  @SerializedName("ids")
  private List<String> ids = null;

  public DeviceSettingsBGPFilterSet ids(List<String> ids) {
    this.ids = ids;
    return this;
  }

  public DeviceSettingsBGPFilterSet addIdsItem(String idsItem) {
    if (this.ids == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceSettingsBGPFilterSet deviceSettingsBGPFilterSet = (DeviceSettingsBGPFilterSet) o;
    return Objects.equals(this.ids, deviceSettingsBGPFilterSet.ids);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceSettingsBGPFilterSet {\n");
