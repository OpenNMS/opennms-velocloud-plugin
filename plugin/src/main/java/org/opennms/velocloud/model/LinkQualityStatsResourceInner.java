...
public class LinkQualityStatsResourceInner {
  @SerializedName("link")
  private Object link = null;

  @SerializedName("scoreAfterVoice")
  private Float scoreAfterVoice = null;

  @SerializedName("scoreAfterVideo")
  private Float scoreAfterVideo = null;

  @SerializedName("scoreAfterTrans")
  private Float scoreAfterTrans = null;

  @SerializedName("scoreBeforeVoice")
  private Float scoreBeforeVoice = null;

  @SerializedName("scoreBeforeVideo")
  private Float scoreBeforeVideo = null;

  @SerializedName("scoreBeforeTrans")
  private Float scoreBeforeTrans = null;

  public LinkQualityStatsResourceInner link(Object link) {
    this.link = link;
    return this;
  }
  ...
  **/
  ...
  public LinkQualityStatsResourceInner scoreAfterVoice(Float scoreAfterVoice) {
    this.scoreAfterVoice = scoreAfterVoice;
    return this;
  }

   /**
   * Get scoreAfterVoice
   * @return scoreAfterVoice
  **/
  @Schema(description = "")
  public Float getScoreAfterVoice() {
    return scoreAfterVoice;
  }

  public void setScoreAfterVoice(Float scoreAfterVoice) {
    this.scoreAfterVoice = scoreAfterVoice;
  }

  public LinkQualityStatsResourceInner scoreAfterVideo(Float scoreAfterVideo) {
    this.scoreAfterVideo = scoreAfterVideo;
    return this;
  }

   /**
   * Get scoreAfterVideo
   * @return scoreAfterVideo
  **/
  @Schema(description = "")
  public Float getScoreAfterVideo() {
    return scoreAfterVideo;
  }

  public void setScoreAfterVideo(Float scoreAfterVideo) {
    this.scoreAfterVideo = scoreAfterVideo;
  }

  public LinkQualityStatsResourceInner scoreAfterTrans(Float scoreAfterTrans) {
    this.scoreAfterTrans = scoreAfterTrans;
    return this;
  }

   /**
   * Get scoreAfterTrans
   * @return scoreAfterTrans
  **/
  @Schema(description = "")
  public Float getScoreAfterTrans() {
    return scoreAfterTrans;
  }

  public void setScoreAfterTrans(Float scoreAfterTrans) {
    this.scoreAfterTrans = scoreAfterTrans;
  }

  public LinkQualityStatsResourceInner scoreBeforeVoice(Float scoreBeforeVoice) {
    this.scoreBeforeVoice = scoreBeforeVoice;
    return this;
  }

   /**
   * Get scoreBeforeVoice
   * @return scoreBeforeVoice
  **/
  @Schema(description = "")
  public Float getScoreBeforeVoice() {
    return scoreBeforeVoice;
  }

  public void setScoreBeforeVoice(Float scoreBeforeVoice) {
    this.scoreBeforeVoice = scoreBeforeVoice;
  }

  public LinkQualityStatsResourceInner scoreBeforeVideo(Float scoreBeforeVideo) {
    this.scoreBeforeVideo = scoreBeforeVideo;
    return this;
  }

   /**
   * Get scoreBeforeVideo
   * @return scoreBeforeVideo
  **/
  @Schema(description = "")
  public Float getScoreBeforeVideo() {
    return scoreBeforeVideo;
  }

  public void setScoreBeforeVideo(Float scoreBeforeVideo) {
    this.scoreBeforeVideo = scoreBeforeVideo;
  }

  public LinkQualityStatsResourceInner scoreBeforeTrans(Float scoreBeforeTrans) {
    this.scoreBeforeTrans = scoreBeforeTrans;
    return this;
  }

   /**
   * Get scoreBeforeTrans
   * @return scoreBeforeTrans
  **/
  @Schema(description = "")
  public Float getScoreBeforeTrans() {
    return scoreBeforeTrans;
  }

  public void setScoreBeforeTrans(Float scoreBeforeTrans) {
    this.scoreBeforeTrans = scoreBeforeTrans;
  }
  ...
  public boolean equals(Object o) {
    ...
    LinkQualityStatsResourceInner linkQualityStatsResourceInner = (LinkQualityStatsResourceInner) o;
    return Objects.equals(this.link, linkQualityStatsResourceInner.link) &&
        Objects.equals(this.scoreAfterVoice, linkQualityStatsResourceInner.scoreAfterVoice) &&
        Objects.equals(this.scoreAfterVideo, linkQualityStatsResourceInner.scoreAfterVideo) &&
        Objects.equals(this.scoreAfterTrans, linkQualityStatsResourceInner.scoreAfterTrans) &&
        Objects.equals(this.scoreBeforeVoice, linkQualityStatsResourceInner.scoreBeforeVoice) &&
        Objects.equals(this.scoreBeforeVideo, linkQualityStatsResourceInner.scoreBeforeVideo) &&
        Objects.equals(this.scoreBeforeTrans, linkQualityStatsResourceInner.scoreBeforeTrans);
  }

  @Override
  public int hashCode() {
    return Objects.hash(link, scoreAfterVoice, scoreAfterVideo, scoreAfterTrans, scoreBeforeVoice, scoreBeforeVideo, scoreBeforeTrans);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinkQualityStatsResourceInner {\n");
    
    sb.append("    link: ").append(toIndentedString(link)).append("\n");
    sb.append("    scoreAfterVoice: ").append(toIndentedString(scoreAfterVoice)).append("\n");
    sb.append("    scoreAfterVideo: ").append(toIndentedString(scoreAfterVideo)).append("\n");
    sb.append("    scoreAfterTrans: ").append(toIndentedString(scoreAfterTrans)).append("\n");
    sb.append("    scoreBeforeVoice: ").append(toIndentedString(scoreBeforeVoice)).append("\n");
    sb.append("    scoreBeforeVideo: ").append(toIndentedString(scoreBeforeVideo)).append("\n");
    sb.append("    scoreBeforeTrans: ").append(toIndentedString(scoreBeforeTrans)).append("\n");
    sb.append("}");
    return sb.toString();
  }
