...
public class DeviceSettingsAuthentication {
  ...
  @SerializedName("authenticationService")
  private BaseApiResource11 authenticationService = null;
  ...
  public enum RefEnum {
    AUTHENTICATION("deviceSettings:authentication");
  ...
  private RefEnum ref = RefEnum.AUTHENTICATION;

  public DeviceSettingsAuthentication override(Boolean override) {
  ...
  **/
  ...
  public DeviceSettingsAuthentication sourceInterface(String sourceInterface) {
  ...
  **/
  ...
  public DeviceSettingsAuthentication authenticationService(BaseApiResource11 authenticationService) {
  ...
  **/
  @Schema(description = "")
  public BaseApiResource11 getAuthenticationService() {
    return authenticationService;
  }

  public void setAuthenticationService(BaseApiResource11 authenticationService) {
    this.authenticationService = authenticationService;
  }

  public DeviceSettingsAuthentication ref(RefEnum ref) {
    this.ref = ref;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceSettingsAuthentication deviceSettingsAuthentication = (DeviceSettingsAuthentication) o;
    return Objects.equals(this.override, deviceSettingsAuthentication.override) &&
        Objects.equals(this.sourceInterface, deviceSettingsAuthentication.sourceInterface) &&
        Objects.equals(this.authenticationService, deviceSettingsAuthentication.authenticationService) &&
        Objects.equals(this.ref, deviceSettingsAuthentication.ref);
  }

  @Override
  public int hashCode() {
    return Objects.hash(override, sourceInterface, authenticationService, ref);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceSettingsAuthentication {\n");
    
    sb.append("    override: ").append(toIndentedString(override)).append("\n");
    sb.append("    sourceInterface: ").append(toIndentedString(sourceInterface)).append("\n");
    sb.append("    authenticationService: ").append(toIndentedString(authenticationService)).append("\n");
