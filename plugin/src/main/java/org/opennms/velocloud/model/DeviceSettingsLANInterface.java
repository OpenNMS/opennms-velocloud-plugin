...
public class DeviceSettingsLANInterface {
   ...
   */
  @JsonAdapter(PortModeEnum.Adapter.class)
  public enum PortModeEnum {
    ...
    public static class Adapter extends TypeAdapter<PortModeEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final PortModeEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public PortModeEnum read(final JsonReader jsonReader) throws IOException {
        Object value = jsonReader.nextString();
        return PortModeEnum.fromValue(String.valueOf(value));
      }
    }
  ...
  public enum SecurityModeEnum {
    ...
    public static class Adapter extends TypeAdapter<SecurityModeEnum> {
      ...
      public SecurityModeEnum read(final JsonReader jsonReader) throws IOException {
        Object value = jsonReader.nextString();
        return SecurityModeEnum.fromValue(String.valueOf(value));
      }
    }
