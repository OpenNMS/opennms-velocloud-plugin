...
public class DeviceSettingsLANL2 {
  @SerializedName("autonegotiation")
  private Boolean autonegotiation = null;
  ...
  public enum DuplexEnum {
    ...
    public static class Adapter extends TypeAdapter<DuplexEnum> {
      ...
      public DuplexEnum read(final JsonReader jsonReader) throws IOException {
        ...
        return DuplexEnum.fromValue(String.valueOf(value));
      }
    }
  ...
  @SerializedName("losDetection")
  private Boolean losDetection = null;

  /**
   * Gets or Sets probeInterval
   */
  @JsonAdapter(ProbeIntervalEnum.Adapter.class)
  public enum ProbeIntervalEnum {
    _1("1"),
    _3("3"),
    _5("5"),
    _10("10");
    ...
    ProbeIntervalEnum(String value) {
      this.value = value;
    }
    public String getValue() {
      return value;
    ...
    public static ProbeIntervalEnum fromValue(String text) {
      for (ProbeIntervalEnum b : ProbeIntervalEnum.values()) {
        if (String.valueOf(b.value).equals(text)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<ProbeIntervalEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final ProbeIntervalEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public ProbeIntervalEnum read(final JsonReader jsonReader) throws IOException {
        Object value = jsonReader.nextString();
        return ProbeIntervalEnum.fromValue(String.valueOf(value));
      }
    }
  }  @SerializedName("probeInterval")
  private ProbeIntervalEnum probeInterval = null;

  public DeviceSettingsLANL2 autonegotiation(Boolean autonegotiation) {
  ...
  **/
  ...
  public DeviceSettingsLANL2 speed(String speed) {
    this.speed = speed;
    return this;
  }
  ...
  **/
  ...
  public DeviceSettingsLANL2 duplex(DuplexEnum duplex) {
    this.duplex = duplex;
    return this;
  }
  ...
  **/
  ...
  public DeviceSettingsLANL2 MTU(Integer MTU) {
    this.MTU = MTU;
    return this;
  }
  ...
  **/
  ...
  public DeviceSettingsLANL2 losDetection(Boolean losDetection) {
    this.losDetection = losDetection;
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public Boolean isLosDetection() {
    return losDetection;
  }

  public void setLosDetection(Boolean losDetection) {
    this.losDetection = losDetection;
  }

  public DeviceSettingsLANL2 probeInterval(ProbeIntervalEnum probeInterval) {
  ...
  **/
  @Schema(description = "")
  public ProbeIntervalEnum getProbeInterval() {
    return probeInterval;
  }

  public void setProbeInterval(ProbeIntervalEnum probeInterval) {
    this.probeInterval = probeInterval;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeviceSettingsLANL2 deviceSettingsLANL2 = (DeviceSettingsLANL2) o;
    return Objects.equals(this.autonegotiation, deviceSettingsLANL2.autonegotiation) &&
        Objects.equals(this.speed, deviceSettingsLANL2.speed) &&
        Objects.equals(this.duplex, deviceSettingsLANL2.duplex) &&
        Objects.equals(this.MTU, deviceSettingsLANL2.MTU) &&
        Objects.equals(this.losDetection, deviceSettingsLANL2.losDetection) &&
        Objects.equals(this.probeInterval, deviceSettingsLANL2.probeInterval);
  }

  @Override
  public int hashCode() {
    return Objects.hash(autonegotiation, speed, duplex, MTU, losDetection, probeInterval);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceSettingsLANL2 {\n");
    
    sb.append("    autonegotiation: ").append(toIndentedString(autonegotiation)).append("\n");
    sb.append("    speed: ").append(toIndentedString(speed)).append("\n");
    sb.append("    duplex: ").append(toIndentedString(duplex)).append("\n");
    sb.append("    MTU: ").append(toIndentedString(MTU)).append("\n");
    sb.append("    losDetection: ").append(toIndentedString(losDetection)).append("\n");
