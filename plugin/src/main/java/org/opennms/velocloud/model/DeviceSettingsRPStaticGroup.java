...
public class DeviceSettingsRPStaticGroup {
  @SerializedName("multicastGroups")
  private List<String> multicastGroups = null;

  @SerializedName("rpAddress")
  private String rpAddress = null;

  public DeviceSettingsRPStaticGroup multicastGroups(List<String> multicastGroups) {
    this.multicastGroups = multicastGroups;
    return this;
  }

  public DeviceSettingsRPStaticGroup addMulticastGroupsItem(String multicastGroupsItem) {
  ...
  **/
  ...
  public DeviceSettingsRPStaticGroup rpAddress(String rpAddress) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceSettingsRPStaticGroup deviceSettingsRPStaticGroup = (DeviceSettingsRPStaticGroup) o;
    return Objects.equals(this.multicastGroups, deviceSettingsRPStaticGroup.multicastGroups) &&
        Objects.equals(this.rpAddress, deviceSettingsRPStaticGroup.rpAddress);
  }

  @Override
  public int hashCode() {
    return Objects.hash(multicastGroups, rpAddress);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceSettingsRPStaticGroup {\n");
    
    sb.append("    multicastGroups: ").append(toIndentedString(multicastGroups)).append("\n");
    sb.append("    rpAddress: ").append(toIndentedString(rpAddress)).append("\n");
    sb.append("}");
    return sb.toString();
  }
