...
public class DataValidationError {
  ...
  public DataValidationError code(String code) {
    this.code = code;
    return this;
  }
  ...
  **/
  ...
  public DataValidationError property(String property) {
  ...
  **/
  ...
  public DataValidationError message(String message) {
  ...
  **/
  ...
  public DataValidationError displayMessage(String displayMessage) {
  ...
  **/
  ...
  public DataValidationError documentation(String documentation) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DataValidationError dataValidationError = (DataValidationError) o;
    return Objects.equals(this.code, dataValidationError.code) &&
        Objects.equals(this.property, dataValidationError.property) &&
        Objects.equals(this.message, dataValidationError.message) &&
        Objects.equals(this.displayMessage, dataValidationError.displayMessage) &&
        Objects.equals(this.documentation, dataValidationError.documentation);
  }
  ...
  public String toString() {
    ...
    sb.append("class DataValidationError {\n");
