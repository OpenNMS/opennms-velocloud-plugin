...
import org.opennms.velocloud.model.CreateEnterpriseSchemaServiceLicensesSDWAN;
import org.opennms.velocloud.model.DeviceSettingsVPNEdgeToEdgeDetailDynamic;
import org.opennms.velocloud.model.DeviceSettingsVPNEdgeToEdgeDetailIsolationGroups;
import org.opennms.velocloud.model.DeviceSettingsVPNEdgeToEdgeDetailProfileIsolation;
/**
...
public class DeviceSettingsVPNEdgeToEdgeDetail {
  @SerializedName("autoSelectVpnHubs")
  private Boolean autoSelectVpnHubs = null;

  @SerializedName("dynamic")
  private DeviceSettingsVPNEdgeToEdgeDetailDynamic dynamic = null;

  @SerializedName("encryptionProtocol")
  private String encryptionProtocol = null;

  @SerializedName("profileIsolation")
  private DeviceSettingsVPNEdgeToEdgeDetailProfileIsolation profileIsolation = null;

  @SerializedName("isolation")
  private CreateEnterpriseSchemaServiceLicensesSDWAN isolation = null;

  @SerializedName("isolationGroupId")
  private String isolationGroupId = null;

  @SerializedName("isolationGroups")
  private List<DeviceSettingsVPNEdgeToEdgeDetailIsolationGroups> isolationGroups = null;

  @SerializedName("useCloudGateway")
  private Boolean useCloudGateway = null;

  @SerializedName("vpnHubs")
  private List<BaseApiResource11> vpnHubs = null;

  public DeviceSettingsVPNEdgeToEdgeDetail autoSelectVpnHubs(Boolean autoSelectVpnHubs) {
    this.autoSelectVpnHubs = autoSelectVpnHubs;
    return this;
  }

   /**
   * Get autoSelectVpnHubs
   * @return autoSelectVpnHubs
  **/
  @Schema(description = "")
  public Boolean isAutoSelectVpnHubs() {
    return autoSelectVpnHubs;
  }

  public void setAutoSelectVpnHubs(Boolean autoSelectVpnHubs) {
    this.autoSelectVpnHubs = autoSelectVpnHubs;
  }

  public DeviceSettingsVPNEdgeToEdgeDetail dynamic(DeviceSettingsVPNEdgeToEdgeDetailDynamic dynamic) {
  ...
  **/
  @Schema(description = "")
  public DeviceSettingsVPNEdgeToEdgeDetailDynamic getDynamic() {
    return dynamic;
  }

  public void setDynamic(DeviceSettingsVPNEdgeToEdgeDetailDynamic dynamic) {
    this.dynamic = dynamic;
  }

  public DeviceSettingsVPNEdgeToEdgeDetail encryptionProtocol(String encryptionProtocol) {
  ...
  **/
  ...
  public DeviceSettingsVPNEdgeToEdgeDetail profileIsolation(DeviceSettingsVPNEdgeToEdgeDetailProfileIsolation profileIsolation) {
    this.profileIsolation = profileIsolation;
    return this;
  }

   /**
   * Get profileIsolation
   * @return profileIsolation
  **/
  @Schema(description = "")
  public DeviceSettingsVPNEdgeToEdgeDetailProfileIsolation getProfileIsolation() {
    return profileIsolation;
  }

  public void setProfileIsolation(DeviceSettingsVPNEdgeToEdgeDetailProfileIsolation profileIsolation) {
    this.profileIsolation = profileIsolation;
  }

  public DeviceSettingsVPNEdgeToEdgeDetail isolation(CreateEnterpriseSchemaServiceLicensesSDWAN isolation) {
  ...
  **/
  @Schema(description = "")
  public CreateEnterpriseSchemaServiceLicensesSDWAN getIsolation() {
    return isolation;
  }

  public void setIsolation(CreateEnterpriseSchemaServiceLicensesSDWAN isolation) {
    this.isolation = isolation;
  }

  public DeviceSettingsVPNEdgeToEdgeDetail isolationGroupId(String isolationGroupId) {
  ...
  **/
  ...
  public DeviceSettingsVPNEdgeToEdgeDetail isolationGroups(List<DeviceSettingsVPNEdgeToEdgeDetailIsolationGroups> isolationGroups) {
    this.isolationGroups = isolationGroups;
    return this;
  }

  public DeviceSettingsVPNEdgeToEdgeDetail addIsolationGroupsItem(DeviceSettingsVPNEdgeToEdgeDetailIsolationGroups isolationGroupsItem) {
    if (this.isolationGroups == null) {
      this.isolationGroups = new ArrayList<>();
    }
    this.isolationGroups.add(isolationGroupsItem);
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public List<DeviceSettingsVPNEdgeToEdgeDetailIsolationGroups> getIsolationGroups() {
    return isolationGroups;
  }

  public void setIsolationGroups(List<DeviceSettingsVPNEdgeToEdgeDetailIsolationGroups> isolationGroups) {
    this.isolationGroups = isolationGroups;
  }

  public DeviceSettingsVPNEdgeToEdgeDetail useCloudGateway(Boolean useCloudGateway) {
    this.useCloudGateway = useCloudGateway;
    return this;
  }

   /**
   * Get useCloudGateway
   * @return useCloudGateway
  **/
  @Schema(description = "")
  public Boolean isUseCloudGateway() {
    return useCloudGateway;
  }

  public void setUseCloudGateway(Boolean useCloudGateway) {
    this.useCloudGateway = useCloudGateway;
  }

  public DeviceSettingsVPNEdgeToEdgeDetail vpnHubs(List<BaseApiResource11> vpnHubs) {
    this.vpnHubs = vpnHubs;
    return this;
  }

  public DeviceSettingsVPNEdgeToEdgeDetail addVpnHubsItem(BaseApiResource11 vpnHubsItem) {
    if (this.vpnHubs == null) {
      this.vpnHubs = new ArrayList<>();
    }
    this.vpnHubs.add(vpnHubsItem);
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public List<BaseApiResource11> getVpnHubs() {
    return vpnHubs;
  }

  public void setVpnHubs(List<BaseApiResource11> vpnHubs) {
    this.vpnHubs = vpnHubs;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeviceSettingsVPNEdgeToEdgeDetail deviceSettingsVPNEdgeToEdgeDetail = (DeviceSettingsVPNEdgeToEdgeDetail) o;
    return Objects.equals(this.autoSelectVpnHubs, deviceSettingsVPNEdgeToEdgeDetail.autoSelectVpnHubs) &&
        Objects.equals(this.dynamic, deviceSettingsVPNEdgeToEdgeDetail.dynamic) &&
        Objects.equals(this.encryptionProtocol, deviceSettingsVPNEdgeToEdgeDetail.encryptionProtocol) &&
        Objects.equals(this.profileIsolation, deviceSettingsVPNEdgeToEdgeDetail.profileIsolation) &&
        Objects.equals(this.isolation, deviceSettingsVPNEdgeToEdgeDetail.isolation) &&
        Objects.equals(this.isolationGroupId, deviceSettingsVPNEdgeToEdgeDetail.isolationGroupId) &&
        Objects.equals(this.isolationGroups, deviceSettingsVPNEdgeToEdgeDetail.isolationGroups) &&
        Objects.equals(this.useCloudGateway, deviceSettingsVPNEdgeToEdgeDetail.useCloudGateway) &&
        Objects.equals(this.vpnHubs, deviceSettingsVPNEdgeToEdgeDetail.vpnHubs);
  }

  @Override
  public int hashCode() {
    return Objects.hash(autoSelectVpnHubs, dynamic, encryptionProtocol, profileIsolation, isolation, isolationGroupId, isolationGroups, useCloudGateway, vpnHubs);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceSettingsVPNEdgeToEdgeDetail {\n");
    
    sb.append("    autoSelectVpnHubs: ").append(toIndentedString(autoSelectVpnHubs)).append("\n");
    ...
    sb.append("    profileIsolation: ").append(toIndentedString(profileIsolation)).append("\n");
    ...
    sb.append("    isolationGroups: ").append(toIndentedString(isolationGroups)).append("\n");
    sb.append("    useCloudGateway: ").append(toIndentedString(useCloudGateway)).append("\n");
    sb.append("    vpnHubs: ").append(toIndentedString(vpnHubs)).append("\n");
    sb.append("}");
    return sb.toString();
  }
