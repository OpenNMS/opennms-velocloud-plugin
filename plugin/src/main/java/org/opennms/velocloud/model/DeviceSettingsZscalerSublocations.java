...
import org.opennms.velocloud.model.DeviceSettingsZscalerLocationGatewayOptions;
/**
 * DeviceSettingsZscalerSublocations
 */
...
public class DeviceSettingsZscalerSublocations {
  ...
  @SerializedName("otherSubLocation")
  private Boolean otherSubLocation = null;

  @SerializedName("ruleId")
  private String ruleId = null;

  @SerializedName("gwProperties")
  private DeviceSettingsZscalerLocationGatewayOptions gwProperties = null;

  @SerializedName("vlans")
  private List<Float> vlans = null;

  @SerializedName("includeAllVlans")
  private Boolean includeAllVlans = null;

  @SerializedName("includeAllLanInterfaces")
  private Boolean includeAllLanInterfaces = null;

  @SerializedName("lanRoutedInterfaces")
  private List<String> lanRoutedInterfaces = null;

  @SerializedName("ipAddressSelectionManual")
  private Boolean ipAddressSelectionManual = null;

  @SerializedName("ipAddresses")
  private List<String> ipAddresses = null;

  public DeviceSettingsZscalerSublocations internalId(String internalId) {
  ...
  **/
  ...
  public DeviceSettingsZscalerSublocations name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public DeviceSettingsZscalerSublocations otherSubLocation(Boolean otherSubLocation) {
    this.otherSubLocation = otherSubLocation;
    return this;
  }

   /**
   * Get otherSubLocation
   * @return otherSubLocation
  **/
  @Schema(description = "")
  public Boolean isOtherSubLocation() {
    return otherSubLocation;
  }

  public void setOtherSubLocation(Boolean otherSubLocation) {
    this.otherSubLocation = otherSubLocation;
  }

  public DeviceSettingsZscalerSublocations ruleId(String ruleId) {
    this.ruleId = ruleId;
    return this;
  }
  ...
  **/
  ...
  public DeviceSettingsZscalerSublocations gwProperties(DeviceSettingsZscalerLocationGatewayOptions gwProperties) {
  ...
  **/
  @Schema(description = "")
  public DeviceSettingsZscalerLocationGatewayOptions getGwProperties() {
    return gwProperties;
  }

  public void setGwProperties(DeviceSettingsZscalerLocationGatewayOptions gwProperties) {
    this.gwProperties = gwProperties;
  }

  public DeviceSettingsZscalerSublocations vlans(List<Float> vlans) {
    this.vlans = vlans;
    return this;
  }

  public DeviceSettingsZscalerSublocations addVlansItem(Float vlansItem) {
    if (this.vlans == null) {
  ...
  **/
  @Schema(description = "")
  public List<Float> getVlans() {
    return vlans;
  }

  public void setVlans(List<Float> vlans) {
    this.vlans = vlans;
  }

  public DeviceSettingsZscalerSublocations includeAllVlans(Boolean includeAllVlans) {
    this.includeAllVlans = includeAllVlans;
    return this;
  }

   /**
   * Get includeAllVlans
   * @return includeAllVlans
  **/
  @Schema(description = "")
  public Boolean isIncludeAllVlans() {
    return includeAllVlans;
  }

  public void setIncludeAllVlans(Boolean includeAllVlans) {
    this.includeAllVlans = includeAllVlans;
  }

  public DeviceSettingsZscalerSublocations includeAllLanInterfaces(Boolean includeAllLanInterfaces) {
    this.includeAllLanInterfaces = includeAllLanInterfaces;
    return this;
  }

   /**
   * Get includeAllLanInterfaces
   * @return includeAllLanInterfaces
  **/
  @Schema(description = "")
  public Boolean isIncludeAllLanInterfaces() {
    return includeAllLanInterfaces;
  }

  public void setIncludeAllLanInterfaces(Boolean includeAllLanInterfaces) {
    this.includeAllLanInterfaces = includeAllLanInterfaces;
  }

  public DeviceSettingsZscalerSublocations lanRoutedInterfaces(List<String> lanRoutedInterfaces) {
    this.lanRoutedInterfaces = lanRoutedInterfaces;
    return this;
  }

  public DeviceSettingsZscalerSublocations addLanRoutedInterfacesItem(String lanRoutedInterfacesItem) {
    if (this.lanRoutedInterfaces == null) {
      this.lanRoutedInterfaces = new ArrayList<>();
    }
    this.lanRoutedInterfaces.add(lanRoutedInterfacesItem);
    return this;
  }

   /**
   * Get lanRoutedInterfaces
   * @return lanRoutedInterfaces
  **/
  @Schema(description = "")
  public List<String> getLanRoutedInterfaces() {
    return lanRoutedInterfaces;
  }

  public void setLanRoutedInterfaces(List<String> lanRoutedInterfaces) {
    this.lanRoutedInterfaces = lanRoutedInterfaces;
  }

  public DeviceSettingsZscalerSublocations ipAddressSelectionManual(Boolean ipAddressSelectionManual) {
    this.ipAddressSelectionManual = ipAddressSelectionManual;
    return this;
  }

   /**
   * Get ipAddressSelectionManual
   * @return ipAddressSelectionManual
  **/
  @Schema(description = "")
  public Boolean isIpAddressSelectionManual() {
    return ipAddressSelectionManual;
  }

  public void setIpAddressSelectionManual(Boolean ipAddressSelectionManual) {
    this.ipAddressSelectionManual = ipAddressSelectionManual;
  }

  public DeviceSettingsZscalerSublocations ipAddresses(List<String> ipAddresses) {
    this.ipAddresses = ipAddresses;
    return this;
  }

  public DeviceSettingsZscalerSublocations addIpAddressesItem(String ipAddressesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceSettingsZscalerSublocations deviceSettingsZscalerSublocations = (DeviceSettingsZscalerSublocations) o;
    return Objects.equals(this.internalId, deviceSettingsZscalerSublocations.internalId) &&
        Objects.equals(this.name, deviceSettingsZscalerSublocations.name) &&
        Objects.equals(this.otherSubLocation, deviceSettingsZscalerSublocations.otherSubLocation) &&
        Objects.equals(this.ruleId, deviceSettingsZscalerSublocations.ruleId) &&
        Objects.equals(this.gwProperties, deviceSettingsZscalerSublocations.gwProperties) &&
        Objects.equals(this.vlans, deviceSettingsZscalerSublocations.vlans) &&
        Objects.equals(this.includeAllVlans, deviceSettingsZscalerSublocations.includeAllVlans) &&
        Objects.equals(this.includeAllLanInterfaces, deviceSettingsZscalerSublocations.includeAllLanInterfaces) &&
        Objects.equals(this.lanRoutedInterfaces, deviceSettingsZscalerSublocations.lanRoutedInterfaces) &&
        Objects.equals(this.ipAddressSelectionManual, deviceSettingsZscalerSublocations.ipAddressSelectionManual) &&
        Objects.equals(this.ipAddresses, deviceSettingsZscalerSublocations.ipAddresses);
  }

  @Override
  public int hashCode() {
    return Objects.hash(internalId, name, otherSubLocation, ruleId, gwProperties, vlans, includeAllVlans, includeAllLanInterfaces, lanRoutedInterfaces, ipAddressSelectionManual, ipAddresses);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceSettingsZscalerSublocations {\n");
    
    sb.append("    internalId: ").append(toIndentedString(internalId)).append("\n");
    sb.append("    name: ").append(toIndentedString(name)).append("\n");
    sb.append("    otherSubLocation: ").append(toIndentedString(otherSubLocation)).append("\n");
    sb.append("    ruleId: ").append(toIndentedString(ruleId)).append("\n");
    sb.append("    gwProperties: ").append(toIndentedString(gwProperties)).append("\n");
    sb.append("    vlans: ").append(toIndentedString(vlans)).append("\n");
    sb.append("    includeAllVlans: ").append(toIndentedString(includeAllVlans)).append("\n");
    sb.append("    includeAllLanInterfaces: ").append(toIndentedString(includeAllLanInterfaces)).append("\n");
    sb.append("    lanRoutedInterfaces: ").append(toIndentedString(lanRoutedInterfaces)).append("\n");
    sb.append("    ipAddressSelectionManual: ").append(toIndentedString(ipAddressSelectionManual)).append("\n");
