...
/**
 * DeviceSettingsNVSFromEdgeConfig
 */
...
public class DeviceSettingsNVSFromEdgeConfig {
  @SerializedName("useAllPublicWanLinks")
  private Boolean useAllPublicWanLinks = null;

  @SerializedName("enabled")
  private Boolean enabled = null;

  public DeviceSettingsNVSFromEdgeConfig useAllPublicWanLinks(Boolean useAllPublicWanLinks) {
    this.useAllPublicWanLinks = useAllPublicWanLinks;
    return this;
  }

   /**
   * Get useAllPublicWanLinks
   * @return useAllPublicWanLinks
  **/
  @Schema(description = "")
  public Boolean isUseAllPublicWanLinks() {
    return useAllPublicWanLinks;
  }

  public void setUseAllPublicWanLinks(Boolean useAllPublicWanLinks) {
    this.useAllPublicWanLinks = useAllPublicWanLinks;
  }

  public DeviceSettingsNVSFromEdgeConfig enabled(Boolean enabled) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceSettingsNVSFromEdgeConfig deviceSettingsNVSFromEdgeConfig = (DeviceSettingsNVSFromEdgeConfig) o;
    return Objects.equals(this.useAllPublicWanLinks, deviceSettingsNVSFromEdgeConfig.useAllPublicWanLinks) &&
        Objects.equals(this.enabled, deviceSettingsNVSFromEdgeConfig.enabled);
  }

  @Override
  public int hashCode() {
    return Objects.hash(useAllPublicWanLinks, enabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceSettingsNVSFromEdgeConfig {\n");
    
    sb.append("    useAllPublicWanLinks: ").append(toIndentedString(useAllPublicWanLinks)).append("\n");
