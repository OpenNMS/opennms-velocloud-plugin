...
public class DeviceSettingsRadio {
  @SerializedName("band")
  private String band = null;

  @SerializedName("channel")
  private AnyOfDeviceSettingsRadioChannel channel = null;
  ...
  public DeviceSettingsRadio band(String band) {
    this.band = band;
    return this;
  }
  ...
  **/
  ...
  public DeviceSettingsRadio channel(AnyOfDeviceSettingsRadioChannel channel) {
  ...
  **/
  @Schema(description = "")
  public AnyOfDeviceSettingsRadioChannel getChannel() {
    return channel;
  }

  public void setChannel(AnyOfDeviceSettingsRadioChannel channel) {
    this.channel = channel;
  }

  public DeviceSettingsRadio isEnabled(Boolean isEnabled) {
  ...
  **/
  ...
  public DeviceSettingsRadio mode(String mode) {
    this.mode = mode;
    return this;
  }
  ...
  **/
  ...
  public DeviceSettingsRadio name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public DeviceSettingsRadio radioId(Integer radioId) {
  ...
  **/
  ...
  public DeviceSettingsRadio width(String width) {
    this.width = width;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeviceSettingsRadio deviceSettingsRadio = (DeviceSettingsRadio) o;
    return Objects.equals(this.band, deviceSettingsRadio.band) &&
        Objects.equals(this.channel, deviceSettingsRadio.channel) &&
        Objects.equals(this.isEnabled, deviceSettingsRadio.isEnabled) &&
        Objects.equals(this.mode, deviceSettingsRadio.mode) &&
        Objects.equals(this.name, deviceSettingsRadio.name) &&
        Objects.equals(this.radioId, deviceSettingsRadio.radioId) &&
        Objects.equals(this.width, deviceSettingsRadio.width);
  }

  @Override
  public int hashCode() {
    return Objects.hash(band, channel, isEnabled, mode, name, radioId, width);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceSettingsRadio {\n");
