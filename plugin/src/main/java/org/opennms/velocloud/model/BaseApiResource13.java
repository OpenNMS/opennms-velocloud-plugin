...
public class BaseApiResource13 {
  ...
  @SerializedName("knownIpPortMapping")
  private Object knownIpPortMapping = null;

  @SerializedName("protocolPortMapping")
  private Object protocolPortMapping = null;

  @SerializedName("mustNotPerformDpi")
  private Integer mustNotPerformDpi = null;

  public BaseApiResource13 _href(String _href) {
    this._href = _href;
    return this;
  }
  ...
  **/
  ...
  public BaseApiResource13 name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public BaseApiResource13 displayName(String displayName) {
  ...
  **/
  ...
  public BaseApiResource13 propertyClass(Integer propertyClass) {
  ...
  **/
  ...
  public BaseApiResource13 description(String description) {
  ...
  **/
  ...
  public BaseApiResource13 knownIpPortMapping(Object knownIpPortMapping) {
    this.knownIpPortMapping = knownIpPortMapping;
    return this;
  }

   /**
   * Get knownIpPortMapping
   * @return knownIpPortMapping
  **/
  @Schema(description = "")
  public Object getKnownIpPortMapping() {
    return knownIpPortMapping;
  }

  public void setKnownIpPortMapping(Object knownIpPortMapping) {
    this.knownIpPortMapping = knownIpPortMapping;
  }

  public BaseApiResource13 protocolPortMapping(Object protocolPortMapping) {
    this.protocolPortMapping = protocolPortMapping;
    return this;
  }

   /**
   * Get protocolPortMapping
   * @return protocolPortMapping
  **/
  @Schema(description = "")
  public Object getProtocolPortMapping() {
    return protocolPortMapping;
  }

  public void setProtocolPortMapping(Object protocolPortMapping) {
    this.protocolPortMapping = protocolPortMapping;
  }

  public BaseApiResource13 mustNotPerformDpi(Integer mustNotPerformDpi) {
    this.mustNotPerformDpi = mustNotPerformDpi;
    return this;
  }

   /**
   * Get mustNotPerformDpi
   * @return mustNotPerformDpi
  **/
  @Schema(description = "")
  public Integer getMustNotPerformDpi() {
    return mustNotPerformDpi;
  }

  public void setMustNotPerformDpi(Integer mustNotPerformDpi) {
    this.mustNotPerformDpi = mustNotPerformDpi;
  }
  ...
  public boolean equals(Object o) {
    ...
    BaseApiResource13 baseApiResource13 = (BaseApiResource13) o;
    return Objects.equals(this._href, baseApiResource13._href) &&
        Objects.equals(this.name, baseApiResource13.name) &&
        Objects.equals(this.displayName, baseApiResource13.displayName) &&
        Objects.equals(this.propertyClass, baseApiResource13.propertyClass) &&
        Objects.equals(this.description, baseApiResource13.description) &&
        Objects.equals(this.knownIpPortMapping, baseApiResource13.knownIpPortMapping) &&
        Objects.equals(this.protocolPortMapping, baseApiResource13.protocolPortMapping) &&
        Objects.equals(this.mustNotPerformDpi, baseApiResource13.mustNotPerformDpi);
  }

  @Override
  public int hashCode() {
    return Objects.hash(_href, name, displayName, propertyClass, description, knownIpPortMapping, protocolPortMapping, mustNotPerformDpi);
  }
  ...
  public String toString() {
    ...
    sb.append("class BaseApiResource13 {\n");
    ...
    sb.append("    knownIpPortMapping: ").append(toIndentedString(knownIpPortMapping)).append("\n");
    sb.append("    protocolPortMapping: ").append(toIndentedString(protocolPortMapping)).append("\n");
    sb.append("    mustNotPerformDpi: ").append(toIndentedString(mustNotPerformDpi)).append("\n");
    sb.append("}");
    return sb.toString();
  }
