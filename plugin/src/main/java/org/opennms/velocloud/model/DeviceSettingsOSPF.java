...
import org.opennms.velocloud.model.DeviceSettingsOSPFArea;
import org.opennms.velocloud.model.DeviceSettingsOSPFBGPRedistribution;
/**
 * DeviceSettingsOSPF
 */
...
public class DeviceSettingsOSPF {
  @SerializedName("enabled")
  private Boolean enabled = null;

  @SerializedName("areas")
  private List<DeviceSettingsOSPFArea> areas = null;

  @SerializedName("bgp")
  private DeviceSettingsOSPFBGPRedistribution bgp = null;

  @SerializedName("defaultPrefixes")
  private Boolean defaultPrefixes = null;

  /**
   * Gets or Sets defaultRouteAdvertise
   */
  @JsonAdapter(DefaultRouteAdvertiseEnum.Adapter.class)
  public enum DefaultRouteAdvertiseEnum {
    ALWAYS("ALWAYS"),
    ...
    DefaultRouteAdvertiseEnum(String value) {
      this.value = value;
    }
    ...
    public static DefaultRouteAdvertiseEnum fromValue(String text) {
      for (DefaultRouteAdvertiseEnum b : DefaultRouteAdvertiseEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<DefaultRouteAdvertiseEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final DefaultRouteAdvertiseEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public DefaultRouteAdvertiseEnum read(final JsonReader jsonReader) throws IOException {
        Object value = jsonReader.nextString();
        return DefaultRouteAdvertiseEnum.fromValue(String.valueOf(value));
      }
    }
  }  @SerializedName("defaultRouteAdvertise")
  private DefaultRouteAdvertiseEnum defaultRouteAdvertise = null;

  /**
   * Gets or Sets defaultRoutes
   */
  @JsonAdapter(DefaultRoutesEnum.Adapter.class)
  public enum DefaultRoutesEnum {
    OE1("OE1"),
    OE2("OE2"),
    NONE("NONE");
    ...
    DefaultRoutesEnum(String value) {
      this.value = value;
    }
    public String getValue() {
      return value;
    ...
    public static DefaultRoutesEnum fromValue(String text) {
      for (DefaultRoutesEnum b : DefaultRoutesEnum.values()) {
        if (String.valueOf(b.value).equals(text)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<DefaultRoutesEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final DefaultRoutesEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public DefaultRoutesEnum read(final JsonReader jsonReader) throws IOException {
        Object value = jsonReader.nextString();
        return DefaultRoutesEnum.fromValue(String.valueOf(value));
      }
    }
  }  @SerializedName("defaultRoutes")
  private DefaultRoutesEnum defaultRoutes = null;

  public DeviceSettingsOSPF enabled(Boolean enabled) {
  ...
  **/
  ...
  public DeviceSettingsOSPF areas(List<DeviceSettingsOSPFArea> areas) {
    this.areas = areas;
    return this;
  }

  public DeviceSettingsOSPF addAreasItem(DeviceSettingsOSPFArea areasItem) {
    if (this.areas == null) {
  ...
  **/
  @Schema(description = "")
  public List<DeviceSettingsOSPFArea> getAreas() {
    return areas;
  }

  public void setAreas(List<DeviceSettingsOSPFArea> areas) {
    this.areas = areas;
  }

  public DeviceSettingsOSPF bgp(DeviceSettingsOSPFBGPRedistribution bgp) {
    this.bgp = bgp;
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public DeviceSettingsOSPFBGPRedistribution getBgp() {
    return bgp;
  }

  public void setBgp(DeviceSettingsOSPFBGPRedistribution bgp) {
    this.bgp = bgp;
  }

  public DeviceSettingsOSPF defaultPrefixes(Boolean defaultPrefixes) {
  ...
  **/
  @Schema(description = "")
  public Boolean isDefaultPrefixes() {
    return defaultPrefixes;
  }

  public void setDefaultPrefixes(Boolean defaultPrefixes) {
    this.defaultPrefixes = defaultPrefixes;
  }

  public DeviceSettingsOSPF defaultRouteAdvertise(DefaultRouteAdvertiseEnum defaultRouteAdvertise) {
    this.defaultRouteAdvertise = defaultRouteAdvertise;
    return this;
  }

   /**
   * Get defaultRouteAdvertise
   * @return defaultRouteAdvertise
  **/
  @Schema(description = "")
  public DefaultRouteAdvertiseEnum getDefaultRouteAdvertise() {
    return defaultRouteAdvertise;
  }

  public void setDefaultRouteAdvertise(DefaultRouteAdvertiseEnum defaultRouteAdvertise) {
    this.defaultRouteAdvertise = defaultRouteAdvertise;
  }

  public DeviceSettingsOSPF defaultRoutes(DefaultRoutesEnum defaultRoutes) {
  ...
  **/
  @Schema(description = "")
  public DefaultRoutesEnum getDefaultRoutes() {
    return defaultRoutes;
  }

  public void setDefaultRoutes(DefaultRoutesEnum defaultRoutes) {
    this.defaultRoutes = defaultRoutes;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeviceSettingsOSPF deviceSettingsOSPF = (DeviceSettingsOSPF) o;
    return Objects.equals(this.enabled, deviceSettingsOSPF.enabled) &&
        Objects.equals(this.areas, deviceSettingsOSPF.areas) &&
        Objects.equals(this.bgp, deviceSettingsOSPF.bgp) &&
        Objects.equals(this.defaultPrefixes, deviceSettingsOSPF.defaultPrefixes) &&
        Objects.equals(this.defaultRouteAdvertise, deviceSettingsOSPF.defaultRouteAdvertise) &&
        Objects.equals(this.defaultRoutes, deviceSettingsOSPF.defaultRoutes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(enabled, areas, bgp, defaultPrefixes, defaultRouteAdvertise, defaultRoutes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceSettingsOSPF {\n");
    
    sb.append("    enabled: ").append(toIndentedString(enabled)).append("\n");
    sb.append("    areas: ").append(toIndentedString(areas)).append("\n");
    sb.append("    bgp: ").append(toIndentedString(bgp)).append("\n");
    sb.append("    defaultPrefixes: ").append(toIndentedString(defaultPrefixes)).append("\n");
    sb.append("    defaultRouteAdvertise: ").append(toIndentedString(defaultRouteAdvertise)).append("\n");
    sb.append("    defaultRoutes: ").append(toIndentedString(defaultRoutes)).append("\n");
    sb.append("}");
    return sb.toString();
  }
