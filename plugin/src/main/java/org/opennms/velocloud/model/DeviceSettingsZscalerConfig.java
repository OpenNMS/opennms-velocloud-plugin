...
import org.opennms.velocloud.model.DeviceSettingsZscalerConfigLocation;
import org.opennms.velocloud.model.DeviceSettingsZscalerSublocations;
/**
 * DeviceSettingsZscalerConfig
 */
...
public class DeviceSettingsZscalerConfig {
  ...
  public enum CloudEnum {
    ...
    public static class Adapter extends TypeAdapter<CloudEnum> {
      ...
      public CloudEnum read(final JsonReader jsonReader) throws IOException {
        ...
        return CloudEnum.fromValue(String.valueOf(value));
      }
    }
  ...
  private VendorEnum vendor = VendorEnum.ZSCALER;

  @SerializedName("provider")
  private BaseApiResource11 provider = null;

  @SerializedName("location")
  private DeviceSettingsZscalerConfigLocation location = null;

  @SerializedName("subLocations")
  private List<DeviceSettingsZscalerSublocations> subLocations = null;

  @SerializedName("mtgre")
  private CreateEnterpriseSchemaServiceLicensesSDWAN mtgre = null;

  public DeviceSettingsZscalerConfig override(Boolean override) {
  ...
  **/
  ...
  public DeviceSettingsZscalerConfig enabled(Boolean enabled) {
  ...
  **/
  ...
  public DeviceSettingsZscalerConfig cloud(CloudEnum cloud) {
    this.cloud = cloud;
    return this;
  }
  ...
  **/
  ...
  public DeviceSettingsZscalerConfig vendor(VendorEnum vendor) {
    this.vendor = vendor;
    return this;
  }
  ...
  **/
  ...
  public DeviceSettingsZscalerConfig provider(BaseApiResource11 provider) {
  ...
  **/
  @Schema(description = "")
  public BaseApiResource11 getProvider() {
    return provider;
  }

  public void setProvider(BaseApiResource11 provider) {
    this.provider = provider;
  }

  public DeviceSettingsZscalerConfig location(DeviceSettingsZscalerConfigLocation location) {
  ...
  **/
  @Schema(description = "")
  public DeviceSettingsZscalerConfigLocation getLocation() {
    return location;
  }

  public void setLocation(DeviceSettingsZscalerConfigLocation location) {
    this.location = location;
  }

  public DeviceSettingsZscalerConfig subLocations(List<DeviceSettingsZscalerSublocations> subLocations) {
    this.subLocations = subLocations;
    return this;
  }

  public DeviceSettingsZscalerConfig addSubLocationsItem(DeviceSettingsZscalerSublocations subLocationsItem) {
    if (this.subLocations == null) {
      this.subLocations = new ArrayList<>();
    }
    this.subLocations.add(subLocationsItem);
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public List<DeviceSettingsZscalerSublocations> getSubLocations() {
    return subLocations;
  }

  public void setSubLocations(List<DeviceSettingsZscalerSublocations> subLocations) {
    this.subLocations = subLocations;
  }

  public DeviceSettingsZscalerConfig mtgre(CreateEnterpriseSchemaServiceLicensesSDWAN mtgre) {
    this.mtgre = mtgre;
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public CreateEnterpriseSchemaServiceLicensesSDWAN getMtgre() {
    return mtgre;
  }

  public void setMtgre(CreateEnterpriseSchemaServiceLicensesSDWAN mtgre) {
    this.mtgre = mtgre;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeviceSettingsZscalerConfig deviceSettingsZscalerConfig = (DeviceSettingsZscalerConfig) o;
    return Objects.equals(this.override, deviceSettingsZscalerConfig.override) &&
        Objects.equals(this.enabled, deviceSettingsZscalerConfig.enabled) &&
        Objects.equals(this.cloud, deviceSettingsZscalerConfig.cloud) &&
        Objects.equals(this.vendor, deviceSettingsZscalerConfig.vendor) &&
        Objects.equals(this.provider, deviceSettingsZscalerConfig.provider) &&
        Objects.equals(this.location, deviceSettingsZscalerConfig.location) &&
        Objects.equals(this.subLocations, deviceSettingsZscalerConfig.subLocations) &&
        Objects.equals(this.mtgre, deviceSettingsZscalerConfig.mtgre);
  }

  @Override
  public int hashCode() {
    return Objects.hash(override, enabled, cloud, vendor, provider, location, subLocations, mtgre);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceSettingsZscalerConfig {\n");
    ...
    sb.append("    mtgre: ").append(toIndentedString(mtgre)).append("\n");
    sb.append("}");
    return sb.toString();
  }
