...
import org.opennms.velocloud.model.EnterpriseAlertNotificationUserData;
/**
 * EnterpriseAlertNotification
 */
...
public class EnterpriseAlertNotification {
  @SerializedName("created")
  private OffsetDateTime created = null;

  @SerializedName("enterpriseUserList")
  private List<EnterpriseAlertNotificationUserData> enterpriseUserList = new ArrayList<>();

  @SerializedName("smsEnabled")
  private Float smsEnabled = null;

  @SerializedName("smsList")
  private String smsList = null;

  @SerializedName("smsText")
  private String smsText = null;

  @SerializedName("emailEnabled")
  private Float emailEnabled = null;
  ...
  private Float mobileEnabled = null;
  ...
  @SerializedName("snmpEnabled")
  private Float snmpEnabled = null;

  @SerializedName("snmpList")
  private String snmpList = null;

  @SerializedName("modified")
  private OffsetDateTime modified = null;

  public EnterpriseAlertNotification created(OffsetDateTime created) {
  ...
  **/
  ...
  public EnterpriseAlertNotification enterpriseUserList(List<EnterpriseAlertNotificationUserData> enterpriseUserList) {
    this.enterpriseUserList = enterpriseUserList;
    return this;
  }

  public EnterpriseAlertNotification addEnterpriseUserListItem(EnterpriseAlertNotificationUserData enterpriseUserListItem) {
    this.enterpriseUserList.add(enterpriseUserListItem);
    return this;
  }

   /**
   * Get enterpriseUserList
   * @return enterpriseUserList
  **/
  @Schema(required = true, description = "")
  public List<EnterpriseAlertNotificationUserData> getEnterpriseUserList() {
    return enterpriseUserList;
  }

  public void setEnterpriseUserList(List<EnterpriseAlertNotificationUserData> enterpriseUserList) {
    this.enterpriseUserList = enterpriseUserList;
  }

  public EnterpriseAlertNotification smsEnabled(Float smsEnabled) {
  ...
  **/
  @Schema(description = "")
  public Float getSmsEnabled() {
    return smsEnabled;
  }

  public void setSmsEnabled(Float smsEnabled) {
    this.smsEnabled = smsEnabled;
  }

  public EnterpriseAlertNotification smsList(String smsList) {
  ...
  **/
  ...
  public EnterpriseAlertNotification smsText(String smsText) {
  ...
  **/
  ...
  public EnterpriseAlertNotification emailEnabled(Float emailEnabled) {
  ...
  **/
  @Schema(description = "")
  public Float getEmailEnabled() {
    return emailEnabled;
  }

  public void setEmailEnabled(Float emailEnabled) {
    this.emailEnabled = emailEnabled;
  }

  public EnterpriseAlertNotification emailList(String emailList) {
  ...
  **/
  ...
  public EnterpriseAlertNotification emailText(String emailText) {
  ...
  **/
  ...
  public EnterpriseAlertNotification mobileEnabled(Float mobileEnabled) {
  ...
  **/
  @Schema(description = "")
  public Float getMobileEnabled() {
    return mobileEnabled;
  }

  public void setMobileEnabled(Float mobileEnabled) {
    this.mobileEnabled = mobileEnabled;
  }

  public EnterpriseAlertNotification mobileList(String mobileList) {
  ...
  **/
  ...
  public EnterpriseAlertNotification mobileText(String mobileText) {
  ...
  **/
  ...
  public EnterpriseAlertNotification snmpEnabled(Float snmpEnabled) {
  ...
  **/
  @Schema(description = "")
  public Float getSnmpEnabled() {
    return snmpEnabled;
  }

  public void setSnmpEnabled(Float snmpEnabled) {
    this.snmpEnabled = snmpEnabled;
  }

  public EnterpriseAlertNotification snmpList(String snmpList) {
  ...
  **/
  @Schema(description = "")
  public String getSnmpList() {
    return snmpList;
  }

  public void setSnmpList(String snmpList) {
    this.snmpList = snmpList;
  }

  public EnterpriseAlertNotification modified(OffsetDateTime modified) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    EnterpriseAlertNotification enterpriseAlertNotification = (EnterpriseAlertNotification) o;
    return Objects.equals(this.created, enterpriseAlertNotification.created) &&
        Objects.equals(this.enterpriseUserList, enterpriseAlertNotification.enterpriseUserList) &&
        Objects.equals(this.smsEnabled, enterpriseAlertNotification.smsEnabled) &&
        Objects.equals(this.smsList, enterpriseAlertNotification.smsList) &&
        Objects.equals(this.smsText, enterpriseAlertNotification.smsText) &&
        Objects.equals(this.emailEnabled, enterpriseAlertNotification.emailEnabled) &&
        Objects.equals(this.emailList, enterpriseAlertNotification.emailList) &&
        Objects.equals(this.emailText, enterpriseAlertNotification.emailText) &&
        Objects.equals(this.mobileEnabled, enterpriseAlertNotification.mobileEnabled) &&
        Objects.equals(this.mobileList, enterpriseAlertNotification.mobileList) &&
        Objects.equals(this.mobileText, enterpriseAlertNotification.mobileText) &&
        Objects.equals(this.snmpEnabled, enterpriseAlertNotification.snmpEnabled) &&
        Objects.equals(this.snmpList, enterpriseAlertNotification.snmpList) &&
        Objects.equals(this.modified, enterpriseAlertNotification.modified);
  }

  @Override
  public int hashCode() {
    return Objects.hash(created, enterpriseUserList, smsEnabled, smsList, smsText, emailEnabled, emailList, emailText, mobileEnabled, mobileList, mobileText, snmpEnabled, snmpList, modified);
  }
  ...
  public String toString() {
    ...
    sb.append("class EnterpriseAlertNotification {\n");
    
    sb.append("    created: ").append(toIndentedString(created)).append("\n");
    sb.append("    enterpriseUserList: ").append(toIndentedString(enterpriseUserList)).append("\n");
    sb.append("    smsEnabled: ").append(toIndentedString(smsEnabled)).append("\n");
    sb.append("    smsList: ").append(toIndentedString(smsList)).append("\n");
    ...
    sb.append("    emailText: ").append(toIndentedString(emailText)).append("\n");
    sb.append("    mobileEnabled: ").append(toIndentedString(mobileEnabled)).append("\n");
    sb.append("    mobileList: ").append(toIndentedString(mobileList)).append("\n");
    sb.append("    mobileText: ").append(toIndentedString(mobileText)).append("\n");
    sb.append("    snmpEnabled: ").append(toIndentedString(snmpEnabled)).append("\n");
    sb.append("    snmpList: ").append(toIndentedString(snmpList)).append("\n");
