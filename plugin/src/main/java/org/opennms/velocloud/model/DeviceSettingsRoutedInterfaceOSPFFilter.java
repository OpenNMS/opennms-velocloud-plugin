...
import org.opennms.velocloud.model.DeviceSettingsRoutedInterfaceOSPFFilterFilters;
/**
...
public class DeviceSettingsRoutedInterfaceOSPFFilter {
  /**
  ...
  public enum DefaultActionEnum {
    ...
    public static DefaultActionEnum fromValue(String text) {
    ...
    public static class Adapter extends TypeAdapter<DefaultActionEnum> {
      ...
      public DefaultActionEnum read(final JsonReader jsonReader) throws IOException {
        ...
        return DefaultActionEnum.fromValue(String.valueOf(value));
      }
    }
  ...
  private List<DeviceSettingsRoutedInterfaceOSPFFilterFilters> filters = null;

  public DeviceSettingsRoutedInterfaceOSPFFilter defaultAction(DefaultActionEnum defaultAction) {
  ...
  **/
  ...
  public DeviceSettingsRoutedInterfaceOSPFFilter filters(List<DeviceSettingsRoutedInterfaceOSPFFilterFilters> filters) {
    this.filters = filters;
    return this;
  }

  public DeviceSettingsRoutedInterfaceOSPFFilter addFiltersItem(DeviceSettingsRoutedInterfaceOSPFFilterFilters filtersItem) {
  ...
  **/
  @Schema(description = "")
  public List<DeviceSettingsRoutedInterfaceOSPFFilterFilters> getFilters() {
    return filters;
  }

  public void setFilters(List<DeviceSettingsRoutedInterfaceOSPFFilterFilters> filters) {
    this.filters = filters;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeviceSettingsRoutedInterfaceOSPFFilter deviceSettingsRoutedInterfaceOSPFFilter = (DeviceSettingsRoutedInterfaceOSPFFilter) o;
    return Objects.equals(this.defaultAction, deviceSettingsRoutedInterfaceOSPFFilter.defaultAction) &&
        Objects.equals(this.filters, deviceSettingsRoutedInterfaceOSPFFilter.filters);
  }

  @Override
  public int hashCode() {
    return Objects.hash(defaultAction, filters);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceSettingsRoutedInterfaceOSPFFilter {\n");
