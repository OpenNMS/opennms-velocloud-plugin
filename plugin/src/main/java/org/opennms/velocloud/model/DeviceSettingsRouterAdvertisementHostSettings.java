...
public class DeviceSettingsRouterAdvertisementHostSettings {
  @SerializedName("mtu")
  private Boolean mtu = null;

  @SerializedName("defaultRoutes")
  private Boolean defaultRoutes = null;

  @SerializedName("specificRoutes")
  private Boolean specificRoutes = null;

  @SerializedName("nd6Timers")
  private Boolean nd6Timers = null;

  public DeviceSettingsRouterAdvertisementHostSettings mtu(Boolean mtu) {
    this.mtu = mtu;
    return this;
  }
  ...
  **/
  ...
  public void setMtu(Boolean mtu) {
    this.mtu = mtu;
  }

  public DeviceSettingsRouterAdvertisementHostSettings defaultRoutes(Boolean defaultRoutes) {
  ...
  **/
  @Schema(description = "")
  public Boolean isDefaultRoutes() {
    return defaultRoutes;
  }

  public void setDefaultRoutes(Boolean defaultRoutes) {
    this.defaultRoutes = defaultRoutes;
  }

  public DeviceSettingsRouterAdvertisementHostSettings specificRoutes(Boolean specificRoutes) {
  ...
  **/
  @Schema(description = "")
  public Boolean isSpecificRoutes() {
    return specificRoutes;
  }

  public void setSpecificRoutes(Boolean specificRoutes) {
    this.specificRoutes = specificRoutes;
  }

  public DeviceSettingsRouterAdvertisementHostSettings nd6Timers(Boolean nd6Timers) {
    this.nd6Timers = nd6Timers;
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public Boolean isNd6Timers() {
    return nd6Timers;
  }

  public void setNd6Timers(Boolean nd6Timers) {
    this.nd6Timers = nd6Timers;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeviceSettingsRouterAdvertisementHostSettings deviceSettingsRouterAdvertisementHostSettings = (DeviceSettingsRouterAdvertisementHostSettings) o;
    return Objects.equals(this.mtu, deviceSettingsRouterAdvertisementHostSettings.mtu) &&
        Objects.equals(this.defaultRoutes, deviceSettingsRouterAdvertisementHostSettings.defaultRoutes) &&
        Objects.equals(this.specificRoutes, deviceSettingsRouterAdvertisementHostSettings.specificRoutes) &&
        Objects.equals(this.nd6Timers, deviceSettingsRouterAdvertisementHostSettings.nd6Timers);
  }

  @Override
  public int hashCode() {
    return Objects.hash(mtu, defaultRoutes, specificRoutes, nd6Timers);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceSettingsRouterAdvertisementHostSettings {\n");
    
    sb.append("    mtu: ").append(toIndentedString(mtu)).append("\n");
    sb.append("    defaultRoutes: ").append(toIndentedString(defaultRoutes)).append("\n");
    sb.append("    specificRoutes: ").append(toIndentedString(specificRoutes)).append("\n");
    sb.append("    nd6Timers: ").append(toIndentedString(nd6Timers)).append("\n");
    sb.append("}");
    return sb.toString();
  }
