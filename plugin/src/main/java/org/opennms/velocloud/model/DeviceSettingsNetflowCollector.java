...
/**
 * DeviceSettingsNetflowCollector
 */
...
public class DeviceSettingsNetflowCollector {
  @SerializedName("netflowCollector")
  private BaseApiResource11 netflowCollector = null;
  ...
  @SerializedName("allowAllSegment")
  private Boolean allowAllSegment = null;

  @SerializedName("logicalId")
  private String logicalId = null;

  @SerializedName("filterList")
  private List<Object> filterList = null;

  @SerializedName("netflowFilterList")
  private List<BaseApiResource11> netflowFilterList = null;

  public DeviceSettingsNetflowCollector netflowCollector(BaseApiResource11 netflowCollector) {
    this.netflowCollector = netflowCollector;
    return this;
  }

   /**
   * Get netflowCollector
   * @return netflowCollector
  **/
  @Schema(description = "")
  public BaseApiResource11 getNetflowCollector() {
    return netflowCollector;
  }

  public void setNetflowCollector(BaseApiResource11 netflowCollector) {
    this.netflowCollector = netflowCollector;
  }

  public DeviceSettingsNetflowCollector type(String type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  public DeviceSettingsNetflowCollector sourceInterface(String sourceInterface) {
  ...
  **/
  ...
  public DeviceSettingsNetflowCollector name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public DeviceSettingsNetflowCollector allowAllSegment(Boolean allowAllSegment) {
    this.allowAllSegment = allowAllSegment;
    return this;
  }

   /**
   * Get allowAllSegment
   * @return allowAllSegment
  **/
  @Schema(description = "")
  public Boolean isAllowAllSegment() {
    return allowAllSegment;
  }

  public void setAllowAllSegment(Boolean allowAllSegment) {
    this.allowAllSegment = allowAllSegment;
  }

  public DeviceSettingsNetflowCollector logicalId(String logicalId) {
  ...
  **/
  ...
  public DeviceSettingsNetflowCollector filterList(List<Object> filterList) {
    this.filterList = filterList;
    return this;
  }

  public DeviceSettingsNetflowCollector addFilterListItem(Object filterListItem) {
  ...
  **/
  ...
  public DeviceSettingsNetflowCollector netflowFilterList(List<BaseApiResource11> netflowFilterList) {
    this.netflowFilterList = netflowFilterList;
    return this;
  }

  public DeviceSettingsNetflowCollector addNetflowFilterListItem(BaseApiResource11 netflowFilterListItem) {
    if (this.netflowFilterList == null) {
      this.netflowFilterList = new ArrayList<>();
    }
    this.netflowFilterList.add(netflowFilterListItem);
    return this;
  }

   /**
   * Get netflowFilterList
   * @return netflowFilterList
  **/
  @Schema(description = "")
  public List<BaseApiResource11> getNetflowFilterList() {
    return netflowFilterList;
  }

  public void setNetflowFilterList(List<BaseApiResource11> netflowFilterList) {
    this.netflowFilterList = netflowFilterList;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeviceSettingsNetflowCollector deviceSettingsNetflowCollector = (DeviceSettingsNetflowCollector) o;
    return Objects.equals(this.netflowCollector, deviceSettingsNetflowCollector.netflowCollector) &&
        Objects.equals(this.type, deviceSettingsNetflowCollector.type) &&
        Objects.equals(this.sourceInterface, deviceSettingsNetflowCollector.sourceInterface) &&
        Objects.equals(this.name, deviceSettingsNetflowCollector.name) &&
        Objects.equals(this.allowAllSegment, deviceSettingsNetflowCollector.allowAllSegment) &&
        Objects.equals(this.logicalId, deviceSettingsNetflowCollector.logicalId) &&
        Objects.equals(this.filterList, deviceSettingsNetflowCollector.filterList) &&
        Objects.equals(this.netflowFilterList, deviceSettingsNetflowCollector.netflowFilterList);
  }

  @Override
  public int hashCode() {
    return Objects.hash(netflowCollector, type, sourceInterface, name, allowAllSegment, logicalId, filterList, netflowFilterList);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceSettingsNetflowCollector {\n");
    
    sb.append("    netflowCollector: ").append(toIndentedString(netflowCollector)).append("\n");
    sb.append("    type: ").append(toIndentedString(type)).append("\n");
    sb.append("    sourceInterface: ").append(toIndentedString(sourceInterface)).append("\n");
    sb.append("    name: ").append(toIndentedString(name)).append("\n");
    sb.append("    allowAllSegment: ").append(toIndentedString(allowAllSegment)).append("\n");
    ...
    sb.append("    netflowFilterList: ").append(toIndentedString(netflowFilterList)).append("\n");
    sb.append("}");
    return sb.toString();
  }
