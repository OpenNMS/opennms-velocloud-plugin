...
public class ConfigureApiTest {
     ...
     */
    @Test
    public void getEdgeProfileDeviceSettingsTest() {
        String enterpriseLogicalId = null;
        String edgeLogicalId = null;
        String include = null;
        EdgeDeviceSettings response = api.getEdgeProfileDeviceSettings(enterpriseLogicalId, edgeLogicalId, include);
     ...
     */
    @Test
    public void getEnterpriseProfileDeviceSettingsTest() {
        String enterpriseLogicalId = null;
        String profileLogicalId = null;
        String include = null;
        EnterpriseDeviceSettings response = api.getEnterpriseProfileDeviceSettings(enterpriseLogicalId, profileLogicalId, include);
     ...
     */
    @Test
    public void replaceEdgeProfileDeviceSettingsTest() {
        String enterpriseLogicalId = null;
        String edgeLogicalId = null;
        EdgeProfileDeviceSettingsRequestSpec body = null;
        String include = null;
        EdgeDeviceSettings response = api.replaceEdgeProfileDeviceSettings(enterpriseLogicalId, edgeLogicalId, body, include);
     ...
     */
    @Test
    public void replaceEnterpriseProfileDeviceSettingsTest() {
        String enterpriseLogicalId = null;
        String profileLogicalId = null;
        ProfileDeviceSettingsRequestSpec body = null;
        EnterpriseDeviceSettings response = api.replaceEnterpriseProfileDeviceSettings(enterpriseLogicalId, profileLogicalId, body);
     ...
     */
    @Test
    public void updateEdgeProfileDeviceSettingsTest() {
        String enterpriseLogicalId = null;
        String edgeLogicalId = null;
        List<Object> body = null;
        String include = null;
        EdgeDeviceSettings response = api.updateEdgeProfileDeviceSettings(enterpriseLogicalId, edgeLogicalId, body, include);
     ...
     */
    @Test
    public void updateEnterpriseProfileDeviceSettingsTest() {
        String enterpriseLogicalId = null;
        String profileLogicalId = null;
        List<Object> body = null;
        EnterpriseDeviceSettings response = api.updateEnterpriseProfileDeviceSettings(enterpriseLogicalId, profileLogicalId, body);
