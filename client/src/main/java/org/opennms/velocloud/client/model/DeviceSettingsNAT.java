...
import org.opennms.velocloud.client.model.DeviceSettingsNATDualRule;
import org.opennms.velocloud.client.model.DeviceSettingsNATRule;
/**
 * DeviceSettingsNAT
 */
...
public class DeviceSettingsNAT {
  @JsonProperty("override")
  private Boolean override = null;

  @JsonProperty("rules")
  private List<DeviceSettingsNATRule> rules = null;

  @JsonProperty("dualRules")
  private List<DeviceSettingsNATDualRule> dualRules = null;

  public DeviceSettingsNAT override(Boolean override) {
  ...
  **/
  ...
  public DeviceSettingsNAT rules(List<DeviceSettingsNATRule> rules) {
    this.rules = rules;
    return this;
  }

  public DeviceSettingsNAT addRulesItem(DeviceSettingsNATRule rulesItem) {
    if (this.rules == null) {
  ...
  **/
  @Schema(description = "")
  public List<DeviceSettingsNATRule> getRules() {
    return rules;
  }

  public void setRules(List<DeviceSettingsNATRule> rules) {
    this.rules = rules;
  }

  public DeviceSettingsNAT dualRules(List<DeviceSettingsNATDualRule> dualRules) {
    this.dualRules = dualRules;
    return this;
  }

  public DeviceSettingsNAT addDualRulesItem(DeviceSettingsNATDualRule dualRulesItem) {
    if (this.dualRules == null) {
      this.dualRules = new ArrayList<>();
    }
    this.dualRules.add(dualRulesItem);
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public List<DeviceSettingsNATDualRule> getDualRules() {
    return dualRules;
  }

  public void setDualRules(List<DeviceSettingsNATDualRule> dualRules) {
    this.dualRules = dualRules;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DeviceSettingsNAT deviceSettingsNAT = (DeviceSettingsNAT) o;
    return Objects.equals(this.override, deviceSettingsNAT.override) &&
        Objects.equals(this.rules, deviceSettingsNAT.rules) &&
        Objects.equals(this.dualRules, deviceSettingsNAT.dualRules);
  }

  @Override
  public int hashCode() {
    return Objects.hash(override, rules, dualRules);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceSettingsNAT {\n");
    
    sb.append("    override: ").append(toIndentedString(override)).append("\n");
    sb.append("    rules: ").append(toIndentedString(rules)).append("\n");
    sb.append("    dualRules: ").append(toIndentedString(dualRules)).append("\n");
    sb.append("}");
    return sb.toString();
  }
