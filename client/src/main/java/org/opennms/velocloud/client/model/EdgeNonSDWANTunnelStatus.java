...
import org.opennms.velocloud.client.model.EdgeNonSDWANTunnelStatusData;
/**
 * EdgeNonSDWANTunnelStatus
 */
...
public class EdgeNonSDWANTunnelStatus {
  @JsonProperty("_href")
  private String _href = null;

  @JsonProperty("data")
  private List<EdgeNonSDWANTunnelStatusData> data = null;

  @JsonProperty("metaData")
  private CollectionMetadata metaData = null;

  public EdgeNonSDWANTunnelStatus _href(String _href) {
    this._href = _href;
    return this;
  }
  ...
  **/
  ...
  public EdgeNonSDWANTunnelStatus data(List<EdgeNonSDWANTunnelStatusData> data) {
    this.data = data;
    return this;
  }

  public EdgeNonSDWANTunnelStatus addDataItem(EdgeNonSDWANTunnelStatusData dataItem) {
    if (this.data == null) {
  ...
  **/
  @Schema(description = "")
  public List<EdgeNonSDWANTunnelStatusData> getData() {
    return data;
  }

  public void setData(List<EdgeNonSDWANTunnelStatusData> data) {
    this.data = data;
  }

  public EdgeNonSDWANTunnelStatus metaData(CollectionMetadata metaData) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdgeNonSDWANTunnelStatus edgeNonSDWANTunnelStatus = (EdgeNonSDWANTunnelStatus) o;
    return Objects.equals(this._href, edgeNonSDWANTunnelStatus._href) &&
        Objects.equals(this.data, edgeNonSDWANTunnelStatus.data) &&
        Objects.equals(this.metaData, edgeNonSDWANTunnelStatus.metaData);
  }
  ...
  public String toString() {
    ...
    sb.append("class EdgeNonSDWANTunnelStatus {\n");
