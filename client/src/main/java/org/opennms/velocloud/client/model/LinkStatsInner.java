...
public class LinkStatsInner {
  ...
  @JsonProperty("bytesTx")
  private Float bytesTx = null;

  @JsonProperty("bytesRx")
  private Float bytesRx = null;

  @JsonProperty("packetsTx")
  private Float packetsTx = null;

  @JsonProperty("packetsRx")
