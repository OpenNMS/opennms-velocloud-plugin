...
import org.opennms.velocloud.client.model.DeviceSettingsBGPActionValues;
/**
 * DeviceSettingsBGPAction
 */
...
public class DeviceSettingsBGPAction {
  /**
   * Gets or Sets type
   */
  ...
  @JsonProperty("values")
  private List<DeviceSettingsBGPActionValues> values = null;

  public DeviceSettingsBGPAction type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  public DeviceSettingsBGPAction values(List<DeviceSettingsBGPActionValues> values) {
    this.values = values;
    return this;
  }

  public DeviceSettingsBGPAction addValuesItem(DeviceSettingsBGPActionValues valuesItem) {
    if (this.values == null) {
  ...
  **/
  @Schema(description = "")
  public List<DeviceSettingsBGPActionValues> getValues() {
    return values;
  }

  public void setValues(List<DeviceSettingsBGPActionValues> values) {
    this.values = values;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DeviceSettingsBGPAction deviceSettingsBGPAction = (DeviceSettingsBGPAction) o;
    return Objects.equals(this.type, deviceSettingsBGPAction.type) &&
        Objects.equals(this.values, deviceSettingsBGPAction.values);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceSettingsBGPAction {\n");
