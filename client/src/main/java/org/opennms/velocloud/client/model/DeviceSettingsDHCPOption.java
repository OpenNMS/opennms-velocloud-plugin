...
import org.opennms.velocloud.client.model.DeviceSettingsDHCPMetaData;
/**
...
public class DeviceSettingsDHCPOption {
  @JsonProperty("option")
  ...
  private DeviceSettingsDHCPMetaData metaData = null;

  public DeviceSettingsDHCPOption option(Integer option) {
    this.option = option;
    return this;
  }
  ...
  **/
  ...
  public DeviceSettingsDHCPOption value(List<String> value) {
    this.value = value;
    return this;
  }

  public DeviceSettingsDHCPOption addValueItem(String valueItem) {
    if (this.value == null) {
  ...
  **/
  ...
  public DeviceSettingsDHCPOption type(String type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  public DeviceSettingsDHCPOption metaData(DeviceSettingsDHCPMetaData metaData) {
  ...
  **/
  @Schema(description = "")
  public DeviceSettingsDHCPMetaData getMetaData() {
    return metaData;
  }

  public void setMetaData(DeviceSettingsDHCPMetaData metaData) {
    this.metaData = metaData;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DeviceSettingsDHCPOption deviceSettingsDHCPOption = (DeviceSettingsDHCPOption) o;
    return Objects.equals(this.option, deviceSettingsDHCPOption.option) &&
        Objects.equals(this.value, deviceSettingsDHCPOption.value) &&
        Objects.equals(this.type, deviceSettingsDHCPOption.type) &&
        Objects.equals(this.metaData, deviceSettingsDHCPOption.metaData);
  }

  @Override
  public int hashCode() {
    return Objects.hash(option, value, type, metaData);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceSettingsDHCPOption {\n");
