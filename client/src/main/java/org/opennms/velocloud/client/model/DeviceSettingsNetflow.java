...
import org.opennms.velocloud.client.model.DeviceSettingsNetflowCollector;
import org.opennms.velocloud.client.model.DeviceSettingsNetflowIntervals;
/**
 * DeviceSettingsNetflow
 */
...
public class DeviceSettingsNetflow {
  ...
  private List<DeviceSettingsNetflowCollector> collectors = null;

  @JsonProperty("version")
  private Integer version = null;

  @JsonProperty("intervals")
  private DeviceSettingsNetflowIntervals intervals = null;

  public DeviceSettingsNetflow enabled(Boolean enabled) {
  ...
  **/
  ...
  public DeviceSettingsNetflow override(Boolean override) {
  ...
  **/
  ...
  public DeviceSettingsNetflow collectors(List<DeviceSettingsNetflowCollector> collectors) {
    this.collectors = collectors;
    return this;
  }

  public DeviceSettingsNetflow addCollectorsItem(DeviceSettingsNetflowCollector collectorsItem) {
  ...
  **/
  @Schema(description = "")
  public List<DeviceSettingsNetflowCollector> getCollectors() {
    return collectors;
  }

  public void setCollectors(List<DeviceSettingsNetflowCollector> collectors) {
    this.collectors = collectors;
  }

  public DeviceSettingsNetflow version(Integer version) {
  ...
  **/
  ...
  public DeviceSettingsNetflow intervals(DeviceSettingsNetflowIntervals intervals) {
  ...
  **/
  @Schema(description = "")
  public DeviceSettingsNetflowIntervals getIntervals() {
    return intervals;
  }

  public void setIntervals(DeviceSettingsNetflowIntervals intervals) {
    this.intervals = intervals;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DeviceSettingsNetflow deviceSettingsNetflow = (DeviceSettingsNetflow) o;
    return Objects.equals(this.enabled, deviceSettingsNetflow.enabled) &&
        Objects.equals(this.override, deviceSettingsNetflow.override) &&
        Objects.equals(this.collectors, deviceSettingsNetflow.collectors) &&
        Objects.equals(this.version, deviceSettingsNetflow.version) &&
        Objects.equals(this.intervals, deviceSettingsNetflow.intervals);
  }

  @Override
  public int hashCode() {
    return Objects.hash(enabled, override, collectors, version, intervals);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceSettingsNetflow {\n");
