...
import org.opennms.velocloud.client.model.CollectionMetadata;
import org.opennms.velocloud.client.model.EnterpriseHealthStatsSchemaData;
/**
 * EnterpriseHealthStatsSchema
 */
...
public class EnterpriseHealthStatsSchema {
  @JsonProperty("_href")
  private String _href = null;

  @JsonProperty("data")
  private List<EnterpriseHealthStatsSchemaData> data = null;

  @JsonProperty("metaData")
  private CollectionMetadata metaData = null;

  public EnterpriseHealthStatsSchema _href(String _href) {
    this._href = _href;
    return this;
  }
  ...
  **/
  ...
  public EnterpriseHealthStatsSchema data(List<EnterpriseHealthStatsSchemaData> data) {
    this.data = data;
    return this;
  }

  public EnterpriseHealthStatsSchema addDataItem(EnterpriseHealthStatsSchemaData dataItem) {
    if (this.data == null) {
  ...
  **/
  @Schema(description = "")
  public List<EnterpriseHealthStatsSchemaData> getData() {
    return data;
  }

  public void setData(List<EnterpriseHealthStatsSchemaData> data) {
    this.data = data;
  }

  public EnterpriseHealthStatsSchema metaData(CollectionMetadata metaData) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EnterpriseHealthStatsSchema enterpriseHealthStatsSchema = (EnterpriseHealthStatsSchema) o;
    return Objects.equals(this._href, enterpriseHealthStatsSchema._href) &&
        Objects.equals(this.data, enterpriseHealthStatsSchema.data) &&
        Objects.equals(this.metaData, enterpriseHealthStatsSchema.metaData);
  }

  @Override
  public int hashCode() {
    return Objects.hash(_href, data, metaData);
  }
  ...
  public String toString() {
    ...
    sb.append("class EnterpriseHealthStatsSchema {\n");
