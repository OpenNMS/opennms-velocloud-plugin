...
public class DeviceSettingsDHCPRelay {
  ...
  public DeviceSettingsDHCPRelay enabled(Boolean enabled) {
  ...
  **/
  ...
  public DeviceSettingsDHCPRelay servers(List<String> servers) {
    this.servers = servers;
    return this;
  }

  public DeviceSettingsDHCPRelay addServersItem(String serversItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DeviceSettingsDHCPRelay deviceSettingsDHCPRelay = (DeviceSettingsDHCPRelay) o;
    return Objects.equals(this.enabled, deviceSettingsDHCPRelay.enabled) &&
        Objects.equals(this.servers, deviceSettingsDHCPRelay.servers);
  }

  @Override
  public int hashCode() {
    return Objects.hash(enabled, servers);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceSettingsDHCPRelay {\n");
