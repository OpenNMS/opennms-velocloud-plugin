...
import org.opennms.velocloud.client.model.DeviceSettingsBGPFilterRule;
/**
...
public class DeviceSettingsBGPFilter {
  @JsonProperty("ids")
  ...
  @JsonProperty("rules")
  private List<DeviceSettingsBGPFilterRule> rules = null;

  public DeviceSettingsBGPFilter ids(List<String> ids) {
    this.ids = ids;
    return this;
  }

  public DeviceSettingsBGPFilter addIdsItem(String idsItem) {
    if (this.ids == null) {
  ...
  **/
  ...
  public DeviceSettingsBGPFilter name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public DeviceSettingsBGPFilter rules(List<DeviceSettingsBGPFilterRule> rules) {
    this.rules = rules;
    return this;
  }

  public DeviceSettingsBGPFilter addRulesItem(DeviceSettingsBGPFilterRule rulesItem) {
    if (this.rules == null) {
  ...
  **/
  @Schema(description = "")
  public List<DeviceSettingsBGPFilterRule> getRules() {
    return rules;
  }

  public void setRules(List<DeviceSettingsBGPFilterRule> rules) {
    this.rules = rules;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DeviceSettingsBGPFilter deviceSettingsBGPFilter = (DeviceSettingsBGPFilter) o;
    return Objects.equals(this.ids, deviceSettingsBGPFilter.ids) &&
        Objects.equals(this.name, deviceSettingsBGPFilter.name) &&
        Objects.equals(this.rules, deviceSettingsBGPFilter.rules);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ids, name, rules);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceSettingsBGPFilter {\n");
