...
public class DeviceSettingsMultiSourceQOS {
  ...
  @JsonProperty("highRatio")
  private Integer highRatio = null;

  @JsonProperty("normalRatio")
  private Integer normalRatio = null;

  @JsonProperty("lowRatio")
  private Integer lowRatio = null;

  @JsonProperty("maxCapThreshold")
  private Integer maxCapThreshold = null;

  @JsonProperty("minCapThreshold")
  private Integer minCapThreshold = null;

  public DeviceSettingsMultiSourceQOS enabled(Boolean enabled) {
  ...
  **/
  ...
  public DeviceSettingsMultiSourceQOS override(Boolean override) {
  ...
  **/
  ...
  public DeviceSettingsMultiSourceQOS highRatio(Integer highRatio) {
  ...
  **/
  ...
  public DeviceSettingsMultiSourceQOS normalRatio(Integer normalRatio) {
  ...
  **/
  ...
  public DeviceSettingsMultiSourceQOS lowRatio(Integer lowRatio) {
  ...
  **/
  ...
  public DeviceSettingsMultiSourceQOS maxCapThreshold(Integer maxCapThreshold) {
    this.maxCapThreshold = maxCapThreshold;
    return this;
  }

   /**
   * Get maxCapThreshold
   * @return maxCapThreshold
  **/
  @Schema(description = "")
  public Integer getMaxCapThreshold() {
    return maxCapThreshold;
  }

  public void setMaxCapThreshold(Integer maxCapThreshold) {
    this.maxCapThreshold = maxCapThreshold;
  }

  public DeviceSettingsMultiSourceQOS minCapThreshold(Integer minCapThreshold) {
    this.minCapThreshold = minCapThreshold;
    return this;
  }

   /**
   * Get minCapThreshold
   * @return minCapThreshold
  **/
  @Schema(description = "")
  public Integer getMinCapThreshold() {
    return minCapThreshold;
  }

  public void setMinCapThreshold(Integer minCapThreshold) {
    this.minCapThreshold = minCapThreshold;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DeviceSettingsMultiSourceQOS deviceSettingsMultiSourceQOS = (DeviceSettingsMultiSourceQOS) o;
    return Objects.equals(this.enabled, deviceSettingsMultiSourceQOS.enabled) &&
        Objects.equals(this.override, deviceSettingsMultiSourceQOS.override) &&
        Objects.equals(this.highRatio, deviceSettingsMultiSourceQOS.highRatio) &&
        Objects.equals(this.normalRatio, deviceSettingsMultiSourceQOS.normalRatio) &&
        Objects.equals(this.lowRatio, deviceSettingsMultiSourceQOS.lowRatio) &&
        Objects.equals(this.maxCapThreshold, deviceSettingsMultiSourceQOS.maxCapThreshold) &&
        Objects.equals(this.minCapThreshold, deviceSettingsMultiSourceQOS.minCapThreshold);
  }

  @Override
  public int hashCode() {
    return Objects.hash(enabled, override, highRatio, normalRatio, lowRatio, maxCapThreshold, minCapThreshold);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceSettingsMultiSourceQOS {\n");
    
    sb.append("    enabled: ").append(toIndentedString(enabled)).append("\n");
    sb.append("    override: ").append(toIndentedString(override)).append("\n");
    sb.append("    highRatio: ").append(toIndentedString(highRatio)).append("\n");
    sb.append("    normalRatio: ").append(toIndentedString(normalRatio)).append("\n");
    sb.append("    lowRatio: ").append(toIndentedString(lowRatio)).append("\n");
    sb.append("    maxCapThreshold: ").append(toIndentedString(maxCapThreshold)).append("\n");
    sb.append("    minCapThreshold: ").append(toIndentedString(minCapThreshold)).append("\n");
    sb.append("}");
    return sb.toString();
  }
