...
import org.opennms.velocloud.client.model.DeviceSettingsSubLocationDeployment;
import org.opennms.velocloud.client.model.DeviceSettingsZscalerDeploymentLocation;
/**
 * DeviceSettingsZscalerDeployment
 */
...
public class DeviceSettingsZscalerDeployment {
  @JsonProperty("location")
  private DeviceSettingsZscalerDeploymentLocation location = null;

  @JsonProperty("subLocations")
  private List<DeviceSettingsSubLocationDeployment> subLocations = null;

  @JsonProperty("mtgreSite")
  private BaseApiResource11 mtgreSite = null;

  public DeviceSettingsZscalerDeployment location(DeviceSettingsZscalerDeploymentLocation location) {
  ...
  **/
  @Schema(description = "")
  public DeviceSettingsZscalerDeploymentLocation getLocation() {
    return location;
  }

  public void setLocation(DeviceSettingsZscalerDeploymentLocation location) {
    this.location = location;
  }

  public DeviceSettingsZscalerDeployment subLocations(List<DeviceSettingsSubLocationDeployment> subLocations) {
    this.subLocations = subLocations;
    return this;
  }

  public DeviceSettingsZscalerDeployment addSubLocationsItem(DeviceSettingsSubLocationDeployment subLocationsItem) {
  ...
  **/
  @Schema(description = "")
  public List<DeviceSettingsSubLocationDeployment> getSubLocations() {
    return subLocations;
  }

  public void setSubLocations(List<DeviceSettingsSubLocationDeployment> subLocations) {
    this.subLocations = subLocations;
  }

  public DeviceSettingsZscalerDeployment mtgreSite(BaseApiResource11 mtgreSite) {
    this.mtgreSite = mtgreSite;
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public BaseApiResource11 getMtgreSite() {
    return mtgreSite;
  }

  public void setMtgreSite(BaseApiResource11 mtgreSite) {
    this.mtgreSite = mtgreSite;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DeviceSettingsZscalerDeployment deviceSettingsZscalerDeployment = (DeviceSettingsZscalerDeployment) o;
    return Objects.equals(this.location, deviceSettingsZscalerDeployment.location) &&
        Objects.equals(this.subLocations, deviceSettingsZscalerDeployment.subLocations) &&
        Objects.equals(this.mtgreSite, deviceSettingsZscalerDeployment.mtgreSite);
  }

  @Override
  public int hashCode() {
    return Objects.hash(location, subLocations, mtgreSite);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceSettingsZscalerDeployment {\n");
    
    sb.append("    location: ").append(toIndentedString(location)).append("\n");
    sb.append("    subLocations: ").append(toIndentedString(subLocations)).append("\n");
    sb.append("    mtgreSite: ").append(toIndentedString(mtgreSite)).append("\n");
    sb.append("}");
    return sb.toString();
  }
