...
public class RemovePatchOperation implements AnyOfPatchSchemaItems {
  /**
   * Gets or Sets op
   */
  public enum OpEnum {
  ...
  public RemovePatchOperation op(OpEnum op) {
    this.op = op;
    return this;
  }
  ...
  **/
  ...
  public RemovePatchOperation path(String path) {
    this.path = path;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RemovePatchOperation removePatchOperation = (RemovePatchOperation) o;
    return Objects.equals(this.op, removePatchOperation.op) &&
        Objects.equals(this.path, removePatchOperation.path);
  }
  ...
  public String toString() {
    ...
    sb.append("class RemovePatchOperation {\n");
