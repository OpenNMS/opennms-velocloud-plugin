...
import org.opennms.velocloud.client.model.EdgeHealthStatsMetricsSchemaTunnelCount;
/**
...
public class EdgeHealthStatsMetricsSchema {
  @JsonProperty("_href")
  ...
  @JsonProperty("tunnelCount")
  private EdgeHealthStatsMetricsSchemaTunnelCount tunnelCount = null;

  @JsonProperty("tunnelCountV6")
  private EdgeHealthStatsMetricsSchemaTunnelCount tunnelCountV6 = null;

  @JsonProperty("memoryPct")
  private EdgeHealthStatsMetricsSchemaTunnelCount memoryPct = null;

  @JsonProperty("flowCount")
  private EdgeHealthStatsMetricsSchemaTunnelCount flowCount = null;

  @JsonProperty("cpuPct")
  private EdgeHealthStatsMetricsSchemaTunnelCount cpuPct = null;

  @JsonProperty("cpuCoreTemp")
  private EdgeHealthStatsMetricsSchemaTunnelCount cpuCoreTemp = null;

  @JsonProperty("handoffQueueDrops")
  private EdgeHealthStatsMetricsSchemaTunnelCount handoffQueueDrops = null;

  public EdgeHealthStatsMetricsSchema _href(String _href) {
    this._href = _href;
    return this;
  }
  ...
  **/
  ...
  public EdgeHealthStatsMetricsSchema total(Integer total) {
    this.total = total;
    return this;
  }
  ...
  **/
  ...
  public EdgeHealthStatsMetricsSchema tunnelCount(EdgeHealthStatsMetricsSchemaTunnelCount tunnelCount) {
  ...
  **/
  @Schema(description = "")
  public EdgeHealthStatsMetricsSchemaTunnelCount getTunnelCount() {
    return tunnelCount;
  }

  public void setTunnelCount(EdgeHealthStatsMetricsSchemaTunnelCount tunnelCount) {
    this.tunnelCount = tunnelCount;
  }

  public EdgeHealthStatsMetricsSchema tunnelCountV6(EdgeHealthStatsMetricsSchemaTunnelCount tunnelCountV6) {
  ...
  **/
  @Schema(description = "")
  public EdgeHealthStatsMetricsSchemaTunnelCount getTunnelCountV6() {
    return tunnelCountV6;
  }

  public void setTunnelCountV6(EdgeHealthStatsMetricsSchemaTunnelCount tunnelCountV6) {
    this.tunnelCountV6 = tunnelCountV6;
  }

  public EdgeHealthStatsMetricsSchema memoryPct(EdgeHealthStatsMetricsSchemaTunnelCount memoryPct) {
  ...
  **/
  @Schema(description = "")
  public EdgeHealthStatsMetricsSchemaTunnelCount getMemoryPct() {
    return memoryPct;
  }

  public void setMemoryPct(EdgeHealthStatsMetricsSchemaTunnelCount memoryPct) {
    this.memoryPct = memoryPct;
  }

  public EdgeHealthStatsMetricsSchema flowCount(EdgeHealthStatsMetricsSchemaTunnelCount flowCount) {
  ...
  **/
  @Schema(description = "")
  public EdgeHealthStatsMetricsSchemaTunnelCount getFlowCount() {
    return flowCount;
  }

  public void setFlowCount(EdgeHealthStatsMetricsSchemaTunnelCount flowCount) {
    this.flowCount = flowCount;
  }

  public EdgeHealthStatsMetricsSchema cpuPct(EdgeHealthStatsMetricsSchemaTunnelCount cpuPct) {
    this.cpuPct = cpuPct;
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public EdgeHealthStatsMetricsSchemaTunnelCount getCpuPct() {
    return cpuPct;
  }

  public void setCpuPct(EdgeHealthStatsMetricsSchemaTunnelCount cpuPct) {
    this.cpuPct = cpuPct;
  }

  public EdgeHealthStatsMetricsSchema cpuCoreTemp(EdgeHealthStatsMetricsSchemaTunnelCount cpuCoreTemp) {
  ...
  **/
  @Schema(description = "")
  public EdgeHealthStatsMetricsSchemaTunnelCount getCpuCoreTemp() {
    return cpuCoreTemp;
  }

  public void setCpuCoreTemp(EdgeHealthStatsMetricsSchemaTunnelCount cpuCoreTemp) {
    this.cpuCoreTemp = cpuCoreTemp;
  }

  public EdgeHealthStatsMetricsSchema handoffQueueDrops(EdgeHealthStatsMetricsSchemaTunnelCount handoffQueueDrops) {
    this.handoffQueueDrops = handoffQueueDrops;
    return this;
  }

   /**
   * Get handoffQueueDrops
   * @return handoffQueueDrops
  **/
  @Schema(description = "")
  public EdgeHealthStatsMetricsSchemaTunnelCount getHandoffQueueDrops() {
    return handoffQueueDrops;
  }

  public void setHandoffQueueDrops(EdgeHealthStatsMetricsSchemaTunnelCount handoffQueueDrops) {
    this.handoffQueueDrops = handoffQueueDrops;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdgeHealthStatsMetricsSchema edgeHealthStatsMetricsSchema = (EdgeHealthStatsMetricsSchema) o;
    return Objects.equals(this._href, edgeHealthStatsMetricsSchema._href) &&
        Objects.equals(this.total, edgeHealthStatsMetricsSchema.total) &&
        Objects.equals(this.tunnelCount, edgeHealthStatsMetricsSchema.tunnelCount) &&
        Objects.equals(this.tunnelCountV6, edgeHealthStatsMetricsSchema.tunnelCountV6) &&
        Objects.equals(this.memoryPct, edgeHealthStatsMetricsSchema.memoryPct) &&
        Objects.equals(this.flowCount, edgeHealthStatsMetricsSchema.flowCount) &&
        Objects.equals(this.cpuPct, edgeHealthStatsMetricsSchema.cpuPct) &&
        Objects.equals(this.cpuCoreTemp, edgeHealthStatsMetricsSchema.cpuCoreTemp) &&
        Objects.equals(this.handoffQueueDrops, edgeHealthStatsMetricsSchema.handoffQueueDrops);
  }

  @Override
  public int hashCode() {
    return Objects.hash(_href, total, tunnelCount, tunnelCountV6, memoryPct, flowCount, cpuPct, cpuCoreTemp, handoffQueueDrops);
  }
  ...
  public String toString() {
    ...
    sb.append("class EdgeHealthStatsMetricsSchema {\n");
    ...
    sb.append("    tunnelCountV6: ").append(toIndentedString(tunnelCountV6)).append("\n");
    sb.append("    memoryPct: ").append(toIndentedString(memoryPct)).append("\n");
    sb.append("    flowCount: ").append(toIndentedString(flowCount)).append("\n");
    sb.append("    cpuPct: ").append(toIndentedString(cpuPct)).append("\n");
    sb.append("    cpuCoreTemp: ").append(toIndentedString(cpuCoreTemp)).append("\n");
    sb.append("    handoffQueueDrops: ").append(toIndentedString(handoffQueueDrops)).append("\n");
    sb.append("}");
    return sb.toString();
  }
