...
/**
 * DeviceSettingsNetflowIntervals
 */
...
public class DeviceSettingsNetflowIntervals {
  @JsonProperty("flowStats")
  private Integer flowStats = null;

  @JsonProperty("flowLinkStats")
  private Integer flowLinkStats = null;

  @JsonProperty("tunnelStats")
  private Integer tunnelStats = null;

  @JsonProperty("vrfTable")
  private Integer vrfTable = null;

  @JsonProperty("applicationTable")
  private Integer applicationTable = null;

  @JsonProperty("interfaceTable")
  private Integer interfaceTable = null;

  @JsonProperty("linkTable")
  private Integer linkTable = null;

  public DeviceSettingsNetflowIntervals flowStats(Integer flowStats) {
  ...
  **/
  ...
  public void setFlowStats(Integer flowStats) {
    this.flowStats = flowStats;
  }

  public DeviceSettingsNetflowIntervals flowLinkStats(Integer flowLinkStats) {
    this.flowLinkStats = flowLinkStats;
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public Integer getFlowLinkStats() {
    return flowLinkStats;
  }

  public void setFlowLinkStats(Integer flowLinkStats) {
    this.flowLinkStats = flowLinkStats;
  }

  public DeviceSettingsNetflowIntervals tunnelStats(Integer tunnelStats) {
  ...
  **/
  @Schema(description = "")
  public Integer getTunnelStats() {
    return tunnelStats;
  }

  public void setTunnelStats(Integer tunnelStats) {
    this.tunnelStats = tunnelStats;
  }

  public DeviceSettingsNetflowIntervals vrfTable(Integer vrfTable) {
    this.vrfTable = vrfTable;
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public Integer getVrfTable() {
    return vrfTable;
  }

  public void setVrfTable(Integer vrfTable) {
    this.vrfTable = vrfTable;
  }

  public DeviceSettingsNetflowIntervals applicationTable(Integer applicationTable) {
  ...
  **/
  @Schema(description = "")
  public Integer getApplicationTable() {
    return applicationTable;
  }

  public void setApplicationTable(Integer applicationTable) {
    this.applicationTable = applicationTable;
  }

  public DeviceSettingsNetflowIntervals interfaceTable(Integer interfaceTable) {
  ...
  **/
  @Schema(description = "")
  public Integer getInterfaceTable() {
    return interfaceTable;
  }

  public void setInterfaceTable(Integer interfaceTable) {
    this.interfaceTable = interfaceTable;
  }

  public DeviceSettingsNetflowIntervals linkTable(Integer linkTable) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DeviceSettingsNetflowIntervals deviceSettingsNetflowIntervals = (DeviceSettingsNetflowIntervals) o;
    return Objects.equals(this.flowStats, deviceSettingsNetflowIntervals.flowStats) &&
        Objects.equals(this.flowLinkStats, deviceSettingsNetflowIntervals.flowLinkStats) &&
        Objects.equals(this.tunnelStats, deviceSettingsNetflowIntervals.tunnelStats) &&
        Objects.equals(this.vrfTable, deviceSettingsNetflowIntervals.vrfTable) &&
        Objects.equals(this.applicationTable, deviceSettingsNetflowIntervals.applicationTable) &&
        Objects.equals(this.interfaceTable, deviceSettingsNetflowIntervals.interfaceTable) &&
        Objects.equals(this.linkTable, deviceSettingsNetflowIntervals.linkTable);
  }

  @Override
  public int hashCode() {
    return Objects.hash(flowStats, flowLinkStats, tunnelStats, vrfTable, applicationTable, interfaceTable, linkTable);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceSettingsNetflowIntervals {\n");
    
    sb.append("    flowStats: ").append(toIndentedString(flowStats)).append("\n");
    sb.append("    flowLinkStats: ").append(toIndentedString(flowLinkStats)).append("\n");
    sb.append("    tunnelStats: ").append(toIndentedString(tunnelStats)).append("\n");
    sb.append("    vrfTable: ").append(toIndentedString(vrfTable)).append("\n");
    sb.append("    applicationTable: ").append(toIndentedString(applicationTable)).append("\n");
    sb.append("    interfaceTable: ").append(toIndentedString(interfaceTable)).append("\n");
    sb.append("    linkTable: ").append(toIndentedString(linkTable)).append("\n");
    sb.append("}");
    return sb.toString();
  }
