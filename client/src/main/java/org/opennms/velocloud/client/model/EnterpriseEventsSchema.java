...
import org.opennms.velocloud.client.model.EnterpriseEventsResource;
/**
 * EnterpriseEventsSchema
 */
...
public class EnterpriseEventsSchema {
  @JsonProperty("_href")
  private String _href = null;

  @JsonProperty("data")
  private List<EnterpriseEventsResource> data = null;

  @JsonProperty("metaData")
  private CollectionMetadata metaData = null;

  public EnterpriseEventsSchema _href(String _href) {
    this._href = _href;
    return this;
  }
  ...
  **/
  ...
  public EnterpriseEventsSchema data(List<EnterpriseEventsResource> data) {
    this.data = data;
    return this;
  }

  public EnterpriseEventsSchema addDataItem(EnterpriseEventsResource dataItem) {
    if (this.data == null) {
  ...
  **/
  @Schema(description = "")
  public List<EnterpriseEventsResource> getData() {
    return data;
  }

  public void setData(List<EnterpriseEventsResource> data) {
    this.data = data;
  }

  public EnterpriseEventsSchema metaData(CollectionMetadata metaData) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EnterpriseEventsSchema enterpriseEventsSchema = (EnterpriseEventsSchema) o;
    return Objects.equals(this._href, enterpriseEventsSchema._href) &&
        Objects.equals(this.data, enterpriseEventsSchema.data) &&
        Objects.equals(this.metaData, enterpriseEventsSchema.metaData);
  }
  ...
  public String toString() {
    ...
    sb.append("class EnterpriseEventsSchema {\n");
