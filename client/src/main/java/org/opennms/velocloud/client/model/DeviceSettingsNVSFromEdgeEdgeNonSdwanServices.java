...
import org.opennms.velocloud.client.model.DeviceSettingsNVSFromEdgeConfig;
/**
 * DeviceSettingsNVSFromEdgeEdgeNonSdwanServices
 */
...
public class DeviceSettingsNVSFromEdgeEdgeNonSdwanServices {
  @JsonProperty("edgeNonSdwanService")
  private BaseApiResource11 edgeNonSdwanService = null;

  @JsonProperty("config")
  private DeviceSettingsNVSFromEdgeConfig config = null;

  @JsonProperty("edgeNonSdwanSites")
  private List<OneOfDeviceSettingsNVSFromEdgeEdgeNonSdwanServicesEdgeNonSdwanSitesItems> edgeNonSdwanSites = null;

  public DeviceSettingsNVSFromEdgeEdgeNonSdwanServices edgeNonSdwanService(BaseApiResource11 edgeNonSdwanService) {
    this.edgeNonSdwanService = edgeNonSdwanService;
    return this;
  }

   /**
   * Get edgeNonSdwanService
   * @return edgeNonSdwanService
  **/
  @Schema(description = "")
  public BaseApiResource11 getEdgeNonSdwanService() {
    return edgeNonSdwanService;
  }

  public void setEdgeNonSdwanService(BaseApiResource11 edgeNonSdwanService) {
    this.edgeNonSdwanService = edgeNonSdwanService;
  }

  public DeviceSettingsNVSFromEdgeEdgeNonSdwanServices config(DeviceSettingsNVSFromEdgeConfig config) {
    this.config = config;
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public DeviceSettingsNVSFromEdgeConfig getConfig() {
    return config;
  }

  public void setConfig(DeviceSettingsNVSFromEdgeConfig config) {
    this.config = config;
  }

  public DeviceSettingsNVSFromEdgeEdgeNonSdwanServices edgeNonSdwanSites(List<OneOfDeviceSettingsNVSFromEdgeEdgeNonSdwanServicesEdgeNonSdwanSitesItems> edgeNonSdwanSites) {
    this.edgeNonSdwanSites = edgeNonSdwanSites;
    return this;
  }

  public DeviceSettingsNVSFromEdgeEdgeNonSdwanServices addEdgeNonSdwanSitesItem(OneOfDeviceSettingsNVSFromEdgeEdgeNonSdwanServicesEdgeNonSdwanSitesItems edgeNonSdwanSitesItem) {
    if (this.edgeNonSdwanSites == null) {
      this.edgeNonSdwanSites = new ArrayList<>();
    }
    this.edgeNonSdwanSites.add(edgeNonSdwanSitesItem);
    return this;
  }

   /**
   * Get edgeNonSdwanSites
   * @return edgeNonSdwanSites
  **/
  @Schema(description = "")
  public List<OneOfDeviceSettingsNVSFromEdgeEdgeNonSdwanServicesEdgeNonSdwanSitesItems> getEdgeNonSdwanSites() {
    return edgeNonSdwanSites;
  }

  public void setEdgeNonSdwanSites(List<OneOfDeviceSettingsNVSFromEdgeEdgeNonSdwanServicesEdgeNonSdwanSitesItems> edgeNonSdwanSites) {
    this.edgeNonSdwanSites = edgeNonSdwanSites;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DeviceSettingsNVSFromEdgeEdgeNonSdwanServices deviceSettingsNVSFromEdgeEdgeNonSdwanServices = (DeviceSettingsNVSFromEdgeEdgeNonSdwanServices) o;
    return Objects.equals(this.edgeNonSdwanService, deviceSettingsNVSFromEdgeEdgeNonSdwanServices.edgeNonSdwanService) &&
        Objects.equals(this.config, deviceSettingsNVSFromEdgeEdgeNonSdwanServices.config) &&
        Objects.equals(this.edgeNonSdwanSites, deviceSettingsNVSFromEdgeEdgeNonSdwanServices.edgeNonSdwanSites);
  }

  @Override
  public int hashCode() {
    return Objects.hash(edgeNonSdwanService, config, edgeNonSdwanSites);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceSettingsNVSFromEdgeEdgeNonSdwanServices {\n");
    
    sb.append("    edgeNonSdwanService: ").append(toIndentedString(edgeNonSdwanService)).append("\n");
    sb.append("    config: ").append(toIndentedString(config)).append("\n");
    sb.append("    edgeNonSdwanSites: ").append(toIndentedString(edgeNonSdwanSites)).append("\n");
    sb.append("}");
    return sb.toString();
  }
