...
import org.opennms.velocloud.client.model.EnterpriseDeviceSettingsRadiusAuthenticationMacBypass;
/**
 * EnterpriseDeviceSettingsRadiusAuthentication
 */
...
public class EnterpriseDeviceSettingsRadiusAuthentication {
  @JsonProperty("enabled")
  private Boolean enabled = null;

  @JsonProperty("macBypass")
  private List<EnterpriseDeviceSettingsRadiusAuthenticationMacBypass> macBypass = null;

  public EnterpriseDeviceSettingsRadiusAuthentication enabled(Boolean enabled) {
  ...
  **/
  ...
  public EnterpriseDeviceSettingsRadiusAuthentication macBypass(List<EnterpriseDeviceSettingsRadiusAuthenticationMacBypass> macBypass) {
    this.macBypass = macBypass;
    return this;
  }

  public EnterpriseDeviceSettingsRadiusAuthentication addMacBypassItem(EnterpriseDeviceSettingsRadiusAuthenticationMacBypass macBypassItem) {
    if (this.macBypass == null) {
      this.macBypass = new ArrayList<>();
    }
    this.macBypass.add(macBypassItem);
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public List<EnterpriseDeviceSettingsRadiusAuthenticationMacBypass> getMacBypass() {
    return macBypass;
  }

  public void setMacBypass(List<EnterpriseDeviceSettingsRadiusAuthenticationMacBypass> macBypass) {
    this.macBypass = macBypass;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EnterpriseDeviceSettingsRadiusAuthentication enterpriseDeviceSettingsRadiusAuthentication = (EnterpriseDeviceSettingsRadiusAuthentication) o;
    return Objects.equals(this.enabled, enterpriseDeviceSettingsRadiusAuthentication.enabled) &&
        Objects.equals(this.macBypass, enterpriseDeviceSettingsRadiusAuthentication.macBypass);
  }

  @Override
  public int hashCode() {
    return Objects.hash(enabled, macBypass);
  }
  ...
  public String toString() {
    ...
    sb.append("class EnterpriseDeviceSettingsRadiusAuthentication {\n");
    
    sb.append("    enabled: ").append(toIndentedString(enabled)).append("\n");
    sb.append("    macBypass: ").append(toIndentedString(macBypass)).append("\n");
    sb.append("}");
    return sb.toString();
  }
