...
import org.opennms.velocloud.client.model.DeviceSettingsBGPAction;
import org.opennms.velocloud.client.model.DeviceSettingsBGPMatch;
/**
 * DeviceSettingsBGPFilterRule
 */
...
public class DeviceSettingsBGPFilterRule {
  @JsonProperty("action")
  private DeviceSettingsBGPAction action = null;

  @JsonProperty("match")
  private DeviceSettingsBGPMatch match = null;

  public DeviceSettingsBGPFilterRule action(DeviceSettingsBGPAction action) {
    this.action = action;
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public DeviceSettingsBGPAction getAction() {
    return action;
  }

  public void setAction(DeviceSettingsBGPAction action) {
    this.action = action;
  }

  public DeviceSettingsBGPFilterRule match(DeviceSettingsBGPMatch match) {
    this.match = match;
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public DeviceSettingsBGPMatch getMatch() {
    return match;
  }

  public void setMatch(DeviceSettingsBGPMatch match) {
    this.match = match;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DeviceSettingsBGPFilterRule deviceSettingsBGPFilterRule = (DeviceSettingsBGPFilterRule) o;
    return Objects.equals(this.action, deviceSettingsBGPFilterRule.action) &&
        Objects.equals(this.match, deviceSettingsBGPFilterRule.match);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceSettingsBGPFilterRule {\n");
