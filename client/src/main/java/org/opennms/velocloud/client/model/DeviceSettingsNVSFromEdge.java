...
import org.opennms.velocloud.client.model.DeviceSettingsNVSFromEdgeEdgeNonSdwanServices;
/**
 * DeviceSettingsNVSFromEdge
 */
...
public class DeviceSettingsNVSFromEdge {
  ...
  @JsonProperty("edgeNonSdwanServices")
  private List<DeviceSettingsNVSFromEdgeEdgeNonSdwanServices> edgeNonSdwanServices = null;

  public DeviceSettingsNVSFromEdge enabled(Boolean enabled) {
  ...
  **/
  ...
  public DeviceSettingsNVSFromEdge override(Boolean override) {
  ...
  **/
  ...
  public DeviceSettingsNVSFromEdge providers(List<Object> providers) {
    this.providers = providers;
    return this;
  }

  public DeviceSettingsNVSFromEdge addProvidersItem(Object providersItem) {
  ...
  **/
  ...
  public DeviceSettingsNVSFromEdge edgeNonSdwanServices(List<DeviceSettingsNVSFromEdgeEdgeNonSdwanServices> edgeNonSdwanServices) {
    this.edgeNonSdwanServices = edgeNonSdwanServices;
    return this;
  }

  public DeviceSettingsNVSFromEdge addEdgeNonSdwanServicesItem(DeviceSettingsNVSFromEdgeEdgeNonSdwanServices edgeNonSdwanServicesItem) {
    if (this.edgeNonSdwanServices == null) {
      this.edgeNonSdwanServices = new ArrayList<>();
    }
    this.edgeNonSdwanServices.add(edgeNonSdwanServicesItem);
    return this;
  }

   /**
   * Get edgeNonSdwanServices
   * @return edgeNonSdwanServices
  **/
  @Schema(description = "")
  public List<DeviceSettingsNVSFromEdgeEdgeNonSdwanServices> getEdgeNonSdwanServices() {
    return edgeNonSdwanServices;
  }

  public void setEdgeNonSdwanServices(List<DeviceSettingsNVSFromEdgeEdgeNonSdwanServices> edgeNonSdwanServices) {
    this.edgeNonSdwanServices = edgeNonSdwanServices;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DeviceSettingsNVSFromEdge deviceSettingsNVSFromEdge = (DeviceSettingsNVSFromEdge) o;
    return Objects.equals(this.enabled, deviceSettingsNVSFromEdge.enabled) &&
        Objects.equals(this.override, deviceSettingsNVSFromEdge.override) &&
        Objects.equals(this.providers, deviceSettingsNVSFromEdge.providers) &&
        Objects.equals(this.edgeNonSdwanServices, deviceSettingsNVSFromEdge.edgeNonSdwanServices);
  }

  @Override
  public int hashCode() {
    return Objects.hash(enabled, override, providers, edgeNonSdwanServices);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceSettingsNVSFromEdge {\n");
    
    sb.append("    enabled: ").append(toIndentedString(enabled)).append("\n");
    sb.append("    override: ").append(toIndentedString(override)).append("\n");
    sb.append("    providers: ").append(toIndentedString(providers)).append("\n");
    sb.append("    edgeNonSdwanServices: ").append(toIndentedString(edgeNonSdwanServices)).append("\n");
    sb.append("}");
    return sb.toString();
  }
