...
import org.opennms.velocloud.client.model.BaseApiResource7;
...
public class BgpSessionCollection {
  @JsonProperty("_href")
  private String _href = null;

  @JsonProperty("data")
  private List<BaseApiResource7> data = null;

  @JsonProperty("metaData")
  private CollectionMetadata metaData = null;

  public BgpSessionCollection _href(String _href) {
    this._href = _href;
    return this;
  }
  ...
  **/
  ...
  public BgpSessionCollection data(List<BaseApiResource7> data) {
    this.data = data;
    return this;
  }

  public BgpSessionCollection addDataItem(BaseApiResource7 dataItem) {
    if (this.data == null) {
  ...
  **/
  @Schema(description = "")
  public List<BaseApiResource7> getData() {
    return data;
  }

  public void setData(List<BaseApiResource7> data) {
    this.data = data;
  }

  public BgpSessionCollection metaData(CollectionMetadata metaData) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    BgpSessionCollection bgpSessionCollection = (BgpSessionCollection) o;
    return Objects.equals(this._href, bgpSessionCollection._href) &&
        Objects.equals(this.data, bgpSessionCollection.data) &&
        Objects.equals(this.metaData, bgpSessionCollection.metaData);
  }
  ...
  public String toString() {
    ...
    sb.append("class BgpSessionCollection {\n");
