...
public class DeviceSettingsSNPMv3 {
  ...
  public DeviceSettingsSNPMv3 enabled(Boolean enabled) {
  ...
  **/
  ...
  public DeviceSettingsSNPMv3 users(List<DeviceSettingsSNMPv3User> users) {
    this.users = users;
    return this;
  }

  public DeviceSettingsSNPMv3 addUsersItem(DeviceSettingsSNMPv3User usersItem) {
    if (this.users == null) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DeviceSettingsSNPMv3 deviceSettingsSNPMv3 = (DeviceSettingsSNPMv3) o;
    return Objects.equals(this.enabled, deviceSettingsSNPMv3.enabled) &&
        Objects.equals(this.users, deviceSettingsSNPMv3.users);
  }

  @Override
  public int hashCode() {
    return Objects.hash(enabled, users);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceSettingsSNPMv3 {\n");
