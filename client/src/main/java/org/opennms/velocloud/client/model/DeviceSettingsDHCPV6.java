...
import org.opennms.velocloud.client.model.DeviceSettingsDHCPOption;
import org.opennms.velocloud.client.model.DeviceSettingsDHCPRelay;
import org.opennms.velocloud.client.model.DeviceSettingsDHCPV6PrefixDelegation;
import org.opennms.velocloud.client.model.DeviceSettingsLANFixedIp;
/**
...
public class DeviceSettingsDHCPV6 {
  @JsonProperty("enabled")
  private Boolean enabled = null;

  @JsonProperty("dhcpRelay")
  private DeviceSettingsDHCPRelay dhcpRelay = null;

  @JsonProperty("leaseTimeSeconds")
  private Integer leaseTimeSeconds = null;

  @JsonProperty("options")
  private List<DeviceSettingsDHCPOption> options = null;

  @JsonProperty("prefixDelegation")
  private DeviceSettingsDHCPV6PrefixDelegation prefixDelegation = null;

  @JsonProperty("baseDhcpAddr")
  private AnyOfDeviceSettingsDHCPV6BaseDhcpAddr baseDhcpAddr = null;

  @JsonProperty("numDhcpAddr")
  private Integer numDhcpAddr = null;

  @JsonProperty("staticReserved")
  private Integer staticReserved = null;

  @JsonProperty("fixedIp")
  private List<DeviceSettingsLANFixedIp> fixedIp = null;

  public DeviceSettingsDHCPV6 enabled(Boolean enabled) {
  ...
  **/
  ...
  public DeviceSettingsDHCPV6 dhcpRelay(DeviceSettingsDHCPRelay dhcpRelay) {
  ...
  **/
  @Schema(description = "")
  public DeviceSettingsDHCPRelay getDhcpRelay() {
    return dhcpRelay;
  }

  public void setDhcpRelay(DeviceSettingsDHCPRelay dhcpRelay) {
    this.dhcpRelay = dhcpRelay;
  }

  public DeviceSettingsDHCPV6 leaseTimeSeconds(Integer leaseTimeSeconds) {
  ...
  **/
  ...
  public void setLeaseTimeSeconds(Integer leaseTimeSeconds) {
    this.leaseTimeSeconds = leaseTimeSeconds;
  }

  public DeviceSettingsDHCPV6 options(List<DeviceSettingsDHCPOption> options) {
    this.options = options;
    return this;
  }

  public DeviceSettingsDHCPV6 addOptionsItem(DeviceSettingsDHCPOption optionsItem) {
  ...
  **/
  @Schema(description = "")
  public List<DeviceSettingsDHCPOption> getOptions() {
    return options;
  }

  public void setOptions(List<DeviceSettingsDHCPOption> options) {
    this.options = options;
  }

  public DeviceSettingsDHCPV6 prefixDelegation(DeviceSettingsDHCPV6PrefixDelegation prefixDelegation) {
    this.prefixDelegation = prefixDelegation;
    return this;
  }

   /**
   * Get prefixDelegation
   * @return prefixDelegation
  **/
  @Schema(description = "")
  public DeviceSettingsDHCPV6PrefixDelegation getPrefixDelegation() {
    return prefixDelegation;
  }

  public void setPrefixDelegation(DeviceSettingsDHCPV6PrefixDelegation prefixDelegation) {
    this.prefixDelegation = prefixDelegation;
  }

  public DeviceSettingsDHCPV6 baseDhcpAddr(AnyOfDeviceSettingsDHCPV6BaseDhcpAddr baseDhcpAddr) {
  ...
  **/
  @Schema(description = "")
  public AnyOfDeviceSettingsDHCPV6BaseDhcpAddr getBaseDhcpAddr() {
    return baseDhcpAddr;
  }

  public void setBaseDhcpAddr(AnyOfDeviceSettingsDHCPV6BaseDhcpAddr baseDhcpAddr) {
    this.baseDhcpAddr = baseDhcpAddr;
  }

  public DeviceSettingsDHCPV6 numDhcpAddr(Integer numDhcpAddr) {
  ...
  **/
  ...
  public DeviceSettingsDHCPV6 staticReserved(Integer staticReserved) {
  ...
  **/
  ...
  public DeviceSettingsDHCPV6 fixedIp(List<DeviceSettingsLANFixedIp> fixedIp) {
    this.fixedIp = fixedIp;
    return this;
  }

  public DeviceSettingsDHCPV6 addFixedIpItem(DeviceSettingsLANFixedIp fixedIpItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DeviceSettingsDHCPV6 deviceSettingsDHCPV6 = (DeviceSettingsDHCPV6) o;
    return Objects.equals(this.enabled, deviceSettingsDHCPV6.enabled) &&
        Objects.equals(this.dhcpRelay, deviceSettingsDHCPV6.dhcpRelay) &&
        Objects.equals(this.leaseTimeSeconds, deviceSettingsDHCPV6.leaseTimeSeconds) &&
        Objects.equals(this.options, deviceSettingsDHCPV6.options) &&
        Objects.equals(this.prefixDelegation, deviceSettingsDHCPV6.prefixDelegation) &&
        Objects.equals(this.baseDhcpAddr, deviceSettingsDHCPV6.baseDhcpAddr) &&
        Objects.equals(this.numDhcpAddr, deviceSettingsDHCPV6.numDhcpAddr) &&
        Objects.equals(this.staticReserved, deviceSettingsDHCPV6.staticReserved) &&
        Objects.equals(this.fixedIp, deviceSettingsDHCPV6.fixedIp);
  }

  @Override
  public int hashCode() {
    return Objects.hash(enabled, dhcpRelay, leaseTimeSeconds, options, prefixDelegation, baseDhcpAddr, numDhcpAddr, staticReserved, fixedIp);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceSettingsDHCPV6 {\n");
    ...
    sb.append("    prefixDelegation: ").append(toIndentedString(prefixDelegation)).append("\n");
