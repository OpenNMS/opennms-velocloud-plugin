...
/**
 * EdgeHealthStatsSeriesSchemaSeries
 */
...
public class EdgeHealthStatsSeriesSchemaSeries {
  @JsonProperty("metric")
  ...
  @JsonProperty("data")
  private List<AnyOfEdgeHealthStatsSeriesSchemaSeriesDataItems> data = null;

  @JsonProperty("total")
  private AnyOfEdgeHealthStatsSeriesSchemaSeriesTotal total = null;

  @JsonProperty("min")
  private AnyOfEdgeHealthStatsSeriesSchemaSeriesMin min = null;

  @JsonProperty("max")
  private AnyOfEdgeHealthStatsSeriesSchemaSeriesMax max = null;

  public EdgeHealthStatsSeriesSchemaSeries metric(String metric) {
    this.metric = metric;
    return this;
  }
  ...
  **/
  ...
  public EdgeHealthStatsSeriesSchemaSeries startTime(OffsetDateTime startTime) {
  ...
  **/
  ...
  public EdgeHealthStatsSeriesSchemaSeries tickInterval(Float tickInterval) {
  ...
  **/
  ...
  public EdgeHealthStatsSeriesSchemaSeries data(List<AnyOfEdgeHealthStatsSeriesSchemaSeriesDataItems> data) {
    this.data = data;
    return this;
  }

  public EdgeHealthStatsSeriesSchemaSeries addDataItem(AnyOfEdgeHealthStatsSeriesSchemaSeriesDataItems dataItem) {
    if (this.data == null) {
  ...
  **/
  @Schema(description = "")
  public List<AnyOfEdgeHealthStatsSeriesSchemaSeriesDataItems> getData() {
    return data;
  }

  public void setData(List<AnyOfEdgeHealthStatsSeriesSchemaSeriesDataItems> data) {
    this.data = data;
  }

  public EdgeHealthStatsSeriesSchemaSeries total(AnyOfEdgeHealthStatsSeriesSchemaSeriesTotal total) {
    this.total = total;
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public AnyOfEdgeHealthStatsSeriesSchemaSeriesTotal getTotal() {
    return total;
  }

  public void setTotal(AnyOfEdgeHealthStatsSeriesSchemaSeriesTotal total) {
    this.total = total;
  }

  public EdgeHealthStatsSeriesSchemaSeries min(AnyOfEdgeHealthStatsSeriesSchemaSeriesMin min) {
    this.min = min;
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public AnyOfEdgeHealthStatsSeriesSchemaSeriesMin getMin() {
    return min;
  }

  public void setMin(AnyOfEdgeHealthStatsSeriesSchemaSeriesMin min) {
    this.min = min;
  }

  public EdgeHealthStatsSeriesSchemaSeries max(AnyOfEdgeHealthStatsSeriesSchemaSeriesMax max) {
    this.max = max;
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public AnyOfEdgeHealthStatsSeriesSchemaSeriesMax getMax() {
    return max;
  }

  public void setMax(AnyOfEdgeHealthStatsSeriesSchemaSeriesMax max) {
    this.max = max;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdgeHealthStatsSeriesSchemaSeries edgeHealthStatsSeriesSchemaSeries = (EdgeHealthStatsSeriesSchemaSeries) o;
    return Objects.equals(this.metric, edgeHealthStatsSeriesSchemaSeries.metric) &&
        Objects.equals(this.startTime, edgeHealthStatsSeriesSchemaSeries.startTime) &&
        Objects.equals(this.tickInterval, edgeHealthStatsSeriesSchemaSeries.tickInterval) &&
        Objects.equals(this.data, edgeHealthStatsSeriesSchemaSeries.data) &&
        Objects.equals(this.total, edgeHealthStatsSeriesSchemaSeries.total) &&
        Objects.equals(this.min, edgeHealthStatsSeriesSchemaSeries.min) &&
        Objects.equals(this.max, edgeHealthStatsSeriesSchemaSeries.max);
  }

  @Override
  public int hashCode() {
    return Objects.hash(metric, startTime, tickInterval, data, total, min, max);
  }
  ...
  public String toString() {
    ...
    sb.append("class EdgeHealthStatsSeriesSchemaSeries {\n");
