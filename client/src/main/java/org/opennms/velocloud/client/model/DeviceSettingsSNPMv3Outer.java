...
import org.opennms.velocloud.client.model.DeviceSettingsSNMPv3User;
/**
 * DeviceSettingsSNPMv3Outer
 */
...
public class DeviceSettingsSNPMv3Outer {
  @JsonProperty("enable")
  ...
  @JsonProperty("users")
  private List<DeviceSettingsSNMPv3User> users = null;

  public DeviceSettingsSNPMv3Outer enable(Boolean enable) {
    this.enable = enable;
    return this;
  }
  ...
  **/
  ...
  public DeviceSettingsSNPMv3Outer enabled(Boolean enabled) {
  ...
  **/
  ...
  public DeviceSettingsSNPMv3Outer users(List<DeviceSettingsSNMPv3User> users) {
    this.users = users;
    return this;
  }

  public DeviceSettingsSNPMv3Outer addUsersItem(DeviceSettingsSNMPv3User usersItem) {
    if (this.users == null) {
  ...
  **/
  @Schema(description = "")
  public List<DeviceSettingsSNMPv3User> getUsers() {
    return users;
  }

  public void setUsers(List<DeviceSettingsSNMPv3User> users) {
    this.users = users;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DeviceSettingsSNPMv3Outer deviceSettingsSNPMv3Outer = (DeviceSettingsSNPMv3Outer) o;
    return Objects.equals(this.enable, deviceSettingsSNPMv3Outer.enable) &&
        Objects.equals(this.enabled, deviceSettingsSNPMv3Outer.enabled) &&
        Objects.equals(this.users, deviceSettingsSNPMv3Outer.users);
  }

  @Override
  public int hashCode() {
    return Objects.hash(enable, enabled, users);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceSettingsSNPMv3Outer {\n");
