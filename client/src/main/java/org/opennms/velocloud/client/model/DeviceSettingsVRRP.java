...
import org.opennms.velocloud.client.model.DeviceSettingsVRRPVirtualRouter;
/**
 * DeviceSettingsVRRP
 */
...
public class DeviceSettingsVRRP {
  @JsonProperty("enabled")
  private Boolean enabled = null;

  @JsonProperty("data")
  private List<DeviceSettingsVRRPVirtualRouter> data = null;

  public DeviceSettingsVRRP enabled(Boolean enabled) {
  ...
  **/
  ...
  public DeviceSettingsVRRP data(List<DeviceSettingsVRRPVirtualRouter> data) {
    this.data = data;
    return this;
  }

  public DeviceSettingsVRRP addDataItem(DeviceSettingsVRRPVirtualRouter dataItem) {
    if (this.data == null) {
  ...
  **/
  @Schema(description = "")
  public List<DeviceSettingsVRRPVirtualRouter> getData() {
    return data;
  }

  public void setData(List<DeviceSettingsVRRPVirtualRouter> data) {
    this.data = data;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DeviceSettingsVRRP deviceSettingsVRRP = (DeviceSettingsVRRP) o;
    return Objects.equals(this.enabled, deviceSettingsVRRP.enabled) &&
        Objects.equals(this.data, deviceSettingsVRRP.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceSettingsVRRP {\n");
