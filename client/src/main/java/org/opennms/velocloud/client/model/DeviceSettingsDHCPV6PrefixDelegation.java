...
import org.opennms.velocloud.client.model.DeviceSettingsDHCPV6PrefixDelegationPool;
/**
 * DeviceSettingsDHCPV6PrefixDelegation
 */
...
public class DeviceSettingsDHCPV6PrefixDelegation {
  @JsonProperty("enabled")
  private Boolean enabled = null;

  @JsonProperty("pdlist")
  private List<DeviceSettingsDHCPV6PrefixDelegationPool> pdlist = null;

  public DeviceSettingsDHCPV6PrefixDelegation enabled(Boolean enabled) {
  ...
  **/
  ...
  public DeviceSettingsDHCPV6PrefixDelegation pdlist(List<DeviceSettingsDHCPV6PrefixDelegationPool> pdlist) {
    this.pdlist = pdlist;
    return this;
  }

  public DeviceSettingsDHCPV6PrefixDelegation addPdlistItem(DeviceSettingsDHCPV6PrefixDelegationPool pdlistItem) {
    if (this.pdlist == null) {
      this.pdlist = new ArrayList<>();
    }
    this.pdlist.add(pdlistItem);
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public List<DeviceSettingsDHCPV6PrefixDelegationPool> getPdlist() {
    return pdlist;
  }

  public void setPdlist(List<DeviceSettingsDHCPV6PrefixDelegationPool> pdlist) {
    this.pdlist = pdlist;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DeviceSettingsDHCPV6PrefixDelegation deviceSettingsDHCPV6PrefixDelegation = (DeviceSettingsDHCPV6PrefixDelegation) o;
    return Objects.equals(this.enabled, deviceSettingsDHCPV6PrefixDelegation.enabled) &&
        Objects.equals(this.pdlist, deviceSettingsDHCPV6PrefixDelegation.pdlist);
  }

  @Override
  public int hashCode() {
    return Objects.hash(enabled, pdlist);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceSettingsDHCPV6PrefixDelegation {\n");
    
    sb.append("    enabled: ").append(toIndentedString(enabled)).append("\n");
    sb.append("    pdlist: ").append(toIndentedString(pdlist)).append("\n");
    sb.append("}");
    return sb.toString();
  }
