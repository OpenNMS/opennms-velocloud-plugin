...
import org.opennms.velocloud.client.model.NonSdwanServiceStatusData;
/**
 * NonSdwanServiceStatus
 */
...
public class NonSdwanServiceStatus {
  @JsonProperty("_href")
  private String _href = null;

  @JsonProperty("data")
  private List<NonSdwanServiceStatusData> data = null;

  @JsonProperty("metaData")
  private CollectionMetadata metaData = null;

  public NonSdwanServiceStatus _href(String _href) {
    this._href = _href;
    return this;
  }
  ...
  **/
  ...
  public NonSdwanServiceStatus data(List<NonSdwanServiceStatusData> data) {
    this.data = data;
    return this;
  }

  public NonSdwanServiceStatus addDataItem(NonSdwanServiceStatusData dataItem) {
    if (this.data == null) {
  ...
  **/
  @Schema(description = "")
  public List<NonSdwanServiceStatusData> getData() {
    return data;
  }

  public void setData(List<NonSdwanServiceStatusData> data) {
    this.data = data;
  }

  public NonSdwanServiceStatus metaData(CollectionMetadata metaData) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    NonSdwanServiceStatus nonSdwanServiceStatus = (NonSdwanServiceStatus) o;
    return Objects.equals(this._href, nonSdwanServiceStatus._href) &&
        Objects.equals(this.data, nonSdwanServiceStatus.data) &&
        Objects.equals(this.metaData, nonSdwanServiceStatus.metaData);
  }
  ...
  public String toString() {
    ...
    sb.append("class NonSdwanServiceStatus {\n");
