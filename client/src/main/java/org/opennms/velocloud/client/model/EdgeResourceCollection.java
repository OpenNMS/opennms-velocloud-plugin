...
public class EdgeResourceCollection {
  @JsonProperty("_href")
  private String _href = null;

  @JsonProperty("data")
  private List<BaseApiResource2> data = null;

  @JsonProperty("metaData")
  private CollectionMetadata metaData = null;

  public EdgeResourceCollection _href(String _href) {
    this._href = _href;
    return this;
  }
  ...
  **/
  ...
  public EdgeResourceCollection data(List<BaseApiResource2> data) {
    this.data = data;
    return this;
  }

  public EdgeResourceCollection addDataItem(BaseApiResource2 dataItem) {
    if (this.data == null) {
  ...
  **/
  @Schema(description = "")
  public List<BaseApiResource2> getData() {
    return data;
  }

  public void setData(List<BaseApiResource2> data) {
    this.data = data;
  }

  public EdgeResourceCollection metaData(CollectionMetadata metaData) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdgeResourceCollection edgeResourceCollection = (EdgeResourceCollection) o;
    return Objects.equals(this._href, edgeResourceCollection._href) &&
        Objects.equals(this.data, edgeResourceCollection.data) &&
        Objects.equals(this.metaData, edgeResourceCollection.metaData);
  }
  ...
  public String toString() {
    ...
    sb.append("class EdgeResourceCollection {\n");
