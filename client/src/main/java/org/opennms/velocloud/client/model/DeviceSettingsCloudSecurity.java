...
import org.opennms.velocloud.client.model.DeviceSettingsCloudSecurityConfig;
/**
 * DeviceSettingsCloudSecurity
 */
...
public class DeviceSettingsCloudSecurity {
  ...
  @JsonProperty("config")
  private DeviceSettingsCloudSecurityConfig config = null;

  @JsonProperty("provider")
  private Object provider = null;

  @JsonProperty("cloudSecurityProvider")
  private BaseApiResource11 cloudSecurityProvider = null;

  @JsonProperty("sites")
  private List<Object> sites = null;

  @JsonProperty("cloudSecuritySites")
  private List<OneOfDeviceSettingsCloudSecurityCloudSecuritySitesItems> cloudSecuritySites = null;

  public DeviceSettingsCloudSecurity enabled(Boolean enabled) {
  ...
  **/
  ...
  public DeviceSettingsCloudSecurity override(Boolean override) {
  ...
  **/
  ...
  public DeviceSettingsCloudSecurity config(DeviceSettingsCloudSecurityConfig config) {
    this.config = config;
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public DeviceSettingsCloudSecurityConfig getConfig() {
    return config;
  }

  public void setConfig(DeviceSettingsCloudSecurityConfig config) {
    this.config = config;
  }

  public DeviceSettingsCloudSecurity provider(Object provider) {
  ...
  **/
  ...
  public DeviceSettingsCloudSecurity cloudSecurityProvider(BaseApiResource11 cloudSecurityProvider) {
    this.cloudSecurityProvider = cloudSecurityProvider;
    return this;
  }

   /**
   * Get cloudSecurityProvider
   * @return cloudSecurityProvider
  **/
  @Schema(description = "")
  public BaseApiResource11 getCloudSecurityProvider() {
    return cloudSecurityProvider;
  }

  public void setCloudSecurityProvider(BaseApiResource11 cloudSecurityProvider) {
    this.cloudSecurityProvider = cloudSecurityProvider;
  }

  public DeviceSettingsCloudSecurity sites(List<Object> sites) {
    this.sites = sites;
    return this;
  }

  public DeviceSettingsCloudSecurity addSitesItem(Object sitesItem) {
    if (this.sites == null) {
  ...
  **/
  ...
  public DeviceSettingsCloudSecurity cloudSecuritySites(List<OneOfDeviceSettingsCloudSecurityCloudSecuritySitesItems> cloudSecuritySites) {
    this.cloudSecuritySites = cloudSecuritySites;
    return this;
  }

  public DeviceSettingsCloudSecurity addCloudSecuritySitesItem(OneOfDeviceSettingsCloudSecurityCloudSecuritySitesItems cloudSecuritySitesItem) {
    if (this.cloudSecuritySites == null) {
      this.cloudSecuritySites = new ArrayList<>();
    }
    this.cloudSecuritySites.add(cloudSecuritySitesItem);
    return this;
  }

   /**
   * Get cloudSecuritySites
   * @return cloudSecuritySites
  **/
  @Schema(description = "")
  public List<OneOfDeviceSettingsCloudSecurityCloudSecuritySitesItems> getCloudSecuritySites() {
    return cloudSecuritySites;
  }

  public void setCloudSecuritySites(List<OneOfDeviceSettingsCloudSecurityCloudSecuritySitesItems> cloudSecuritySites) {
    this.cloudSecuritySites = cloudSecuritySites;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DeviceSettingsCloudSecurity deviceSettingsCloudSecurity = (DeviceSettingsCloudSecurity) o;
    return Objects.equals(this.enabled, deviceSettingsCloudSecurity.enabled) &&
        Objects.equals(this.override, deviceSettingsCloudSecurity.override) &&
        Objects.equals(this.config, deviceSettingsCloudSecurity.config) &&
        Objects.equals(this.provider, deviceSettingsCloudSecurity.provider) &&
        Objects.equals(this.cloudSecurityProvider, deviceSettingsCloudSecurity.cloudSecurityProvider) &&
        Objects.equals(this.sites, deviceSettingsCloudSecurity.sites) &&
        Objects.equals(this.cloudSecuritySites, deviceSettingsCloudSecurity.cloudSecuritySites);
  }

  @Override
  public int hashCode() {
    return Objects.hash(enabled, override, config, provider, cloudSecurityProvider, sites, cloudSecuritySites);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceSettingsCloudSecurity {\n");
    
    sb.append("    enabled: ").append(toIndentedString(enabled)).append("\n");
    sb.append("    override: ").append(toIndentedString(override)).append("\n");
    sb.append("    config: ").append(toIndentedString(config)).append("\n");
    sb.append("    provider: ").append(toIndentedString(provider)).append("\n");
    sb.append("    cloudSecurityProvider: ").append(toIndentedString(cloudSecurityProvider)).append("\n");
    sb.append("    sites: ").append(toIndentedString(sites)).append("\n");
    sb.append("    cloudSecuritySites: ").append(toIndentedString(cloudSecuritySites)).append("\n");
    sb.append("}");
    return sb.toString();
  }
