...
import org.opennms.velocloud.client.model.EnterpriseAlertsResource;
/**
 * EnterpriseAlertsSchema
 */
...
public class EnterpriseAlertsSchema {
  @JsonProperty("_href")
  private String _href = null;

  @JsonProperty("data")
  private List<EnterpriseAlertsResource> data = null;

  @JsonProperty("metaData")
  private CollectionMetadata metaData = null;

  public EnterpriseAlertsSchema _href(String _href) {
    this._href = _href;
    return this;
  }
  ...
  **/
  ...
  public EnterpriseAlertsSchema data(List<EnterpriseAlertsResource> data) {
    this.data = data;
    return this;
  }

  public EnterpriseAlertsSchema addDataItem(EnterpriseAlertsResource dataItem) {
    if (this.data == null) {
  ...
  **/
  @Schema(description = "")
  public List<EnterpriseAlertsResource> getData() {
    return data;
  }

  public void setData(List<EnterpriseAlertsResource> data) {
    this.data = data;
  }

  public EnterpriseAlertsSchema metaData(CollectionMetadata metaData) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EnterpriseAlertsSchema enterpriseAlertsSchema = (EnterpriseAlertsSchema) o;
    return Objects.equals(this._href, enterpriseAlertsSchema._href) &&
        Objects.equals(this.data, enterpriseAlertsSchema.data) &&
        Objects.equals(this.metaData, enterpriseAlertsSchema.metaData);
  }
  ...
  public String toString() {
    ...
    sb.append("class EnterpriseAlertsSchema {\n");
