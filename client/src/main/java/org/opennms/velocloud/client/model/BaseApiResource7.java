...
import org.opennms.velocloud.client.model.BaseApiResource6;
/**
 * BaseApiResource7
 */
...
public class BaseApiResource7 {
  @JsonProperty("_href")
  private String _href = null;

  @JsonProperty("msgRcvd")
  private Integer msgRcvd = null;

  @JsonProperty("msgSent")
  private Integer msgSent = null;

  @JsonProperty("neighborIp")
  private String neighborIp = null;

  @JsonProperty("neighborAS")
  private Integer neighborAS = null;

  @JsonProperty("pfxRcvd")
  private Integer pfxRcvd = null;
  ...
  @JsonProperty("upDownTime")
  private String upDownTime = null;

  @JsonProperty("edge")
  private BaseApiResource2 edge = null;

  @JsonProperty("gateway")
  private BaseApiResource6 gateway = null;

  public BaseApiResource7 _href(String _href) {
    this._href = _href;
    return this;
  }
  ...
  **/
  ...
  public BaseApiResource7 msgRcvd(Integer msgRcvd) {
  ...
  **/
  @Schema(description = "")
  public Integer getMsgRcvd() {
    return msgRcvd;
  }

  public void setMsgRcvd(Integer msgRcvd) {
    this.msgRcvd = msgRcvd;
  }

  public BaseApiResource7 msgSent(Integer msgSent) {
  ...
  **/
  ...
  public BaseApiResource7 neighborIp(String neighborIp) {
  ...
  **/
  ...
  public BaseApiResource7 neighborAS(Integer neighborAS) {
  ...
  **/
  ...
  public BaseApiResource7 pfxRcvd(Integer pfxRcvd) {
    this.pfxRcvd = pfxRcvd;
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public Integer getPfxRcvd() {
    return pfxRcvd;
  }

  public void setPfxRcvd(Integer pfxRcvd) {
    this.pfxRcvd = pfxRcvd;
  }

  public BaseApiResource7 state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  **/
  ...
  public BaseApiResource7 timestamp(OffsetDateTime timestamp) {
  ...
  **/
  ...
  public BaseApiResource7 upDownTime(String upDownTime) {
  ...
  **/
  @Schema(description = "")
  public String getUpDownTime() {
    return upDownTime;
  }

  public void setUpDownTime(String upDownTime) {
    this.upDownTime = upDownTime;
  }

  public BaseApiResource7 edge(BaseApiResource2 edge) {
    this.edge = edge;
    return this;
  }
  ...
  **/
  ...
  public BaseApiResource7 gateway(BaseApiResource6 gateway) {
  ...
  **/
  @Schema(description = "")
  public BaseApiResource6 getGateway() {
    return gateway;
  }

  public void setGateway(BaseApiResource6 gateway) {
    this.gateway = gateway;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    BaseApiResource7 baseApiResource7 = (BaseApiResource7) o;
    return Objects.equals(this._href, baseApiResource7._href) &&
        Objects.equals(this.msgRcvd, baseApiResource7.msgRcvd) &&
        Objects.equals(this.msgSent, baseApiResource7.msgSent) &&
        Objects.equals(this.neighborIp, baseApiResource7.neighborIp) &&
        Objects.equals(this.neighborAS, baseApiResource7.neighborAS) &&
        Objects.equals(this.pfxRcvd, baseApiResource7.pfxRcvd) &&
        Objects.equals(this.state, baseApiResource7.state) &&
        Objects.equals(this.timestamp, baseApiResource7.timestamp) &&
        Objects.equals(this.upDownTime, baseApiResource7.upDownTime) &&
        Objects.equals(this.edge, baseApiResource7.edge) &&
        Objects.equals(this.gateway, baseApiResource7.gateway);
  }

  @Override
  public int hashCode() {
    return Objects.hash(_href, msgRcvd, msgSent, neighborIp, neighborAS, pfxRcvd, state, timestamp, upDownTime, edge, gateway);
  }
  ...
  public String toString() {
    ...
    sb.append("class BaseApiResource7 {\n");
    
    sb.append("    _href: ").append(toIndentedString(_href)).append("\n");
    sb.append("    msgRcvd: ").append(toIndentedString(msgRcvd)).append("\n");
    sb.append("    msgSent: ").append(toIndentedString(msgSent)).append("\n");
    ...
    sb.append("    pfxRcvd: ").append(toIndentedString(pfxRcvd)).append("\n");
    sb.append("    state: ").append(toIndentedString(state)).append("\n");
    sb.append("    timestamp: ").append(toIndentedString(timestamp)).append("\n");
    sb.append("    upDownTime: ").append(toIndentedString(upDownTime)).append("\n");
