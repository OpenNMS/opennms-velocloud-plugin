...
public class GlobalIPv6AdvancedConfiguration {
  @JsonProperty("disableAllIPv6Traffic")
  private Boolean disableAllIPv6Traffic = null;

  @JsonProperty("dropRoutingHeaderTypeZeroPackets")
  private Boolean dropRoutingHeaderTypeZeroPackets = null;

  @JsonProperty("enforceExtensionHeaderValidation")
  private Boolean enforceExtensionHeaderValidation = null;

  @JsonProperty("enforceExtensionHeaderOrderCheck")
  private Boolean enforceExtensionHeaderOrderCheck = null;

  @JsonProperty("dropnLogPacketsForRFCReservedFields")
