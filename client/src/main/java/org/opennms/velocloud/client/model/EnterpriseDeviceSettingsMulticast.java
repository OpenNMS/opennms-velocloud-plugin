...
import org.opennms.velocloud.client.model.DeviceSettingsLANMulticastIgmp;
import org.opennms.velocloud.client.model.DeviceSettingsLANMulticastPim;
/**
 * EnterpriseDeviceSettingsMulticast
 */
...
public class EnterpriseDeviceSettingsMulticast {
  @JsonProperty("igmp")
  private DeviceSettingsLANMulticastIgmp igmp = null;

  @JsonProperty("igmpHostQueryIntervalSeconds")
  private Integer igmpHostQueryIntervalSeconds = null;

  @JsonProperty("igmpMaxQueryResponse")
  private Integer igmpMaxQueryResponse = null;

  @JsonProperty("pim")
  private DeviceSettingsLANMulticastPim pim = null;

  @JsonProperty("pimKeepAliveTimerSeconds")
  private Integer pimKeepAliveTimerSeconds = null;

  @JsonProperty("pimPruneIntervalSeconds")
  private Integer pimPruneIntervalSeconds = null;

  @JsonProperty("pimHelloTimerSeconds")
  private Integer pimHelloTimerSeconds = null;

  public EnterpriseDeviceSettingsMulticast igmp(DeviceSettingsLANMulticastIgmp igmp) {
    this.igmp = igmp;
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public DeviceSettingsLANMulticastIgmp getIgmp() {
    return igmp;
  }

  public void setIgmp(DeviceSettingsLANMulticastIgmp igmp) {
    this.igmp = igmp;
  }

  public EnterpriseDeviceSettingsMulticast igmpHostQueryIntervalSeconds(Integer igmpHostQueryIntervalSeconds) {
    this.igmpHostQueryIntervalSeconds = igmpHostQueryIntervalSeconds;
    return this;
  }

   /**
   * Get igmpHostQueryIntervalSeconds
   * @return igmpHostQueryIntervalSeconds
  **/
  @Schema(description = "")
  public Integer getIgmpHostQueryIntervalSeconds() {
    return igmpHostQueryIntervalSeconds;
  }

  public void setIgmpHostQueryIntervalSeconds(Integer igmpHostQueryIntervalSeconds) {
    this.igmpHostQueryIntervalSeconds = igmpHostQueryIntervalSeconds;
  }

  public EnterpriseDeviceSettingsMulticast igmpMaxQueryResponse(Integer igmpMaxQueryResponse) {
    this.igmpMaxQueryResponse = igmpMaxQueryResponse;
    return this;
  }

   /**
   * Get igmpMaxQueryResponse
   * @return igmpMaxQueryResponse
  **/
  @Schema(description = "")
  public Integer getIgmpMaxQueryResponse() {
    return igmpMaxQueryResponse;
  }

  public void setIgmpMaxQueryResponse(Integer igmpMaxQueryResponse) {
    this.igmpMaxQueryResponse = igmpMaxQueryResponse;
  }

  public EnterpriseDeviceSettingsMulticast pim(DeviceSettingsLANMulticastPim pim) {
    this.pim = pim;
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public DeviceSettingsLANMulticastPim getPim() {
    return pim;
  }

  public void setPim(DeviceSettingsLANMulticastPim pim) {
    this.pim = pim;
  }

  public EnterpriseDeviceSettingsMulticast pimKeepAliveTimerSeconds(Integer pimKeepAliveTimerSeconds) {
    this.pimKeepAliveTimerSeconds = pimKeepAliveTimerSeconds;
    return this;
  }

   /**
   * Get pimKeepAliveTimerSeconds
   * @return pimKeepAliveTimerSeconds
  **/
  @Schema(description = "")
  public Integer getPimKeepAliveTimerSeconds() {
    return pimKeepAliveTimerSeconds;
  }

  public void setPimKeepAliveTimerSeconds(Integer pimKeepAliveTimerSeconds) {
    this.pimKeepAliveTimerSeconds = pimKeepAliveTimerSeconds;
  }

  public EnterpriseDeviceSettingsMulticast pimPruneIntervalSeconds(Integer pimPruneIntervalSeconds) {
    this.pimPruneIntervalSeconds = pimPruneIntervalSeconds;
    return this;
  }

   /**
   * Get pimPruneIntervalSeconds
   * @return pimPruneIntervalSeconds
  **/
  @Schema(description = "")
  public Integer getPimPruneIntervalSeconds() {
    return pimPruneIntervalSeconds;
  }

  public void setPimPruneIntervalSeconds(Integer pimPruneIntervalSeconds) {
    this.pimPruneIntervalSeconds = pimPruneIntervalSeconds;
  }

  public EnterpriseDeviceSettingsMulticast pimHelloTimerSeconds(Integer pimHelloTimerSeconds) {
    this.pimHelloTimerSeconds = pimHelloTimerSeconds;
    return this;
  }

   /**
   * Get pimHelloTimerSeconds
   * @return pimHelloTimerSeconds
  **/
  @Schema(description = "")
  public Integer getPimHelloTimerSeconds() {
    return pimHelloTimerSeconds;
  }

  public void setPimHelloTimerSeconds(Integer pimHelloTimerSeconds) {
    this.pimHelloTimerSeconds = pimHelloTimerSeconds;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EnterpriseDeviceSettingsMulticast enterpriseDeviceSettingsMulticast = (EnterpriseDeviceSettingsMulticast) o;
    return Objects.equals(this.igmp, enterpriseDeviceSettingsMulticast.igmp) &&
        Objects.equals(this.igmpHostQueryIntervalSeconds, enterpriseDeviceSettingsMulticast.igmpHostQueryIntervalSeconds) &&
        Objects.equals(this.igmpMaxQueryResponse, enterpriseDeviceSettingsMulticast.igmpMaxQueryResponse) &&
        Objects.equals(this.pim, enterpriseDeviceSettingsMulticast.pim) &&
        Objects.equals(this.pimKeepAliveTimerSeconds, enterpriseDeviceSettingsMulticast.pimKeepAliveTimerSeconds) &&
        Objects.equals(this.pimPruneIntervalSeconds, enterpriseDeviceSettingsMulticast.pimPruneIntervalSeconds) &&
        Objects.equals(this.pimHelloTimerSeconds, enterpriseDeviceSettingsMulticast.pimHelloTimerSeconds);
  }

  @Override
  public int hashCode() {
    return Objects.hash(igmp, igmpHostQueryIntervalSeconds, igmpMaxQueryResponse, pim, pimKeepAliveTimerSeconds, pimPruneIntervalSeconds, pimHelloTimerSeconds);
  }
  ...
  public String toString() {
    ...
    sb.append("class EnterpriseDeviceSettingsMulticast {\n");
    
    sb.append("    igmp: ").append(toIndentedString(igmp)).append("\n");
    sb.append("    igmpHostQueryIntervalSeconds: ").append(toIndentedString(igmpHostQueryIntervalSeconds)).append("\n");
    sb.append("    igmpMaxQueryResponse: ").append(toIndentedString(igmpMaxQueryResponse)).append("\n");
    sb.append("    pim: ").append(toIndentedString(pim)).append("\n");
    sb.append("    pimKeepAliveTimerSeconds: ").append(toIndentedString(pimKeepAliveTimerSeconds)).append("\n");
    sb.append("    pimPruneIntervalSeconds: ").append(toIndentedString(pimPruneIntervalSeconds)).append("\n");
    sb.append("    pimHelloTimerSeconds: ").append(toIndentedString(pimHelloTimerSeconds)).append("\n");
    sb.append("}");
    return sb.toString();
  }
