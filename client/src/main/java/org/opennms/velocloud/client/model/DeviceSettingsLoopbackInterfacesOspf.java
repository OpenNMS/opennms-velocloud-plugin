...
/**
 * DeviceSettingsLoopbackInterfacesOspf
 */
...
public class DeviceSettingsLoopbackInterfacesOspf {
  ...
  public DeviceSettingsLoopbackInterfacesOspf enabled(Boolean enabled) {
  ...
  **/
  ...
  public DeviceSettingsLoopbackInterfacesOspf area(List<String> area) {
    this.area = area;
    return this;
  }

  public DeviceSettingsLoopbackInterfacesOspf addAreaItem(String areaItem) {
    if (this.area == null) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DeviceSettingsLoopbackInterfacesOspf deviceSettingsLoopbackInterfacesOspf = (DeviceSettingsLoopbackInterfacesOspf) o;
    return Objects.equals(this.enabled, deviceSettingsLoopbackInterfacesOspf.enabled) &&
        Objects.equals(this.area, deviceSettingsLoopbackInterfacesOspf.area);
  }

  @Override
  public int hashCode() {
    return Objects.hash(enabled, area);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceSettingsLoopbackInterfacesOspf {\n");
