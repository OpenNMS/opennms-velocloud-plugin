...
import org.opennms.velocloud.client.model.DeviceSettingsSecurityVNFVM;
/**
 * DeviceSettingsVNFSSecurityVnf
 */
...
public class DeviceSettingsVNFSSecurityVnf {
  @JsonProperty("vms")
  private List<DeviceSettingsSecurityVNFVM> vms = null;

  public DeviceSettingsVNFSSecurityVnf vms(List<DeviceSettingsSecurityVNFVM> vms) {
    this.vms = vms;
    return this;
  }

  public DeviceSettingsVNFSSecurityVnf addVmsItem(DeviceSettingsSecurityVNFVM vmsItem) {
    if (this.vms == null) {
  ...
  **/
  @Schema(description = "")
  public List<DeviceSettingsSecurityVNFVM> getVms() {
    return vms;
  }

  public void setVms(List<DeviceSettingsSecurityVNFVM> vms) {
    this.vms = vms;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DeviceSettingsVNFSSecurityVnf deviceSettingsVNFSSecurityVnf = (DeviceSettingsVNFSSecurityVnf) o;
    return Objects.equals(this.vms, deviceSettingsVNFSSecurityVnf.vms);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceSettingsVNFSSecurityVnf {\n");
