...
public class EnterpriseResourceCollection {
  @JsonProperty("_href")
  private String _href = null;

  @JsonProperty("data")
  private List<BaseApiResource1> data = null;

  @JsonProperty("metaData")
  private CollectionMetadata metaData = null;

  public EnterpriseResourceCollection _href(String _href) {
    this._href = _href;
    return this;
  }
  ...
  **/
  ...
  public EnterpriseResourceCollection data(List<BaseApiResource1> data) {
    this.data = data;
    return this;
  }

  public EnterpriseResourceCollection addDataItem(BaseApiResource1 dataItem) {
    if (this.data == null) {
  ...
  **/
  @Schema(description = "")
  public List<BaseApiResource1> getData() {
    return data;
  }

  public void setData(List<BaseApiResource1> data) {
    this.data = data;
  }

  public EnterpriseResourceCollection metaData(CollectionMetadata metaData) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EnterpriseResourceCollection enterpriseResourceCollection = (EnterpriseResourceCollection) o;
    return Objects.equals(this._href, enterpriseResourceCollection._href) &&
        Objects.equals(this.data, enterpriseResourceCollection.data) &&
        Objects.equals(this.metaData, enterpriseResourceCollection.metaData);
  }
  ...
  public String toString() {
    ...
    sb.append("class EnterpriseResourceCollection {\n");
