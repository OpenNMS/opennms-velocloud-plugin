...
import org.opennms.velocloud.client.model.BaseApiResource9;
/**
 * NonSdwanServiceStatusData
 */
...
public class NonSdwanServiceStatusData {
  @JsonProperty("tunnels")
  private List<BaseApiResource9> tunnels = null;

  @JsonProperty("provider")
  private BaseApiResource provider = null;

  public NonSdwanServiceStatusData tunnels(List<BaseApiResource9> tunnels) {
    this.tunnels = tunnels;
    return this;
  }

  public NonSdwanServiceStatusData addTunnelsItem(BaseApiResource9 tunnelsItem) {
  ...
  **/
  @Schema(description = "")
  public List<BaseApiResource9> getTunnels() {
    return tunnels;
  }

  public void setTunnels(List<BaseApiResource9> tunnels) {
    this.tunnels = tunnels;
  }

  public NonSdwanServiceStatusData provider(BaseApiResource provider) {
  ...
  **/
  @Schema(description = "")
  public BaseApiResource getProvider() {
    return provider;
  }

  public void setProvider(BaseApiResource provider) {
    this.provider = provider;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    NonSdwanServiceStatusData nonSdwanServiceStatusData = (NonSdwanServiceStatusData) o;
    return Objects.equals(this.tunnels, nonSdwanServiceStatusData.tunnels) &&
        Objects.equals(this.provider, nonSdwanServiceStatusData.provider);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tunnels, provider);
  }
  ...
  public String toString() {
    ...
    sb.append("class NonSdwanServiceStatusData {\n");
