...
import org.opennms.velocloud.client.model.DeviceSettingsRPStaticGroup;
/**
 * DeviceSettingsMulticastRP
 */
...
public class DeviceSettingsMulticastRP {
  /**
   * Gets or Sets type
   */
  ...
  @JsonProperty("staticGroups")
  private List<DeviceSettingsRPStaticGroup> staticGroups = null;

  public DeviceSettingsMulticastRP type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  public DeviceSettingsMulticastRP staticGroups(List<DeviceSettingsRPStaticGroup> staticGroups) {
    this.staticGroups = staticGroups;
    return this;
  }

  public DeviceSettingsMulticastRP addStaticGroupsItem(DeviceSettingsRPStaticGroup staticGroupsItem) {
    if (this.staticGroups == null) {
      this.staticGroups = new ArrayList<>();
    }
    this.staticGroups.add(staticGroupsItem);
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public List<DeviceSettingsRPStaticGroup> getStaticGroups() {
    return staticGroups;
  }

  public void setStaticGroups(List<DeviceSettingsRPStaticGroup> staticGroups) {
    this.staticGroups = staticGroups;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DeviceSettingsMulticastRP deviceSettingsMulticastRP = (DeviceSettingsMulticastRP) o;
    return Objects.equals(this.type, deviceSettingsMulticastRP.type) &&
        Objects.equals(this.staticGroups, deviceSettingsMulticastRP.staticGroups);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, staticGroups);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceSettingsMulticastRP {\n");
    
    sb.append("    type: ").append(toIndentedString(type)).append("\n");
    sb.append("    staticGroups: ").append(toIndentedString(staticGroups)).append("\n");
    sb.append("}");
    return sb.toString();
  }
