...
import org.opennms.velocloud.client.model.DeviceSettingsBFDRule;
/**
 * DeviceSettingsBFD
 */
...
public class DeviceSettingsBFD {
  @JsonProperty("enabled")
  private Boolean enabled = null;

  @JsonProperty("rules")
  private List<DeviceSettingsBFDRule> rules = null;

  @JsonProperty("override")
  private Boolean override = null;

  @JsonProperty("rulesV6")
  private List<DeviceSettingsBFDRule> rulesV6 = null;

  public DeviceSettingsBFD enabled(Boolean enabled) {
  ...
  **/
  ...
  public DeviceSettingsBFD rules(List<DeviceSettingsBFDRule> rules) {
    this.rules = rules;
    return this;
  }

  public DeviceSettingsBFD addRulesItem(DeviceSettingsBFDRule rulesItem) {
    if (this.rules == null) {
  ...
  **/
  @Schema(description = "")
  public List<DeviceSettingsBFDRule> getRules() {
    return rules;
  }

  public void setRules(List<DeviceSettingsBFDRule> rules) {
    this.rules = rules;
  }

  public DeviceSettingsBFD override(Boolean override) {
  ...
  **/
  ...
  public DeviceSettingsBFD rulesV6(List<DeviceSettingsBFDRule> rulesV6) {
    this.rulesV6 = rulesV6;
    return this;
  }

  public DeviceSettingsBFD addRulesV6Item(DeviceSettingsBFDRule rulesV6Item) {
    if (this.rulesV6 == null) {
      this.rulesV6 = new ArrayList<>();
    }
    this.rulesV6.add(rulesV6Item);
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public List<DeviceSettingsBFDRule> getRulesV6() {
    return rulesV6;
  }

  public void setRulesV6(List<DeviceSettingsBFDRule> rulesV6) {
    this.rulesV6 = rulesV6;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DeviceSettingsBFD deviceSettingsBFD = (DeviceSettingsBFD) o;
    return Objects.equals(this.enabled, deviceSettingsBFD.enabled) &&
        Objects.equals(this.rules, deviceSettingsBFD.rules) &&
        Objects.equals(this.override, deviceSettingsBFD.override) &&
        Objects.equals(this.rulesV6, deviceSettingsBFD.rulesV6);
  }

  @Override
  public int hashCode() {
    return Objects.hash(enabled, rules, override, rulesV6);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceSettingsBFD {\n");
    
    sb.append("    enabled: ").append(toIndentedString(enabled)).append("\n");
    sb.append("    rules: ").append(toIndentedString(rules)).append("\n");
    sb.append("    override: ").append(toIndentedString(override)).append("\n");
    sb.append("    rulesV6: ").append(toIndentedString(rulesV6)).append("\n");
    sb.append("}");
    return sb.toString();
  }
