...
import org.opennms.velocloud.client.model.DeviceSettingsHandoffGatewayIpsecDetail;
/**
 * DeviceSettingsHandoffGateway
 */
...
public class DeviceSettingsHandoffGateway {
  @JsonProperty("gateway")
  private BaseApiResource gateway = null;

  @JsonProperty("ipsecDetail")
  private DeviceSettingsHandoffGatewayIpsecDetail ipsecDetail = null;

  @JsonProperty("logicalId")
  private String logicalId = null;

  public DeviceSettingsHandoffGateway gateway(BaseApiResource gateway) {
  ...
  **/
  @Schema(description = "")
  public BaseApiResource getGateway() {
    return gateway;
  }

  public void setGateway(BaseApiResource gateway) {
    this.gateway = gateway;
  }

  public DeviceSettingsHandoffGateway ipsecDetail(DeviceSettingsHandoffGatewayIpsecDetail ipsecDetail) {
    this.ipsecDetail = ipsecDetail;
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public DeviceSettingsHandoffGatewayIpsecDetail getIpsecDetail() {
    return ipsecDetail;
  }

  public void setIpsecDetail(DeviceSettingsHandoffGatewayIpsecDetail ipsecDetail) {
    this.ipsecDetail = ipsecDetail;
  }

  public DeviceSettingsHandoffGateway logicalId(String logicalId) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DeviceSettingsHandoffGateway deviceSettingsHandoffGateway = (DeviceSettingsHandoffGateway) o;
    return Objects.equals(this.gateway, deviceSettingsHandoffGateway.gateway) &&
        Objects.equals(this.ipsecDetail, deviceSettingsHandoffGateway.ipsecDetail) &&
        Objects.equals(this.logicalId, deviceSettingsHandoffGateway.logicalId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gateway, ipsecDetail, logicalId);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceSettingsHandoffGateway {\n");
    
    sb.append("    gateway: ").append(toIndentedString(gateway)).append("\n");
    sb.append("    ipsecDetail: ").append(toIndentedString(ipsecDetail)).append("\n");
