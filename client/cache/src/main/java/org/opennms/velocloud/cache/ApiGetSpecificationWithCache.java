 ...
 */
public class ApiGetSpecificationWithCache<A, P, C, E extends Exception> implements ApiGetExecution<C> {

    private final Supplier<ParamsForApiCall<A, P>> prepare;
     ...
     */
    public ApiGetSpecificationWithCache(
    ...
    public Supplier<ParamsForApiCall<A, P>> getPrepare() {
        return prepare;
    }
    ...
    @Override
    public C doApiGet() throws VelocloudApiException {
        final ParamsForApiCall<A, P> params = this.prepare.get();
        try {
